...
# direct methods
.method public constructor <init>(Lhdu;Lhet;Loyd;Loyw;Lcom/google/googlex/gcam/ExifMetadata;Lcom/google/googlex/gcam/PortraitRequest;Loyw;Lcom/google/googlex/gcam/ExifMetadata;Lcom/google/googlex/gcam/InterleavedImageU16;Lcom/google/googlex/gcam/InterleavedImageU8;J)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhdm;->a:Lhdu;

    iput-object p2, p0, Lhdm;->b:Lhet;

    iput-object p3, p0, Lhdm;->c:Loyd;

    iput-object p4, p0, Lhdm;->d:Loyw;

    iput-object p5, p0, Lhdm;->e:Lcom/google/googlex/gcam/ExifMetadata;

    iput-object p6, p0, Lhdm;->f:Lcom/google/googlex/gcam/PortraitRequest;

    iput-object p7, p0, Lhdm;->g:Loyw;

    iput-object p8, p0, Lhdm;->h:Lcom/google/googlex/gcam/ExifMetadata;

    iput-object p9, p0, Lhdm;->i:Lcom/google/googlex/gcam/InterleavedImageU16;

    iput-object p10, p0, Lhdm;->j:Lcom/google/googlex/gcam/InterleavedImageU8;

    iput-wide p11, p0, Lhdm;->k:J
...
.method public final run()V
    ...
    iget-object v0, v1, Lhdm;->a:Lhdu;

    iget-object v2, v1, Lhdm;->b:Lhet;

    iget-object v3, v1, Lhdm;->c:Loyd;

    iget-object v4, v1, Lhdm;->d:Loyw;

    iget-object v5, v1, Lhdm;->e:Lcom/google/googlex/gcam/ExifMetadata;

    iget-object v14, v1, Lhdm;->f:Lcom/google/googlex/gcam/PortraitRequest;

    iget-object v6, v1, Lhdm;->g:Loyw;

    iget-object v7, v1, Lhdm;->h:Lcom/google/googlex/gcam/ExifMetadata;

    iget-object v8, v1, Lhdm;->i:Lcom/google/googlex/gcam/InterleavedImageU16;

    iget-object v9, v1, Lhdm;->j:Lcom/google/googlex/gcam/InterleavedImageU8;

    iget-wide v10, v1, Lhdm;->k:J

    :try_start_0
    iget-object v12, v0, Lhdu;->s:Lhdv;

    iget-object v15, v12, Lhdv;->f:Ljava/lang/Object;
    ...
    invoke-direct {v12, v2}, Lhdn;-><init>(Lhet;)V

    new-instance v13, Lhdo;

    invoke-direct {v13, v3, v2}, Lhdo;-><init>(Loyd;Lhet;)V

    new-instance v1, Lhdp;

    invoke-direct {v1, v0, v2}, Lhdp;-><init>(Lhdu;Lhet;)V

    iput-object v1, v0, Lhdu;->a:Lcom/google/googlex/gcam/PortraitImageCallback;

    new-instance v1, Lhdq;

    invoke-direct {v1, v2}, Lhdq;-><init>(Lhet;)V

    iput-object v1, v0, Lhdu;->e:Lcom/google/googlex/gcam/PortraitBlobCallback;

    new-instance v1, Lhdr;

    invoke-direct {v1, v0, v2}, Lhdr;-><init>(Lhdu;Lhet;)V

    iput-object v1, v0, Lhdu;->b:Lcom/google/googlex/gcam/PortraitImageCallback;

    new-instance v1, Loza;

    invoke-direct {v1}, Loza;-><init>()V

    iput-object v1, v0, Lhdu;->f:Loza;

    new-instance v1, Lozb;

    invoke-direct {v1}, Lozb;-><init>()V

    iput-object v1, v0, Lhdu;->g:Lozb;
    ...
    :try_start_2
    iget-object v3, v0, Lhdu;->s:Lhdv;

    iget-object v3, v3, Lhdv;->h:Lcom/google/googlex/gcam/creativecamera/portraitmode/PortraitOutputsInterface;
    ...
    iget-object v3, v0, Lhdu;->a:Lcom/google/googlex/gcam/PortraitImageCallback;
    ...
    iget-object v3, v0, Lhdu;->b:Lcom/google/googlex/gcam/PortraitImageCallback;
    ...
    iget-object v3, v0, Lhdu;->e:Lcom/google/googlex/gcam/PortraitBlobCallback;
    ...
    invoke-direct {v3, v0, v2}, Lhds;-><init>(Lhdu;Lhet;)V

    iput-object v3, v0, Lhdu;->c:Lcom/google/googlex/gcam/PortraitImageCallback;

    iget-object v3, v0, Lhdu;->c:Lcom/google/googlex/gcam/PortraitImageCallback;
    ...
    invoke-direct {v3, v0, v2}, Lhdt;-><init>(Lhdu;Lhet;)V

    iput-object v3, v0, Lhdu;->d:Lcom/google/googlex/gcam/PortraitImageCallback;

    new-instance v2, Loza;

    invoke-direct {v2}, Loza;-><init>()V

    iput-object v2, v0, Lhdu;->h:Loza;

    iget-object v2, v0, Lhdu;->h:Loza;
    ...
    iget-object v2, v0, Lhdu;->d:Lcom/google/googlex/gcam/PortraitImageCallback;
    ...
    sget-object v3, Lhdv;->b:Ljava/lang/String;
    ...
    invoke-static {v3, v14, v5}, Ldph;->a(Ljava/lang/String;Lcom/google/googlex/gcam/PortraitRequest;Lcom/google/googlex/gcam/ExifMetadata;)V
    ...
    sget-object v3, Lhdv;->c:Ljava/lang/String;
    ...
    invoke-static {v3, v14, v7}, Ldph;->a(Ljava/lang/String;Lcom/google/googlex/gcam/PortraitRequest;Lcom/google/googlex/gcam/ExifMetadata;)V
    ...
    iget-object v2, v0, Lhdu;->s:Lhdv;

    iget-object v2, v2, Lhdv;->e:Lchh;
    ...
    iput-object v2, v0, Lhdu;->i:Lcom/google/android/apps/camera/dynamicdepth/DynamicDepthResult;

    iget-object v2, v0, Lhdu;->i:Lcom/google/android/apps/camera/dynamicdepth/DynamicDepthResult;
    ...
    :cond_5
    iget-object v0, v0, Lhdu;->s:Lhdv;

    iget-object v8, v0, Lhdv;->j:Lcom/google/googlex/gcam/PortraitSwigWrapper;
