...
.method public static a()Lpaw;
    ...
    invoke-direct {v0, v1}, Lpaw;-><init>([B)V
...
# virtual methods
.method public final a(Lkkt;)Landroid/os/Bundle;
    .locals 10
    ...
    iget-object v1, p0, Lpax;->a:Landroid/net/Uri;
    ...
    :goto_0
    iget-object v3, p0, Lpax;->b:Landroid/graphics/Bitmap;
    ...
    :cond_3
    iget-object p1, p0, Lpax;->f:Ljava/lang/Integer;
    ...
    iget-object p1, p0, Lpax;->h:Landroid/graphics/PointF;
...
.method public final b()Lpaw;
    .locals 1

    new-instance v0, Lpaw;

    invoke-direct {v0, p0}, Lpaw;-><init>(Lpax;)V
