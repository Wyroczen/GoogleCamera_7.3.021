...
.method public final entrySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Loix;->a:Ljava/util/Set;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Loix;->a()Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Loix;->a:Ljava/util/Set;
...
.method public keySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Loix;->b:Ljava/util/Set;

    if-nez v0, :cond_0

    new-instance v0, Loiv;

    invoke-direct {v0, p0}, Loiv;-><init>(Ljava/util/Map;)V

    iput-object v0, p0, Loix;->b:Ljava/util/Set;
...
.method public final values()Ljava/util/Collection;
    ...
    iget-object v0, p0, Loix;->c:Ljava/util/Collection;
    ...
    iput-object v0, p0, Loix;->c:Ljava/util/Collection;
