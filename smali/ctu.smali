...
.method public constructor <init>(Lcom/google/android/apps/camera/evcomp/EvCompView;Landroid/widget/CheckBox;Landroid/animation/ObjectAnimator;Lcub;Lctd;Lgrk;Lioc;)V
    .locals 0
    ...
    iget-object p2, p5, Lctd;->b:Llom;

    iput-object p2, p0, Lctu;->f:Llom;

    iput-object p6, p0, Lctu;->g:Lgrk;

    iput-object p7, p0, Lctu;->i:Lioc;
    ...
    invoke-direct {p2, p0, p6}, Lcto;-><init>(Lctu;Lgrk;)V
...
.method public final a(Ljzi;)V
    ...
    :cond_0
    invoke-static {p1}, Ljzi;->a(Ljzi;)Z
    ...
    iget-object p1, p0, Lctu;->i:Lioc;

    const/16 v0, 0x1707

    invoke-interface {p1, v0}, Lioc;->b(I)V
