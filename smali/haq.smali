...
.method public final run()V
    ...
    iget-object v0, p0, Lhaq;->a:Lhar;

    iget-object v1, v0, Lhar;->b:Llva;

    const-string v2, "Closing one camera."

    invoke-interface {v1, v2}, Llva;->d(Ljava/lang/String;)V

    iget-object v1, v0, Lhar;->c:Llmz;

    iget-object v2, v0, Lhar;->a:Llln;

    new-instance v3, Llnb;

    const-string v4, "OneCameraLifetime"

    invoke-direct {v3, v2, v4}, Llnb;-><init>(Llul;Ljava/lang/String;)V

    invoke-interface {v1, v3}, Llmz;->a(Llul;)V

    monitor-enter v0

    :try_start_0
    iget-object v1, v0, Lhar;->d:Loxn;
