...
.method public constructor <init>(Lbkc;Landroid/view/View;Ljava/util/concurrent/Executor;)V
    ...
    iput-boolean v0, p0, Lefy;->f:Z

    iput-object p1, p0, Lefy;->a:Lbkc;

    iput-object p3, p0, Lefy;->c:Ljava/util/concurrent/Executor;

    iput-object p2, p0, Lefy;->g:Landroid/view/View;
    ...
    iget-object p1, p0, Lefy;->g:Landroid/view/View;
    ...
    iput-object p1, p0, Lefy;->d:Lcom/google/android/apps/camera/ui/widget/ReviewImageView;
    ...
    invoke-direct {p2, p1}, Ljew;-><init>(Landroid/widget/FrameLayout;)V

    invoke-static {p2}, Lkab;->e(Landroid/view/View;)Landroid/view/View;

    move-result-object p1

    check-cast p1, Ljew;

    iput-object p1, p0, Lefy;->b:Ljew;
    ...
    iput-object p1, p0, Lefy;->e:Lcom/google/android/apps/camera/progressoverlay/ProgressOverlay;
...
.method public final declared-synchronized a(Landroid/graphics/Bitmap;Z)V
    ...
    iget-object p2, p0, Lefy;->e:Lcom/google/android/apps/camera/progressoverlay/ProgressOverlay;
    ...
    iput-boolean p2, p0, Lefy;->f:Z

    iget-object p2, p0, Lefy;->d:Lcom/google/android/apps/camera/ui/widget/ReviewImageView;

    invoke-virtual {p2, p1}, Lcom/google/android/apps/camera/ui/widget/ReviewImageView;->a(Landroid/graphics/Bitmap;)V

    iget-object p1, p0, Lefy;->d:Lcom/google/android/apps/camera/ui/widget/ReviewImageView;
