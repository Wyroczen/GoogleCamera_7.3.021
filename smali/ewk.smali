...
.method public static a(Ljava/io/InputStream;)Lael;
    ...
    invoke-direct {v0, p0}, Lewh;-><init>(Ljava/io/InputStream;)V

    const/4 p0, 0x1

    invoke-static {v0, p0}, Lewk;->a(Lewj;Z)Ljava/util/List;
    ...
    invoke-static {v5}, Lewk;->a(Lewi;)Z
    ...
    sget-object p0, Lewk;->a:Ljava/lang/String;

    invoke-static {p0}, Lijc;->c(Ljava/lang/String;)V
...
.method public static a(Ljava/lang/String;)Lael;
    ...
    :try_start_1
    invoke-static {v0}, Lewk;->a(Ljava/io/InputStream;)Lael;
    ...
    :try_start_4
    invoke-static {v2, v0}, Loys;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    :goto_1
    invoke-static {v2, p0, v0}, Lijc;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static a(Lewj;Z)Ljava/util/List;
    .locals 8

    const/4 v0, 0x0

    :try_start_0
    invoke-interface {p0}, Lewj;->a()I
    ...
    :try_start_1
    invoke-interface {p0}, Lewj;->close()V
    :try_end_1
    ...
    iget-object v3, v3, Lewh;->a:Ljava/io/InputStream;
    ...
    iget-object v6, v6, Lewh;->a:Ljava/io/InputStream;
    ...
    invoke-direct {v6, v5, v3, v4}, Lewi;-><init>([BII)V
    ...
    iget-object p1, p1, Lewh;->a:Ljava/io/InputStream;
    ...
    invoke-direct {v2, p1, v5, v3}, Lewi;-><init>([BII)V
    ...
    :try_start_9
    sget-object p1, Lewk;->a:Ljava/lang/String;
...
.method public static a(Lael;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-static {p1, p0}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Ljava/lang/String;Lael;)Z
    ...
    invoke-direct {v2, v0}, Lewh;-><init>(Ljava/io/InputStream;)V

    invoke-static {v2, v1}, Lewk;->a(Lewj;Z)Ljava/util/List;
    ...
    invoke-direct {p1, v7, v5, v6}, Lewi;-><init>([BII)V
    ...
    invoke-static {v7}, Lewk;->a(Lewi;)Z
    ...
    :goto_e
    invoke-static {v0, p0, p1}, Lijc;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
