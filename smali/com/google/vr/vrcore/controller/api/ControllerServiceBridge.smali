...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)V
    ...
    invoke-direct {v0, p3}, Lpkz;-><init>(I)V
    ...
    invoke-direct {p3, p2, v0, v1}, Lpll;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lpkz;I)V

    iput-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lpll;
    ...
    invoke-direct {p2, p0}, Lplu;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V

    iput-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lplu;
    ...
    move-result v1
    :try_end_0
    .catch Lpke; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final a(ILpll;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lplt;

    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->c:Ljava/lang/String;

    new-instance v2, Lplq;

    invoke-direct {v2, p2}, Lplq;-><init>(Lpll;)V

    invoke-interface {v0, p1, v1, v2}, Lplt;->a(ILjava/lang/String;Lplr;)Z
...
.method public final a()V
    ...
    invoke-interface {v0, v2}, Lplt;->a(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lplu;

    invoke-interface {v0, v2}, Lplt;->b(Lplv;)Z
    ...
    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lplt;
...
.method public final a(ILplf;)V
    ...
    :cond_0
    :try_start_0
    invoke-interface {v0, p1, p2}, Lplt;->a(ILplf;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final b()V
    ...
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lpll;

    iget-object v0, v0, Lpll;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILpll;)Z
    ...
    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lpll;
...
.method public controllerHapticsEffect(III)V
    ...
    invoke-direct {p3}, Lplf;-><init>()V

    invoke-virtual {p3, p2}, Lpkc;->a(Lpec;)V

    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->b:Landroid/os/Handler;

    new-instance v0, Lplj;

    invoke-direct {v0, p0, p1, p3}, Lplj;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILplf;)V
...
.method public createAndConnectController(ILcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)Z
    ...
    iget-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lplt;
    ...
    invoke-direct {p3, p2, v0, p1}, Lpll;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lpkz;I)V

    iget p2, p3, Lpll;->c:I

    invoke-direct {p0, p2, p3}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILpll;)Z
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, p2}, Lpls;-><init>(Landroid/os/IBinder;)V
    ...
    :try_start_1
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lplt;

    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lplu;

    invoke-interface {p2, v0}, Lplt;->a(Lplv;)Z
    ...
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lpll;

    iget-object p2, p2, Lpll;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;
    ...
    iget-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lpll;

    iget-object p1, p1, Lpll;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iput-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lplt;
...
.method public requestBind()V
    ...
    invoke-direct {v1, p0}, Lplg;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V
...
.method public vibrateController(IIII)V
    ...
    invoke-direct {p4, p0, p1, p3}, Lpli;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILplf;)V
