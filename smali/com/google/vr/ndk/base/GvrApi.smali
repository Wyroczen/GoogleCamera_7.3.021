...
.method private static requestFeatures(Landroid/content/Context;J[I[ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p3}, Lpjv;->a([I)[Lpjv;

    move-result-object p3

    invoke-static {p4}, Lpjv;->a([I)[Lpjv;
    ...
    invoke-direct {v0, v1, v2}, Lpjw;-><init>(J)V
    ...
    sget-object v2, Lpjk;->a:Landroid/content/ComponentName;
    ...
    :cond_1
    invoke-virtual {v0, v6}, Lpjw;->a(Lpjv;)Z

    move-result v7

    if-nez v7, :cond_0

    iget-object v6, v6, Lpjv;->d:Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {v0, v3}, Lpjw;->a(Lpjv;)Z

    move-result v5

    if-nez v5, :cond_4

    iget-object v3, v3, Lpjv;->d:Ljava/lang/String;
