...
.method private static readDeviceParams(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lpji;->a()Lpjy;
...
.method private static readDisplayParams(Landroid/content/Context;J)V
    ...
    invoke-interface {v2}, Lpji;->b()Lpjz;

    move-result-object v3

    invoke-interface {v2}, Lpji;->d()V

    invoke-static {p0}, Lpir;->a(Landroid/content/Context;)Landroid/view/Display;

    move-result-object v2

    invoke-static {v2}, Lpir;->a(Landroid/view/Display;)Landroid/util/DisplayMetrics;
    ...
    :cond_2
    :goto_1
    invoke-static {v3}, Lpir;->a(Lpjz;)F
    ...
    invoke-static {v2}, Lpio;->a(Ljava/lang/Object;)Lpio;
    ...
    invoke-virtual {v0, p0}, Lpio;->a(Ljava/lang/String;)I

    move-result p0

    const-string v1, "getSafeInsetRight"

    invoke-virtual {v0, v1}, Lpio;->a(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lpir;->a(Lpjz;)F
...
.method private static readSdkConfigurationParams(Landroid/content/Context;)[B
    ...
    invoke-static {p0}, Lpju;->a(Landroid/content/Context;)Lopd;
...
.method private static readUserPrefs(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lpji;->c()Lpka;
...
.method private static writeDeviceParams(Landroid/content/Context;[B)Z
    ...
    invoke-static {v1, p1, v0}, Lpct;->a(Lpct;[BLpcg;)Lpct;
    ...
    invoke-interface {p0, p1}, Lpji;->a(Lpjy;)Z
