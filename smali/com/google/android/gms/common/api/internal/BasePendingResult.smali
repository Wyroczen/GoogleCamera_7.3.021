...
.field private volatile m:Lkqp;

.field private mResultGuardian:Lkrj;
...
.method constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lkri;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkri;
...
.method protected constructor <init>(Lkqf;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lkqf;->a()Landroid/os/Looper;

    move-result-object v0

    new-instance v1, Lkri;

    invoke-direct {v1, v0}, Lkri;-><init>(Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkri;
...
.method private final b()Lkql;
    ...
    invoke-static {v1, v3}, Lkvw;->a(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkql;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkql;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkqm;
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Lkql;
.end method

.method public final a(Ljava/util/concurrent/TimeUnit;)Lkql;
    .locals 3
    ...
    invoke-static {v1, v0}, Lkvw;->a(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, v0}, Lkvw;->a(ZLjava/lang/Object;)V

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b()Lkql;
...
.method public final a(Lkqg;)V
    ...
    invoke-interface {p1, v1}, Lkqg;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final a(Lkql;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkql;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Lkql;

    invoke-interface {p1}, Lkql;->a()Lcom/google/android/gms/common/api/Status;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkqm;

    if-eqz p1, :cond_0

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkri;

    const/4 v1, 0x2

    invoke-virtual {p1, v1}, Lkri;->removeMessages(I)V

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkri;

    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkqm;

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b()Lkql;

    move-result-object v2

    invoke-virtual {p1, v1, v2}, Lkri;->a(Lkqm;Lkql;)V
    ...
    instance-of p1, p1, Lkqi;

    if-eqz p1, :cond_1

    new-instance p1, Lkrj;

    invoke-direct {p1, p0}, Lkrj;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Lkrj;
    ...
    invoke-interface {v1, v2}, Lkqg;->a(Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b(Lkql;)V
...
.method public final a(Lkqm;)V
    ...
    invoke-static {v2, v1}, Lkvw;->a(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Lkri;

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b()Lkql;

    move-result-object v2

    invoke-virtual {v1, p1, v2}, Lkri;->a(Lkqm;Lkql;)V

    goto :goto_0

    :cond_0
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lkqm;
...
.method public final c(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Lkql;
