...
.method private final a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lnsj;Lnuw;)V
    .locals 0

    invoke-direct {p0, p2, p3}, Lcom/google/android/material/floatingactionbutton/ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior;->a(Landroid/view/View;Lnuw;)Z
    ...
    invoke-static {p1, p2, p3}, Lnvf;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private final a(Landroid/view/View;Lnuw;)Z
    .locals 2

    invoke-virtual {p2}, Lnuw;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
...
.method private final b(Landroid/view/View;Lnuw;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Lcom/google/android/material/floatingactionbutton/ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior;->a(Landroid/view/View;Lnuw;)Z
    ...
    invoke-virtual {p2}, Lnuw;->getHeight()I
...
.method public final bridge synthetic a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    instance-of v4, v3, Lnsj;

    if-eqz v4, :cond_0

    check-cast v3, Lnsj;

    invoke-direct {p0, p1, v3, p2}, Lcom/google/android/material/floatingactionbutton/ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lnsj;Lnuw;)V
    ...
    invoke-direct {p0, v3, p2}, Lcom/google/android/material/floatingactionbutton/ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior;->b(Landroid/view/View;Lnuw;)V
...
.method public final bridge synthetic a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    instance-of v0, p3, Lnsj;

    if-eqz v0, :cond_0

    check-cast p3, Lnsj;

    invoke-direct {p0, p1, p3, p2}, Lcom/google/android/material/floatingactionbutton/ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lnsj;Lnuw;)V
    ...
    invoke-direct {p0, p3, p2}, Lcom/google/android/material/floatingactionbutton/ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior;->b(Landroid/view/View;Lnuw;)V
