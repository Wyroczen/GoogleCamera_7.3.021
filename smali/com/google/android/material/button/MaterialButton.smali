...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static/range {v1 .. v6}, Lnvj;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v2, v4}, Lnvx;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v2, v1, v4}, Lnvx;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v5, v0, v2}, Lntg;-><init>(Lcom/google/android/material/button/MaterialButton;Lnwj;)V

    iput-object v5, v0, Lcom/google/android/material/button/MaterialButton;->e:Lntg;
    ...
    iget-object v7, v5, Lntg;->b:Lnwj;

    invoke-virtual {v7}, Lnwj;->b()Lnwh;

    move-result-object v7

    invoke-virtual {v7, v6}, Lnwh;->c(F)V

    invoke-virtual {v7, v6}, Lnwh;->d(F)V

    invoke-virtual {v7, v6}, Lnwh;->b(F)V

    invoke-virtual {v7, v6}, Lnwh;->a(F)V

    invoke-virtual {v7}, Lnwh;->a()Lnwj;

    move-result-object v6

    invoke-virtual {v5, v6}, Lntg;->a(Lnwj;)V
    ...
    invoke-static {v6, v7}, Lnvx;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v6

    iput-object v6, v5, Lntg;->i:Landroid/graphics/PorterDuff$Mode;

    iget-object v6, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-static {v6, v1, v7}, Lnvx;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, v5, Lntg;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v5, Lntg;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v5, Lntg;->l:Landroid/content/res/ColorStateList;
    ...
    iget-object v7, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-static {v7}, Lkb;->g(Landroid/view/View;)I

    move-result v7

    iget-object v8, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v8}, Lcom/google/android/material/button/MaterialButton;->getPaddingTop()I

    move-result v8

    iget-object v9, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-static {v9}, Lkb;->h(Landroid/view/View;)I

    move-result v9

    iget-object v11, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v11}, Lcom/google/android/material/button/MaterialButton;->getPaddingBottom()I

    move-result v11

    iget-object v12, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;

    new-instance v13, Lnwd;

    iget-object v14, v5, Lntg;->b:Lnwj;

    invoke-direct {v13, v14}, Lnwd;-><init>(Lnwj;)V

    iget-object v14, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v14}, Lcom/google/android/material/button/MaterialButton;->getContext()Landroid/content/Context;

    move-result-object v14

    invoke-virtual {v13, v14}, Lnwd;->a(Landroid/content/Context;)V

    iget-object v14, v5, Lntg;->j:Landroid/content/res/ColorStateList;

    invoke-static {v13, v14}, Llh;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    iget-object v14, v5, Lntg;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_1
    iget v14, v5, Lntg;->h:I

    int-to-float v14, v14

    iget-object v15, v5, Lntg;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v13, v14, v15}, Lnwd;->a(FLandroid/content/res/ColorStateList;)V

    new-instance v14, Lnwd;

    iget-object v15, v5, Lntg;->b:Lnwj;

    invoke-direct {v14, v15}, Lnwd;-><init>(Lnwj;)V

    invoke-virtual {v14, v10}, Lnwd;->setTint(I)V

    iget v15, v5, Lntg;->h:I

    int-to-float v15, v15

    invoke-virtual {v14, v15, v10}, Lnwd;->a(FI)V

    new-instance v15, Lnwd;

    iget-object v4, v5, Lntg;->b:Lnwj;

    invoke-direct {v15, v4}, Lnwd;-><init>(Lnwj;)V

    iput-object v15, v5, Lntg;->m:Landroid/graphics/drawable/Drawable;

    iget-object v4, v5, Lntg;->m:Landroid/graphics/drawable/Drawable;

    invoke-static {v4, v3}, Llh;->a(Landroid/graphics/drawable/Drawable;I)V

    new-instance v3, Landroid/graphics/drawable/RippleDrawable;

    iget-object v4, v5, Lntg;->l:Landroid/content/res/ColorStateList;

    invoke-static {v4}, Lnvs;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    iget v13, v5, Lntg;->c:I

    iget v10, v5, Lntg;->e:I

    iget v14, v5, Lntg;->d:I
    ...
    iget-object v0, v5, Lntg;->m:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v3, v5, Lntg;->p:Landroid/graphics/drawable/LayerDrawable;

    iget-object v0, v5, Lntg;->p:Landroid/graphics/drawable/LayerDrawable;

    invoke-super {v12, v0}, Lqq;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v5}, Lntg;->a()Lnwd;
    ...
    invoke-virtual {v0, v2}, Lnwd;->c(F)V

    :goto_2
    iget-object v0, v5, Lntg;->a:Lcom/google/android/material/button/MaterialButton;
...
.method private final d()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->e:Lntg;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lntg;->n:Z
...
.method public final a(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lntg;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lntg;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {v0}, Lntg;->a()Lnwd;
    ...
    iget-object v0, v0, Lntg;->j:Landroid/content/res/ColorStateList;
...
.method public final a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lntg;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lntg;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p1, v0, Lntg;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lntg;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final a(Lnwj;)V
    ...
    invoke-virtual {v0, p1}, Lntg;->a(Lnwj;)V
...
.method protected onAttachedToWindow()V
    ...
    iget-object v1, v0, Lnwd;->a:Lnwc;

    iget-object v1, v1, Lnwc;->b:Lnut;

    if-eqz v1, :cond_2

    iget-boolean v1, v1, Lnut;->a:Z
...
.method public final setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lnwd;->setTint(I)V
...
.method public final setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v1, v0, Lntg;->n:Z

    iget-object v1, v0, Lntg;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Lntg;->j:Landroid/content/res/ColorStateList;
...
.method public final setElevation(F)V
    ...
    invoke-virtual {v0, p1}, Lnwd;->c(F)V
