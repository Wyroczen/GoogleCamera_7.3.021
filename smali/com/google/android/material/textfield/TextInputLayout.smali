...
.field private I:Lnwd;

.field private J:Lnwj;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v1, v7, v8, v9}, Lnys;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-direct {v1, v0}, Lnxx;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V

    iput-object v1, v0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;
    ...
    invoke-direct {v1, v0}, Lnve;-><init>(Landroid/view/View;)V

    iput-object v1, v0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;
    ...
    iget-object v1, v0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    sget-object v2, Lnsf;->a:Landroid/animation/TimeInterpolator;

    iput-object v2, v1, Lnve;->w:Landroid/animation/TimeInterpolator;
    ...
    iput-object v2, v1, Lnve;->v:Landroid/animation/TimeInterpolator;
    ...
    invoke-virtual {v1, v2}, Lnve;->b(I)V

    sget-object v15, Lnye;->a:[I
    ...
    invoke-static {v11, v7, v8, v9}, Lnvj;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static/range {v1 .. v6}, Lnvj;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
    ...
    invoke-static {v11, v7, v8, v9}, Lnwj;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Lnwh;

    move-result-object v3

    invoke-virtual {v3}, Lnwh;->a()Lnwj;

    move-result-object v3

    iput-object v3, v0, Lcom/google/android/material/textfield/TextInputLayout;->J:Lnwj;
    ...
    iget-object v8, v0, Lcom/google/android/material/textfield/TextInputLayout;->J:Lnwj;

    invoke-virtual {v8}, Lnwj;->b()Lnwh;
    ...
    :cond_0
    invoke-virtual {v8, v3}, Lnwh;->c(F)V
    ...
    :cond_1
    invoke-virtual {v8, v5}, Lnwh;->d(F)V
    ...
    :cond_2
    invoke-virtual {v8, v6}, Lnwh;->b(F)V
    ...
    invoke-virtual {v8, v7}, Lnwh;->a(F)V

    :cond_3
    invoke-virtual {v8}, Lnwh;->a()Lnwj;
    ...
    invoke-static {v11, v1, v3}, Lnvx;->a(Landroid/content/Context;Lwg;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v11, v1, v5}, Lnvx;->a(Landroid/content/Context;Lwg;I)Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    new-instance v7, Lnvq;

    iget-object v8, v6, Lnve;->a:Landroid/view/View;

    invoke-virtual {v8}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v8

    invoke-direct {v7, v8, v5}, Lnvq;-><init>(Landroid/content/Context;I)V

    iget-object v5, v7, Lnvq;->b:Landroid/content/res/ColorStateList;
    ...
    :cond_b
    iput-object v5, v6, Lnve;->i:Landroid/content/res/ColorStateList;
    ...
    :goto_6
    iget-object v5, v7, Lnvq;->f:Landroid/content/res/ColorStateList;
    ...
    :cond_d
    iput-object v5, v6, Lnve;->A:Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v8, v6}, Lnvd;-><init>(Lnve;)V

    invoke-virtual {v7}, Lnvq;->a()V

    iget-object v9, v7, Lnvq;->j:Landroid/graphics/Typeface;

    invoke-direct {v5, v8, v9}, Lnvr;-><init>(Lnvn;Landroid/graphics/Typeface;)V

    iput-object v5, v6, Lnve;->B:Lnvr;

    iget-object v5, v6, Lnve;->a:Landroid/view/View;

    invoke-virtual {v5}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v5

    iget-object v8, v6, Lnve;->B:Lnvr;

    invoke-virtual {v7, v5, v8}, Lnvq;->a(Landroid/content/Context;Lnvr;)V

    invoke-virtual {v6}, Lnve;->e()V

    iget-object v5, v0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    iget-object v5, v5, Lnve;->i:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v11, v1, v8}, Lnvx;->a(Landroid/content/Context;Lwg;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v8, v15}, Lnvx;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v11, v1, v4}, Lnvx;->a(Landroid/content/Context;Lwg;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v4, v10}, Lnvx;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {v10, v0}, Lnxy;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    new-instance v10, Lnyd;

    invoke-direct {v10, v0}, Lnyd;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    invoke-direct {v10, v0}, Lnxh;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    new-instance v10, Lnxu;

    invoke-direct {v10, v0}, Lnxu;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    invoke-static {v4, v14}, Lnvx;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_f
    iget-object v4, v0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v4}, Lnxx;->b()V

    iput-object v9, v4, Lnxx;->l:Ljava/lang/CharSequence;

    iget-object v8, v4, Lnxx;->n:Landroid/widget/TextView;
    ...
    :cond_28
    iput v10, v4, Lnxx;->e:I

    :goto_10
    iget v10, v4, Lnxx;->e:I

    iget-object v11, v4, Lnxx;->n:Landroid/widget/TextView;

    invoke-virtual {v4, v11, v9}, Lnxx;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)Z

    move-result v9

    invoke-virtual {v4, v8, v10, v9}, Lnxx;->a(IIZ)V

    :goto_11
    iget-object v4, v0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v4, v3}, Lnxx;->b(I)V

    invoke-virtual {v0, v7}, Lcom/google/android/material/textfield/TextInputLayout;->b(Z)V

    iget-object v3, v0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v3, v5}, Lnxx;->a(I)V

    iget-object v3, v0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v3, v6}, Lnxx;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v2}, Lnxx;->a(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v3, v2}, Lnxx;->b(Landroid/content/res/ColorStateList;)V
    ...
    :cond_31
    iget-object v3, v0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    invoke-virtual {v3, v2}, Lnve;->a(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, v0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    iget-object v4, v0, Lcom/google/android/material/textfield/TextInputLayout;->f:Landroid/widget/TextView;

    const/4 v5, 0x2

    invoke-virtual {v2, v4, v5}, Lnxx;->a(Landroid/widget/TextView;I)V
    ...
    invoke-static {v2, v4}, Lnhv;->a(Landroid/view/ViewGroup$MarginLayoutParams;I)V
    ...
    invoke-virtual {v2, v4, v5}, Lnxx;->b(Landroid/widget/TextView;I)V
...
.method private final A()Z
    ...
    invoke-static {v4}, Lnhv;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private final B()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->j:Lnwd;

    instance-of v0, v0, Lnxj;
...
.method private final C()V
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;
    ...
    iget-object v4, v1, Lnve;->m:Ljava/lang/CharSequence;

    invoke-virtual {v1, v4}, Lnve;->a(Ljava/lang/CharSequence;)Z

    move-result v4

    iput-boolean v4, v1, Lnve;->o:Z
    ...
    iget-object v4, v1, Lnve;->e:Landroid/graphics/Rect;

    iget v4, v4, Landroid/graphics/Rect;->right:I

    int-to-float v4, v4

    invoke-virtual {v1}, Lnve;->a()F
    ...
    iget-boolean v2, v1, Lnve;->o:Z

    if-eqz v2, :cond_6

    iget-object v2, v1, Lnve;->e:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->j:Lnwd;
    ...
    invoke-virtual {v1, v2, v3, v4, v0}, Lnxj;->a(FFFF)V
...
.method private final a(ZZ)V
    ...
    :goto_1
    iget-object v5, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v5}, Lnxx;->d()Z
    ...
    iget-object v7, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    invoke-virtual {v7, v6}, Lnve;->a(Landroid/content/res/ColorStateList;)V

    iget-object v6, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    iget-object v7, p0, Lcom/google/android/material/textfield/TextInputLayout;->ap:Landroid/content/res/ColorStateList;

    invoke-virtual {v6, v7}, Lnve;->b(Landroid/content/res/ColorStateList;)V

    :cond_4
    if-nez v0, :cond_5

    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;
    ...
    invoke-virtual {v0, v6}, Lnve;->a(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v6}, Lnve;->b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v6, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    iget-object v6, v6, Lnxx;->h:Landroid/widget/TextView;
    ...
    invoke-virtual {v6, v0}, Lnve;->a(Landroid/content/res/ColorStateList;)V
    ...
    :cond_f
    :goto_5
    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    invoke-virtual {p1, p2}, Lnve;->a(F)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->j:Lnwd;

    check-cast p1, Lnxj;

    iget-object p1, p1, Lnxj;->f:Landroid/graphics/RectF;
    ...
    invoke-virtual {p1, p2, p2, p2, p2}, Lnxj;->a(FFFF)V
...
.method private final k()V
    ...
    iget-object v2, p0, Lcom/google/android/material/textfield/TextInputLayout;->J:Lnwj;

    invoke-direct {v0, v2}, Lnxj;-><init>(Lnwj;)V

    iput-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->j:Lnwd;
    ...
    invoke-direct {v0, v2}, Lnwd;-><init>(Lnwj;)V

    iput-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->j:Lnwd;

    :goto_1
    iput-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->I:Lnwd;
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->J:Lnwj;

    invoke-direct {v0, v1}, Lnwd;-><init>(Lnwj;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->I:Lnwd;

    goto :goto_2

    :cond_4
    iput-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->j:Lnwd;
...
.method private final r()V
    ...
    invoke-direct {p0}, Lcom/google/android/material/textfield/TextInputLayout;->w()Lnxv;

    move-result-object v0

    invoke-virtual {v0, v1}, Lnxv;->a(Z)V
...
.method final a(F)V
    ...
    sget-object v1, Lnsf;->b:Landroid/animation/TimeInterpolator;
    ...
    invoke-direct {v1, p0}, Lnyi;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    iget-object v3, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;
...
.method public final a(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    iget-boolean p1, p1, Lnxx;->g:Z
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    :cond_0
    iget-object v1, v0, Lnve;->m:Ljava/lang/CharSequence;
    ...
    :goto_0
    iput-object p1, v0, Lnve;->m:Ljava/lang/CharSequence;

    const/4 p1, 0x0

    iput-object p1, v0, Lnve;->n:Ljava/lang/CharSequence;
...
.method public final a(Lnyk;)V
    ...
    invoke-interface {p1, p0}, Lnyk;->a(Lcom/google/android/material/textfield/TextInputLayout;)V
...
.method public final addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-direct {p2, p0}, Lnyj;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V

    invoke-virtual {p0, p2}, Lcom/google/android/material/textfield/TextInputLayout;->a(Lnyj;)V

    iget-object p2, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;
    ...
    invoke-virtual {p2, p3}, Lnve;->a(Landroid/graphics/Typeface;)Z

    move-result v0

    iget-object v1, p2, Lnve;->l:Landroid/graphics/Typeface;
    ...
    iput-object p3, p2, Lnve;->l:Landroid/graphics/Typeface;
    ...
    iget-object p3, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    and-int/lit8 v0, p2, -0x71

    or-int/lit8 v0, v0, 0x30

    invoke-virtual {p3, v0}, Lnve;->b(I)V

    iget-object p3, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    invoke-virtual {p3, p2}, Lnve;->a(I)V

    iget-object p2, p0, Lcom/google/android/material/textfield/TextInputLayout;->a:Landroid/widget/EditText;

    new-instance p3, Lnyf;

    invoke-direct {p3, p0}, Lnyf;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    iget-object p2, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {p2}, Lnxx;->c()V
    ...
    invoke-interface {p3, p0}, Lnyk;->a(Lcom/google/android/material/textfield/TextInputLayout;)V
...
.method public final b(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    iget-boolean v1, v0, Lnxx;->g:Z

    if-eq v1, p1, :cond_1

    invoke-virtual {v0}, Lnxx;->b()V
    ...
    iget-object v3, v0, Lnxx;->a:Landroid/content/Context;

    invoke-direct {v2, v3}, Lrw;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Lnxx;->h:Landroid/widget/TextView;

    iget-object v2, v0, Lnxx;->h:Landroid/widget/TextView;
    ...
    invoke-virtual {v0, v2}, Lnxx;->a(I)V

    iget-object v2, v0, Lnxx;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lnxx;->a(Landroid/content/res/ColorStateList;)V

    iget-object v2, v0, Lnxx;->i:Ljava/lang/CharSequence;

    invoke-virtual {v0, v2}, Lnxx;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v2, v1}, Lnxx;->a(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {v0, v2, v1}, Lnxx;->b(Landroid/widget/TextView;I)V

    const/4 v1, 0x0

    iput-object v1, v0, Lnxx;->h:Landroid/widget/TextView;

    iget-object v1, v0, Lnxx;->b:Lcom/google/android/material/textfield/TextInputLayout;
...
.method public final c()V
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v1}, Lnxx;->d()Z
...
.method public final c(Z)V
    ...
    iput-object v2, v0, Lnxx;->n:Landroid/widget/TextView;

    iget-object v2, v0, Lnxx;->n:Landroid/widget/TextView;
    ...
    invoke-virtual {v0, v2}, Lnxx;->b(I)V

    iget-object v2, v0, Lnxx;->p:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lnxx;->b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v4, v0, Lnxx;->n:Landroid/widget/TextView;

    const/4 v5, 0x0

    invoke-virtual {v0, v4, v5}, Lnxx;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)Z

    move-result v4

    invoke-virtual {v0, v2, v3, v4}, Lnxx;->a(IIZ)V

    iget-object v2, v0, Lnxx;->n:Landroid/widget/TextView;

    invoke-virtual {v0, v2, v1}, Lnxx;->b(Landroid/widget/TextView;I)V

    iput-object v5, v0, Lnxx;->n:Landroid/widget/TextView;
...
.method public final d()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Lnxx;->f:Ljava/lang/CharSequence;
...
.method public final d(I)V
    ...
    invoke-virtual {v1, v2}, Lnxv;->a(I)Z
    ...
    invoke-interface {v1, p0, v0}, Lnyl;->a(Lcom/google/android/material/textfield/TextInputLayout;I)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v0, Lnve;->n:Ljava/lang/CharSequence;

    if-eqz v2, :cond_1

    iget-boolean v2, v0, Lnve;->b:Z
    ...
    iget-boolean v2, v0, Lnve;->p:Z

    iget-object v2, v0, Lnve;->t:Landroid/text/TextPaint;
    ...
    :goto_0
    iget-object v4, v0, Lnve;->n:Ljava/lang/CharSequence;
    ...
    iget-object v9, v0, Lnve;->t:Landroid/text/TextPaint;
    ...
    :cond_2
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->I:Lnwd;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Lnwd;->getBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, p1}, Lnwd;->draw(Landroid/graphics/Canvas;)V
...
.method protected final drawableStateChanged()V
    ...
    iget-object v2, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    const/4 v3, 0x0

    if-eqz v2, :cond_3

    iput-object v1, v2, Lnve;->r:[I

    iget-object v1, v2, Lnve;->i:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iget-object v1, v2, Lnve;->h:Landroid/content/res/ColorStateList;
...
.method public final h()V
    ...
    iget-object v4, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v4}, Lnxx;->d()Z
    ...
    invoke-virtual {v0, v1}, Lnwd;->a(Lnwj;)V
    ...
    invoke-virtual {v0, v1, v3}, Lnwd;->a(FI)V
    ...
    invoke-virtual {v1, v0}, Lnwd;->a(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v1}, Lnwd;->a(Landroid/content/res/ColorStateList;)V
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-static {p0, p1, p2}, Lnvf;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V

    iget-object p1, p0, Lcom/google/android/material/textfield/TextInputLayout;->I:Lnwd;
    ...
    iget-object p4, p0, Lcom/google/android/material/textfield/TextInputLayout;->I:Lnwd;
    ...
    invoke-virtual {p4, p5, p1, p3, v0}, Lnwd;->setBounds(IIII)V
    ...
    invoke-virtual {p3, p4}, Lnve;->b(I)V

    iget-object p3, p0, Lcom/google/android/material/textfield/TextInputLayout;->o:Lnve;

    invoke-virtual {p3, p1}, Lnve;->a(I)V
    ...
    iget-object v2, p1, Lnve;->e:Landroid/graphics/Rect;

    invoke-static {v2, p4, p5, v1, p3}, Lnve;->a(Landroid/graphics/Rect;IIII)Z
    ...
    iget-object p4, p1, Lnve;->u:Landroid/text/TextPaint;

    iget p5, p1, Lnve;->f:F

    invoke-virtual {p4, p5}, Landroid/text/TextPaint;->setTextSize(F)V

    iget-object p5, p1, Lnve;->l:Landroid/graphics/Typeface;
    ...
    iget-object v1, p1, Lnve;->d:Landroid/graphics/Rect;

    invoke-static {v1, p2, p4, p5, p3}, Lnve;->a(Landroid/graphics/Rect;IIII)Z
...
.method protected final onMeasure(II)V
    ...
    invoke-direct {p2, p0}, Lnyh;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
...
.method protected final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v0, p1, Lnyn;->c:Ljava/lang/CharSequence;

    iget-object v1, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    iget-boolean v1, v1, Lnxx;->g:Z
    ...
    invoke-virtual {v1}, Lnxx;->b()V

    iput-object v0, v1, Lnxx;->f:Ljava/lang/CharSequence;

    iget-object v3, v1, Lnxx;->h:Landroid/widget/TextView;
    ...
    iget-object v4, v1, Lnxx;->h:Landroid/widget/TextView;

    invoke-virtual {v1, v4, v0}, Lnxx;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)Z

    move-result v0

    invoke-virtual {v1, v3, v2, v0}, Lnxx;->a(IIZ)V

    :cond_4
    :goto_1
    iget-boolean p1, p1, Lnyn;->d:Z
    ...
    invoke-direct {v0, p0}, Lnyg;-><init>(Lcom/google/android/material/textfield/TextInputLayout;)V
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lnyn;-><init>(Landroid/os/Parcelable;)V

    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout;->b:Lnxx;

    invoke-virtual {v0}, Lnxx;->d()Z
    ...
    iput-object v0, v1, Lnyn;->c:Ljava/lang/CharSequence;
