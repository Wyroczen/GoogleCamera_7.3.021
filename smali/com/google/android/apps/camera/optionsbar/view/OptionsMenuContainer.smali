...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Ljzi;->a:Ljzi;

    iput-object p2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzi;
    ...
    invoke-direct {p2, p0}, Lgqc;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->c:Lgqc;

    new-instance p2, Landroid/view/GestureDetector;

    new-instance v0, Lgqs;

    invoke-direct {v0, p0}, Lgqs;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;)V
...
.method public final a(Lfvj;Z)V
    .locals 1
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->w:Lfvj;

    if-nez v0, :cond_0

    iput-object p1, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->w:Lfvj;
    ...
    iget-object p2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->r:Lfvi;

    invoke-interface {p1, p2}, Lfvj;->b(Lfvi;)V

    iget-object p2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->s:Lfvi;

    invoke-interface {p1, p2}, Lfvj;->b(Lfvi;)V

    iget-object p2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->t:Lfvi;
    ...
    iget-object p2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzi;
...
.method public final a(Ljzi;)V
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzi;

    invoke-static {p0, p1}, Ljzj;->c(Landroid/view/View;Ljzi;)V
    ...
    iget-object v0, v0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;->i:Lgqx;
    ...
    iget-object v0, v0, Lgqx;->d:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, p1}, Lgqw;-><init>(Ljzi;)V
    ...
    invoke-static {v0, p1}, Ljzj;->b(Landroid/view/View;Ljzi;)Landroid/animation/ValueAnimator;

    move-result-object p1

    new-instance v1, Ljzb;

    invoke-direct {v1, v0}, Ljzb;-><init>(Landroid/view/View;)V

    invoke-virtual {p1, v1}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {p1}, Landroid/animation/ValueAnimator;->start()V

    iget-object p1, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->w:Lfvj;

    if-eqz p1, :cond_1

    iget-boolean v0, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->x:Z

    invoke-virtual {p0, p1, v0}, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->a(Lfvj;Z)V
...
.method public final a(Z)V
    ...
    invoke-direct {v1, p0}, Lgqm;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;)V
    ...
    invoke-direct {v2, p0}, Lgqn;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;)V
...
.method public final l()V
    ...
    invoke-direct {v0, p0, v1}, Lgqh;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;Z)V

    invoke-virtual {v0}, Lgqh;->a()Landroid/animation/Animator;
...
.method public final m()V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->a(Lfvj;Z)V
...
.method protected final onFinishInflate()V
    ...
    invoke-direct {v2, p0}, Lgqi;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;)V
    ...
    invoke-direct {v1, p0}, Lgqk;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;)V
    ...
    invoke-direct {v2, p0}, Lgql;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;)V

    iput-object v2, v1, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;->h:Lgra;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzi;

    invoke-virtual {p0, p1}, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->a(Ljzi;)V
...
.method public final onMeasure(II)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzi;
    ...
    :goto_0
    iget-object v0, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzi;
