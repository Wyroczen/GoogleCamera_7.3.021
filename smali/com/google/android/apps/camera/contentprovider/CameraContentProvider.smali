...
.method public final delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    iget-object p2, p1, Lcis;->a:Lilx;

    invoke-interface {p2, v3}, Lilx;->b(Ljava/io/File;)Z
    ...
    invoke-interface {p2, v3}, Lilx;->c(Ljava/io/File;)Z
    ...
    iget-object v4, p1, Lcis;->a:Lilx;

    invoke-interface {v4, v3}, Lilx;->b(Ljava/io/File;)Z
    ...
    invoke-interface {v4, v3}, Lilx;->c(Ljava/io/File;)Z
...
.method public final openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v5}, Lijc;->f(Ljava/lang/String;)V
    ...
    iget-object v6, v6, Ldgs;->b:Ldfi;

    invoke-interface {v6, v3, v4}, Ldfi;->a(J)Loab;
    ...
    invoke-interface {v4, v6}, Llvi;->b(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Ljyv;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    sget-object v9, Ljyv;->a:Ljava/lang/String;
    ...
    invoke-static {v9}, Lijc;->f(Ljava/lang/String;)V
    ...
    :goto_3
    sget-object v6, Ljyv;->a:Ljava/lang/String;
    ...
    :try_end_0
    .catch Ldgw; {:try_start_0 .. :try_end_0} :catch_1
    ...
    iget-object v0, v0, Ldgs;->e:Ldgo;

    :cond_7
    nop

    invoke-interface {v0, v3}, Ldgn;->a(Landroid/graphics/Bitmap;)Ljava/io/ByteArrayOutputStream;
    ...
    invoke-direct {v9, p2, v2, v0}, Ldgr;-><init>(Ldgs;Ljava/lang/String;Ljava/io/ByteArrayOutputStream;)V
    ...
    move-result-object p1
    :try_end_2
    .catch Ldgw; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-direct {v1, v0}, Ldgw;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, v0}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;)V

    new-instance p2, Ldgw;

    const-string v0, "DrawableResource is not set in ProcessingMedia"

    invoke-direct {p2, v0}, Ldgw;-><init>(Ljava/lang/String;)V
    ...
    throw p2
    :try_end_4
    .catch Ldgw; {:try_start_4 .. :try_end_4} :catch_1
    ...
    invoke-virtual {p2}, Ldgw;->getMessage()Ljava/lang/String;
...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object p4, p3, Lciw;->g:Llvi;

    const-string p5, "SpecialTypesQuery"

    invoke-interface {p4, p5}, Llvi;->b(Ljava/lang/String;)V

    iget-object p4, p3, Lciw;->e:Ldfs;

    check-cast p4, Ldft;

    iget-object p5, p4, Ldft;->d:Landroid/content/UriMatcher;
    ...
    :cond_1
    :goto_0
    iget-object p4, p4, Ldft;->c:Ldfr;

    goto :goto_1

    :cond_2
    iget-object p4, p4, Ldft;->b:Ldfr;

    goto :goto_1

    :cond_3
    iget-object p4, p4, Ldft;->a:Ldfr;

    :goto_1
    invoke-interface {p4, p1, p2}, Ldfr;->a(Landroid/net/Uri;[Ljava/lang/String;)Landroid/database/Cursor;

    move-result-object p1

    iget-object p2, p3, Lciw;->g:Llvi;
