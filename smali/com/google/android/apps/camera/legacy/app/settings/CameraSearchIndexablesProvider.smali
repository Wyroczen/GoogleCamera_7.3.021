...
.method private final declared-synchronized b()Lejh;
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lejh;
    ...
    invoke-interface {v0}, Lear;->a()Ldzg;

    move-result-object v0

    invoke-interface {v0}, Ldzg;->b()Leji;

    move-result-object v0

    invoke-interface {v0}, Leji;->a()Lejh;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lejh;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1}, Lejh;->a(Landroid/content/Context;)V
...
.method public final queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b()Lejh;
...
.method public final queryRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {p1}, Lejh;->b()Loiy;

    move-result-object p1

    invoke-interface {p1}, Loiy;->i()Ljava/util/Collection;
