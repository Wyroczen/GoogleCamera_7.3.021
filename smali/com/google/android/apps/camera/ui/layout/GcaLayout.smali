...
.method private final a(Landroid/content/Context;)V
    ...
    invoke-interface {p1, v0}, Ldwc;->a(Ljava/lang/Class;)Ldwd;

    move-result-object p1

    check-cast p1, Ljgg;

    invoke-interface {p1, p0}, Ljgg;->a(Lcom/google/android/apps/camera/ui/layout/GcaLayout;)V
...
.method private static final a(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    iget v1, v0, Ljgh;->leftMargin:I

    iget v2, p1, Landroid/graphics/Rect;->left:I

    if-ne v1, v2, :cond_3

    iget v1, v0, Ljgh;->topMargin:I

    iget v2, p1, Landroid/graphics/Rect;->top:I

    if-ne v1, v2, :cond_3

    iget v1, v0, Ljgh;->rightMargin:I

    if-nez v1, :cond_3

    iget v1, v0, Ljgh;->bottomMargin:I
    ...
    iput p2, v0, Ljgh;->width:I

    invoke-virtual {p1}, Landroid/graphics/Rect;->height()I

    move-result p2

    iput p2, v0, Ljgh;->height:I
    ...
    invoke-virtual {v0, p2, p1, v1, v1}, Ljgh;->setMargins(IIII)V
...
.method protected final generateDefaultLayoutParams()Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-direct {v0, v1}, Ljgh;-><init>(I)V
...
.method protected final bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Ljgh;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Ljgh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public onMeasure(II)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/layout/GcaLayout;->a:Loam;
    ...
    invoke-virtual {v1}, Ljfy;->c()Landroid/graphics/Rect;
    ...
    :pswitch_0
    invoke-virtual {v1}, Ljfy;->b()Landroid/graphics/Rect;
    ...
    :pswitch_1
    invoke-virtual {v1}, Ljfy;->i()Landroid/graphics/Rect;
    ...
    :pswitch_2
    invoke-virtual {v1}, Ljfy;->f()Landroid/graphics/Rect;
    ...
    :pswitch_3
    invoke-virtual {v1}, Ljfy;->g()Landroid/graphics/Rect;
    ...
    :pswitch_4
    invoke-virtual {v1}, Ljfy;->k()Landroid/graphics/Rect;
    ...
    :pswitch_5
    invoke-virtual {v0}, Ljgb;->c()Ljgj;

    move-result-object v5

    if-nez v5, :cond_0

    invoke-virtual {v1}, Ljfy;->e()Landroid/graphics/Rect;
    ...
    iget v8, v7, Ljgh;->width:I

    invoke-virtual {v5}, Ljgj;->a()Landroid/util/Size;
    ...
    iget v8, v7, Ljgh;->gravity:I

    invoke-virtual {v5}, Ljgj;->d()I
    ...
    invoke-virtual {v7}, Ljgh;->getLayoutDirection()I

    move-result v8

    invoke-virtual {v5}, Ljgj;->e()I

    move-result v9

    if-ne v8, v9, :cond_1

    iget v8, v7, Ljgh;->leftMargin:I

    invoke-virtual {v5}, Ljgj;->c()Landroid/graphics/Rect;
    ...
    iget v8, v7, Ljgh;->bottomMargin:I
    ...
    iput v6, v7, Ljgh;->height:I

    invoke-virtual {v5}, Ljgj;->d()I

    move-result v6

    iput v6, v7, Ljgh;->gravity:I

    invoke-virtual {v5}, Ljgj;->e()I

    move-result v6

    invoke-virtual {v7, v6}, Ljgh;->setLayoutDirection(I)V
    ...
    invoke-virtual {v7, v6, v8, v9, v10}, Ljgh;->setMargins(IIII)V

    invoke-virtual {v4, v7}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    :cond_2
    invoke-virtual {v5}, Ljgj;->b()Landroid/graphics/Rect;
    ...
    :pswitch_9
    invoke-virtual {v1}, Ljfy;->j()Landroid/graphics/Rect;
