...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/wirers/PreviewOverlay;->c:Ljxs;

    if-eqz v0, :cond_9

    check-cast v0, Ljyc;

    iget-object v0, v0, Ljyc;->a:Lkfb;
    ...
    :cond_2
    invoke-virtual {v0}, Lkfb;->c()Lker;

    move-result-object v2

    invoke-interface {v2}, Lker;->d()V

    iget-boolean v2, v0, Lkfb;->o:Z

    if-eqz v2, :cond_3

    iget-object v2, v0, Lkfb;->h:Lkes;

    goto :goto_1

    :cond_3
    sget-object v2, Lker;->l:Lker;
    ...
    iput-boolean v3, v0, Lkfb;->n:Z

    iput-boolean v3, v0, Lkfb;->o:Z
    ...
    invoke-interface {v2, v3}, Lkes;->a(Landroid/graphics/PointF;)V

    :goto_2
    iget-boolean v2, v0, Lkfb;->n:Z

    if-eqz v2, :cond_6

    iget-object v0, v0, Lkfb;->d:Landroid/view/ScaleGestureDetector;
    ...
    iget-object v2, v0, Lkfb;->d:Landroid/view/ScaleGestureDetector;

    invoke-virtual {v2, p1}, Landroid/view/ScaleGestureDetector;->onTouchEvent(Landroid/view/MotionEvent;)Z

    iget-object v0, v0, Lkfb;->c:Landroid/view/GestureDetector;
