...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lhgc;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lhgc;
...
.method private final b()V
    ...
    invoke-interface {v0, p0}, Lhgb;->a(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->r:Lmom;

    iget-boolean v0, v0, Lmom;->d:Z
...
.method public final a()V
    ...
    invoke-direct {v2, p0}, Lhga;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V
...
.method public final a(Ljtb;)V
    ...
    invoke-interface {p1, v1}, Ljtb;->a(Landroid/content/res/Resources;)Ljava/lang/String;
...
.method public final onCreate()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->o:Llvi;
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Lhgi;-><init>(Landroid/os/PowerManager;Ljava/lang/String;J)V

    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->d:Lhgi;

    const-string v2, "onCreate"

    invoke-virtual {v0, v2}, Lhgi;->a(Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lhgc;
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->d:Lhgi;

    invoke-virtual {v0}, Lhgi;->a()V

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->n:Labh;

    iget-object v1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lhgc;
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->l:Lhgd;

    iget-object v1, v0, Lhgd;->b:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lhgd;->a:Llva;

    const-string v3, "Service destroyed, restarting? "

    iget-boolean v4, v0, Lhgd;->d:Z
    ...
    :goto_1
    invoke-interface {v2, v4}, Llva;->d(Ljava/lang/String;)V

    iget-boolean v2, v0, Lhgd;->d:Z

    if-nez v2, :cond_3

    iget-object v0, v0, Lhgd;->c:Ljava/util/LinkedList;
    ...
    iput-boolean v2, v0, Lhgd;->d:Z

    invoke-virtual {v0}, Lhgd;->a()V
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->s:Lerr;

    new-instance p2, Lerq;

    invoke-direct {p2, p1}, Lerq;-><init>(Lerr;)V

    new-instance p1, Llkx;

    new-instance p3, Lhfy;

    invoke-direct {p3, p0, p2}, Lhfy;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lerq;)V

    const/16 p2, 0x9

    const-string v0, "CameraProcessingThread"

    invoke-direct {p1, p2, p3, v0}, Llkx;-><init>(ILjava/lang/Runnable;Ljava/lang/String;)V
