...
.method public constructor <init>(Loxn;Z)V
    ...
    iput-object v0, p0, Lhll;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-boolean v1, p0, Lhll;->d:Z

    iput-object p1, p0, Lhll;->b:Loxn;
...
# virtual methods
.method final declared-synchronized a(Lmpp;Lhjw;)Loab;
    .locals 19
    ...
    :try_start_0
    iget-boolean v2, v1, Lhll;->d:Z

    if-nez v2, :cond_0

    iget-object v2, v1, Lhll;->b:Loxn;
    ...
    :cond_1
    :try_start_1
    iget-object v3, v0, Lhjw;->n:Landroid/graphics/Rect;
    ...
    iget-object v5, v0, Lhjw;->s:Landroid/graphics/Rect;
    ...
    iget-object v7, v0, Lhjw;->s:Landroid/graphics/Rect;
    ...
    invoke-direct {v8, v4, v5}, Lhkk;-><init>(FF)V

    iget-boolean v4, v0, Lhjw;->q:Z

    const/4 v5, 0x0

    if-nez v4, :cond_5

    iget-object v4, v1, Lhll;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget v11, v9, Lpha;->a:I

    or-int/lit8 v11, v11, 0x4

    iput v11, v9, Lpha;->a:I
    ...
    sget-object v7, Lphg;->l:Lphg;

    invoke-virtual {v7}, Lpct;->f()Lpco;

    move-result-object v7

    iget-wide v11, v0, Lhjw;->b:J

    iget-boolean v9, v7, Lpco;->c:Z
    ...
    iput-boolean v5, v7, Lpco;->c:Z

    :goto_5
    iget-object v9, v7, Lpco;->b:Lpct;

    check-cast v9, Lphg;

    iget v13, v9, Lphg;->a:I

    const/4 v14, 0x2

    or-int/2addr v13, v14

    iput v13, v9, Lphg;->a:I

    iput-wide v11, v9, Lphg;->c:J

    invoke-virtual {v8, v3}, Lhkk;->a([Lhjv;)Lpgu;
    ...
    iget-boolean v0, v0, Lhjw;->q:Z

    or-int/lit16 v3, v3, 0x200

    iput v3, v8, Lphg;->a:I

    iput-boolean v0, v8, Lphg;->f:Z

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v6, v8, Lphg;->d:Lpha;
    ...
    invoke-virtual/range {v18 .. v18}, Lpba;->b()[B
    ...
    :try_start_6
    iget-object v2, v2, Lcom/google/android/libraries/vision/smartcapture/BurstCurator;->a:Lpcg;

    sget-object v3, Lphg;->l:Lphg;

    invoke-static {v3, v0, v2}, Lpct;->a(Lpct;[BLpcg;)Lpct;

    move-result-object v0

    check-cast v0, Lphg;
    :try_end_6
    .catch Lpde; {:try_start_6 .. :try_end_6} :catch_0
    ...
    invoke-direct {v2, v0}, Lhli;-><init>(Lphg;)V
...
.method public final declared-synchronized close()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lhll;->d:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lhll;->d:Z

    iget-object v0, p0, Lhll;->b:Loxn;

    new-instance v1, Lhlk;

    invoke-direct {v1, p0}, Lhlk;-><init>(Lhll;)V
