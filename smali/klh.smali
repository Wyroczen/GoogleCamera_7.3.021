...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lklh;->q:Z

    const/4 v1, 0x1

    invoke-static {v1}, Lklh;->a(I)Z
    ...
    :goto_0
    sput-object v2, Lklh;->a:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1
    sput-object v2, Lklh;->b:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_2
    sput-object v2, Lklh;->c:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_3
    sput-object v1, Lklh;->d:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_4
    sput-object v2, Lklh;->e:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_5
    sput-object v2, Lklh;->f:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_7
    sput-object v1, Lklh;->h:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_8
    sput-object v1, Lklh;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_9
    sput-object v1, Lklh;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_a
    sput-object v0, Lklh;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_b
    sput-object v0, Lklh;->l:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_c
    sput-object v1, Lklh;->m:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_d
    sput-object v1, Lklh;->n:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_e
    sput-object v1, Lklh;->o:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_f
    sput-object v3, Lklh;->p:Landroid/hardware/camera2/CaptureResult$Key;
