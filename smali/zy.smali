...
.method public static a(Ljava/util/Iterator;)Ljava/util/Iterator;
    ...
    invoke-direct {v0, p0}, Loiq;-><init>(Ljava/util/Iterator;)V
...
.method public static a(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    instance-of v0, p0, Loil;

    if-eqz v0, :cond_1

    check-cast p0, Loil;

    iget-object p0, p0, Loil;->a:Ljava/util/List;
    ...
    invoke-direct {v0, p0}, Loij;-><init>(Ljava/util/List;)V
    ...
    invoke-direct {v0, p0}, Loil;-><init>(Ljava/util/List;)V

    return-object v0
.end method

.method public static a(Ljava/util/List;Lnzv;)Ljava/util/List;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Loin;-><init>(Ljava/util/List;Lnzv;)V
    ...
    invoke-direct {v0, p0, p1}, Loip;-><init>(Ljava/util/List;Lnzv;)V
...
.method public static a(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;
    ...
    invoke-direct {v0, p0}, Lois;-><init>(Ljava/util/Map$Entry;)V
...
.method public static a(Ljava/util/Map;)Lohg;
    ...
    invoke-direct {p0, v3}, Logv;-><init>(Ljava/util/EnumMap;)V
    ...
    invoke-static {p0, v0}, Lohg;->b(Ljava/lang/Object;Ljava/lang/Object;)Lohg;
...
.method public static a(Ljava/util/List;Loae;)V
    .locals 4
    ...
    invoke-static {p0, p1, v1, v0}, Lzy;->a(Ljava/util/List;Loae;II)V
...
.method private static a(Ljava/util/List;Loae;II)V
    .locals 2
    ...
    invoke-interface {p1, v1}, Loae;->a(Ljava/lang/Object;)Z
...
.method public static d(Ljava/util/Iterator;)Lolc;
    .locals 1

    invoke-static {p0}, Luu;->a(Ljava/lang/Object;)Ljava/lang/Object;

    instance-of v0, p0, Lolc;

    if-nez v0, :cond_0

    new-instance v0, Loif;

    invoke-direct {v0, p0}, Loif;-><init>(Ljava/util/Iterator;)V
