...
.method public static a(Landroid/content/Context;)Landroid/content/Context;
    ...
    sget-object v0, Lpme;->g:Landroid/content/Context;
    ...
    sput-object p0, Lpme;->g:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Lpke;-><init>(I)V
    ...
    :cond_1
    :goto_0
    sget-object p0, Lpme;->g:Landroid/content/Context;
...
.method public static a(Ljava/lang/String;)Llul;
    .locals 1
...
.method public static a(Llva;Loxn;Ljava/lang/String;Ljava/lang/String;)Loxn;
    .locals 1

    new-instance v0, Lcll;

    invoke-direct {v0, p0, p2, p3}, Lcll;-><init>(Llva;Ljava/lang/String;Ljava/lang/String;)V

    sget-object p0, Lowt;->a:Lowt;

    invoke-static {p1, v0, p0}, Loyz;->a(Loxn;Loxc;Ljava/util/concurrent/Executor;)V
...
.method public static declared-synchronized b(Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-object v1, Lpme;->c:Ljava/lang/Boolean;
    :try_end_0
    ...
    sget-object v3, Lpkd;->c:Landroid/content/pm/Signature;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    sget-object v3, Lpkd;->d:Landroid/content/pm/Signature;

    aput-object v3, v1, v2

    const/4 v2, 0x2

    sget-object v3, Lpkd;->b:Landroid/content/pm/Signature;

    aput-object v3, v1, v2

    invoke-static {p0, v1}, Lpkd;->a(Landroid/content/pm/PackageInfo;[Landroid/content/pm/Signature;)Z
    ...
    sput-object p0, Lpme;->c:Ljava/lang/Boolean;
    :try_end_1
    ...
    :cond_0
    :goto_0
    sget-object p0, Lpme;->c:Ljava/lang/Boolean;
...
.method public static c(Landroid/content/Context;)Lpji;
    .locals 7
    ...
    invoke-direct {v2, v5, v4}, Lpjj;-><init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    iget-object v0, v2, Lpjj;->a:Landroid/content/ContentProviderClient;

    iget-object v1, v2, Lpjj;->b:Ljava/lang/String;

    invoke-direct {p0, v0, v1}, Lpiq;-><init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Lpjf;-><init>(Landroid/content/Context;)V
