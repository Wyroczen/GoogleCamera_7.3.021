...
# direct methods
.method public constructor <init>(JLhhq;Loyd;)V
    .locals 0
    ...
    iput-object p3, p0, Lcva;->b:Lhhq;

    iput-object p4, p0, Lcva;->c:Loyd;
...
.method private static a(Landroid/graphics/Point;Lmzb;Landroid/graphics/Rect;)Landroid/graphics/Point;
    .locals 7

    invoke-virtual {p1}, Lmzb;->a()I

    move-result v0

    int-to-float v0, v0

    invoke-virtual {p1}, Lmzb;->b()I
...
.method public final run()V
    ...
    :try_start_0
    iget-object v0, v1, Lcva;->b:Lhhq;

    iget-object v0, v0, Lhhq;->c:Loxn;
    ...
    iget-object v6, v1, Lcva;->b:Lhhq;

    iget-object v6, v6, Lhhq;->a:Lmpp;

    invoke-interface {v6}, Lmpp;->e()Ljava/util/List;
    ...
    iget-object v8, v1, Lcva;->b:Lhhq;

    iget-object v8, v8, Lhhq;->a:Lmpp;

    invoke-interface {v8}, Lmpp;->c()I

    move-result v8

    iget-object v9, v1, Lcva;->b:Lhhq;

    iget-object v9, v9, Lhhq;->a:Lmpp;

    invoke-interface {v9}, Lmpp;->d()I

    move-result v9

    invoke-static {v8, v9}, Lmzb;->a(II)Lmza;

    move-result-object v8

    sget-object v9, Landroid/hardware/camera2/CaptureResult;->STATISTICS_FACES:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v0, v9}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v10}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v10, v0}, Lpaj;->a(Landroid/graphics/Rect;Lmpa;)Lcom/google/googlex/gcam/MeshWarp;
    ...
    invoke-interface {v4}, Lmpo;->getRowStride()I
    ...
    invoke-interface {v6}, Lmpo;->getPixelStride()I
    ...
    iget-object v4, v4, Lhhq;->i:Lhud;

    invoke-virtual {v4}, Lhud;->ordinal()I
    ...
    iget-object v4, v4, Lhhq;->d:Liin;

    if-eqz v4, :cond_a

    sget-object v4, Loqz;->c:Loqz;
    ...
    invoke-virtual {v4, v0, v6, v5}, Lpco;->a([BILpcg;)Lpco;
    ...
    iget-object v2, v2, Lhhq;->d:Liin;

    invoke-interface {v2, v0}, Liin;->a(Loqz;)V
    ...
    invoke-static {v2, v8, v10}, Lcva;->a(Landroid/graphics/Point;Lmzb;Landroid/graphics/Rect;)Landroid/graphics/Point;

    move-result-object v2

    invoke-static {v3, v8, v10}, Lcva;->a(Landroid/graphics/Point;Lmzb;Landroid/graphics/Rect;)Landroid/graphics/Point;
