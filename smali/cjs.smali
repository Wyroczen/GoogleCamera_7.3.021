...
.method public constructor <init>(Landroid/content/Context;Lbfh;Lhqf;Lhgd;Lckq;Lckz;Lckj;Lilu;Lckk;Llvi;Ljava/util/concurrent/ExecutorService;Lllp;)V
    .locals 2
    ...
    iput-object p3, p0, Lcjs;->g:Lhqf;

    iput-object p4, p0, Lcjs;->i:Lhgd;
...
.method private final a(Landroid/net/Uri;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {p2, v1}, Lnck;->a(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lnab;
    ...
    invoke-interface {p2, p3, v0}, Lnab;->a(Ljava/util/concurrent/Executor;Lmyo;)Lnab;
...
.method public final a(Lbkk;Lbki;)V
    ...
    invoke-interface {p2}, Lbki;->e()Lewq;
    ...
    invoke-virtual {v2, v3}, Llun;->equals(Ljava/lang/Object;)Z

    move-result v2

    iget-object v0, v0, Lewq;->h:Landroid/net/Uri;

    iget-object v3, v1, Lewq;->h:Landroid/net/Uri;
    ...
    iget-object p1, v1, Lewq;->h:Landroid/net/Uri;
...
.method public final a(Lbkk;Z)V
    ...
    invoke-static {p2, v2}, Lijc;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-interface {v0}, Lbki;->f()Lewo;
...
.method public final a(Llty;)V
    ...
    invoke-direct {v0, p0, p1}, Lcjp;-><init>(Lcjs;Llty;)V
    ...
    invoke-interface {p1, v1}, Llkw;->a(Llul;)Llul;
...
.method public final a(Lbki;Z)Z
    ...
    invoke-interface {p1}, Lbki;->e()Lewq;
...
.method public final c()Loxn;
    ...
    invoke-direct {v1, p0, v2, v3, v0}, Lcjl;-><init>(Lcjs;JLoyd;)V
