...
.method public final run()V
    ...
    invoke-virtual {v1}, Liwf;->c()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Liwf;->d()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual {v1}, Liwf;->e()I
    ...
    iget-object v3, v0, Liwi;->a:Liwf;

    iget-object v4, v0, Liwi;->b:Ljava/util/List;

    invoke-static {v4}, Lohb;->a(Ljava/util/Collection;)Lohb;

    move-result-object v4

    new-instance v5, Liwq;

    invoke-direct {v5, v2, v3, v4, v1}, Liwq;-><init>(Landroid/view/View;Liwf;Lohb;Landroid/widget/PopupWindow;)V

    iput-object v5, v0, Liwi;->c:Liwq;

    iget-object v1, v0, Liwi;->a:Liwf;

    invoke-virtual {v1}, Liwf;->h()Lepy;
    ...
    :goto_0
    iget-object v0, v0, Liwi;->c:Liwq;

    if-eqz v0, :cond_3

    iget-object v1, v0, Liwq;->i:Ljava/lang/Runnable;
    ...
    invoke-direct {v1, v0}, Liwl;-><init>(Liwq;)V

    iput-object v1, v0, Liwq;->i:Ljava/lang/Runnable;
    ...
    sget-object v2, Liwq;->b:Lj$/time/Duration;
    ...
    invoke-direct {v2, v0}, Liwm;-><init>(Liwq;)V
