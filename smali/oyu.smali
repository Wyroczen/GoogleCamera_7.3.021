...
.method public constructor <init>(Lcom/google/geo/lightfield/processing/ProgressCallback;)V
    ...
    iput-object p1, p0, Loyu;->a:Lcom/google/geo/lightfield/processing/ProgressCallback;
...
.method public final a()V
    ...
    sget-boolean v0, Loyu;->b:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Loyu;->c:Loyt;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    sput-boolean v1, Loyu;->b:Z

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Loyt;->obtainMessage(I)Landroid/os/Message;

    move-result-object v1

    invoke-virtual {v0, v1}, Loyt;->sendMessage(Landroid/os/Message;)Z

    :try_start_0
    iget-object v0, p0, Loyu;->d:Landroid/os/Looper;
...
.method public final setProgress(F)V
    ...
    iget-object v1, v0, Loyt;->a:Ljava/lang/ref/WeakReference;
