...
.method static a(Lmkj;Ldls;Llvi;Ldps;Lmon;)Lcom/google/googlex/gcam/Gcam;
    .locals 19
    ...
    invoke-static {v1, v3}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;)V

    :goto_0
    move-object/from16 v1, p1

    iget-object v5, v1, Ldls;->b:Lcom/google/googlex/gcam/InitParams;
    ...
    invoke-interface {v0, v12}, Lmkj;->c(Lmkp;)Ljava/util/List;
    ...
    iget-object v9, v15, Lmkm;->a:Ljava/lang/String;

    if-eqz v9, :cond_1

    invoke-interface {v0, v15}, Lmkj;->b(Lmkm;)Lmjy;

    move-result-object v9

    if-eqz v9, :cond_1

    invoke-static {v9}, Ldjt;->a(Lmjy;)Z

    move-result v15

    if-eqz v15, :cond_1

    invoke-static {v9}, Lpaj;->d(Lmjy;)Lcom/google/googlex/gcam/StaticMetadata;

    move-result-object v15

    invoke-virtual {v8, v15}, Lcom/google/googlex/gcam/StaticMetadataVector;->a(Lcom/google/googlex/gcam/StaticMetadata;)V

    invoke-interface {v9}, Lmjy;->H()Ljava/util/Set;
    ...
    invoke-interface {v0, v14}, Lmkj;->b(Lmkm;)Lmjy;
    ...
    :cond_4
    invoke-static {v14}, Ldjt;->a(Lmjy;)Z

    move-result v15

    if-eqz v15, :cond_7

    invoke-static {v14}, Lpaj;->d(Lmjy;)Lcom/google/googlex/gcam/StaticMetadata;

    move-result-object v14

    invoke-virtual {v8, v14}, Lcom/google/googlex/gcam/StaticMetadataVector;->a(Lcom/google/googlex/gcam/StaticMetadata;)V

    invoke-virtual/range {p4 .. p4}, Lmon;->e()Z
    ...
    invoke-virtual/range {p3 .. p3}, Ldps;->a()V
    ...
    :goto_6
    invoke-interface/range {p2 .. p2}, Llvi;->a()V

    return-object v9
.end method

.method public static a(Lchh;Levz;Ldjf;Lpng;Lcie;)Ldls;
    .locals 7

    new-instance v6, Ldls;
    ...
    invoke-direct/range {v0 .. v5}, Ldls;-><init>(Lchh;Levz;Ldjf;Lpng;Lcie;)V

    return-object v6
.end method

.method public static a(Lpng;)Ldls;
    .locals 0

    invoke-static {p0}, Ldwh;->a(Lpng;)Ljava/lang/Object;
...
.method private static a(Lmjy;)Z
    .locals 5
    ...
    invoke-interface {p0, v0, v1}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static b(Lpng;)Lcom/google/googlex/gcam/Gcam;
    .locals 0
