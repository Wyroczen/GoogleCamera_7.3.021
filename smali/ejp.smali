...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lejp;->g:Ljava/lang/String;
...
.method public constructor <init>(Laiq;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lejp;->h:Landroid/graphics/SurfaceTexture;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lejp;->e:Z

    iput-object p1, p0, Lejp;->b:Laiq;

    iput-object p2, p0, Lejp;->a:Landroid/os/Handler;
...
.method public final declared-synchronized a(Landroid/view/WindowManager;Lchh;Laig;Z)Laju;
    ...
    :try_start_0
    iput-object p3, p0, Lejp;->c:Laig;

    const/4 p3, 0x1

    iput-boolean p3, p0, Lejp;->d:Z

    iget-object v0, p0, Lejp;->b:Laiq;
    ...
    sget-object p1, Lejp;->g:Ljava/lang/String;
    ...
    iget-object p4, p0, Lejp;->b:Laiq;

    invoke-virtual {p4}, Laiq;->e()Lajn;

    move-result-object p4

    invoke-static {p2, v0}, Lejs;->a(Lchh;Laje;)Lajb;
    ...
    invoke-static {v0}, Lejs;->b(Laje;)Laja;

    move-result-object p2

    iput-object p2, p4, Lajn;->r:Laja;

    invoke-static {v0}, Lejs;->a(Laje;)Lajc;
    ...
    invoke-static {v0}, Lejr;->a(Laje;)Lejq;

    move-result-object p2

    iget-object p3, p2, Lejq;->a:Laju;

    iput-object p3, p0, Lejp;->f:Laju;

    invoke-virtual {p4, p3}, Lajn;->b(Laju;)V

    invoke-static {v0, p4}, Lejs;->a(Laje;Lajn;)V
    ...
    iget-object p2, p0, Lejp;->h:Landroid/graphics/SurfaceTexture;

    invoke-virtual {p1, p2}, Laiq;->a(Landroid/graphics/SurfaceTexture;)V

    iget-boolean p1, p0, Lejp;->d:Z

    if-eqz p1, :cond_3

    iget-object p1, p0, Lejp;->b:Laiq;

    iget-object p2, p0, Lejp;->f:Laju;

    iget-object p3, p0, Lejp;->a:Landroid/os/Handler;

    iget-object p4, p0, Lejp;->c:Laig;

    invoke-static {p1, p2, p3, p4}, Lejs;->a(Laiq;Laju;Landroid/os/Handler;Laig;)V
    ...
    iget-object p2, p0, Lejp;->a:Landroid/os/Handler;

    iget-object p3, p0, Lejp;->c:Laig;

    invoke-virtual {p1, p2, p3}, Laiq;->a(Landroid/os/Handler;Laig;)V

    :goto_1
    iget-object p1, p0, Lejp;->f:Laju;
    :try_end_3
