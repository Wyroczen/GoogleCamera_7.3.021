...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Lnso;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, p2}, Lnsl;->g(Landroid/view/View;)Z
    ...
    iget-object p1, p0, Lnsl;->g:Landroid/view/VelocityTracker;
    ...
    iput-object p1, p0, Lnsl;->g:Landroid/view/VelocityTracker;

    :goto_2
    iget-object p1, p0, Lnsl;->b:Landroid/widget/OverScroller;
...
.method public final b(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, v1}, Lnsl;->f(Landroid/view/View;)I

    move-result v5

    invoke-virtual/range {p0 .. p0}, Lnsl;->d()I
    ...
    invoke-virtual {v0, v1, v8, v5, v7}, Lnsl;->a(Landroid/view/View;III)V
    ...
    :cond_5
    iget-object v3, v0, Lnsl;->g:Landroid/view/VelocityTracker;
    ...
    invoke-virtual {v0, v1}, Lnsl;->e(Landroid/view/View;)I

    move-result v8

    neg-int v8, v8

    iget-object v9, v0, Lnsl;->a:Ljava/lang/Runnable;

    if-eqz v9, :cond_6

    invoke-virtual {v1, v9}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v4, v0, Lnsl;->a:Ljava/lang/Runnable;

    :cond_6
    iget-object v9, v0, Lnsl;->b:Landroid/widget/OverScroller;
    ...
    iput-object v9, v0, Lnsl;->b:Landroid/widget/OverScroller;
    ...
    invoke-virtual/range {p0 .. p0}, Lnso;->e()I
    ...
    iget-object v3, v0, Lnsl;->b:Landroid/widget/OverScroller;
    ...
    invoke-direct {v3, v0, v1}, Lnsk;-><init>(Lnsl;Landroid/view/View;)V

    iput-object v3, v0, Lnsl;->a:Ljava/lang/Runnable;
    ...
    :cond_8
    invoke-virtual {v0, v1}, Lnsl;->h(Landroid/view/View;)V
    ...
    iput-object v4, v0, Lnsl;->g:Landroid/view/VelocityTracker;
