...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lkud;Lkqd;Lkqe;)V
    ...
    iget-object v0, v8, Lkud;->f:Llcr;

    iget-object v0, v8, Lkud;->g:Ljava/lang/Integer;

    new-instance v9, Landroid/os/Bundle;

    invoke-direct {v9}, Landroid/os/Bundle;-><init>()V

    iget-object v1, v8, Lkud;->a:Landroid/accounts/Account;
    ...
    iput-boolean v10, v7, Llda;->q:Z

    iput-object v8, v7, Llda;->r:Lkud;

    iput-object v9, v7, Llda;->s:Landroid/os/Bundle;

    iget-object v0, v8, Lkud;->g:Ljava/lang/Integer;

    iput-object v0, v7, Llda;->t:Ljava/lang/Integer;
...
.method protected final bridge synthetic a(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    instance-of v1, v0, Llcx;

    if-nez v1, :cond_0

    new-instance v0, Llcw;

    invoke-direct {v0, p1}, Llcw;-><init>(Landroid/os/IBinder;)V
...
.method public final a(Llcv;)V
    ...
    invoke-static {v2, v3}, Lkvw;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :try_start_0
    iget-object v3, v1, Llda;->r:Lkud;

    iget-object v3, v3, Lkud;->a:Landroid/accounts/Account;
    ...
    iget-object v0, v1, Lkty;->b:Landroid/content/Context;
    ...
    invoke-virtual {v0, v5}, Lkoa;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7}, Lkvw;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v1, Llda;->t:Ljava/lang/Integer;

    invoke-virtual {v5}, Ljava/lang/Integer;->intValue()I

    move-result v5

    invoke-direct {v0, v3, v5, v4}, Lkvp;-><init>(Landroid/accounts/Account;ILcom/google/android/gms/auth/api/signin/GoogleSignInAccount;)V

    invoke-virtual/range {p0 .. p0}, Lkty;->s()Landroid/os/IInterface;
    ...
    invoke-direct {v4, v0}, Lldb;-><init>(Lkvp;)V

    invoke-interface {v3, v4, v2}, Llcx;->a(Lldb;Llcv;)V
    :try_end_2
    ...
    invoke-interface {v2, v0}, Llcv;->a(Lldd;)V
    :try_end_3
...
.method public final l()V
    ...
    invoke-direct {v0, p0}, Lktu;-><init>(Lkty;)V

    invoke-virtual {p0, v0}, Lkty;->a(Lkts;)V
...
.method protected final q()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Llda;->s:Landroid/os/Bundle;

    iget-object v1, p0, Llda;->r:Lkud;
