...
.method public static a(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
    ...
    invoke-direct {v0, p0}, Loyc;-><init>(Ljava/util/concurrent/Executor;)V

    return-object v0
.end method

.method public static a(Ljava/util/concurrent/Executor;Lovx;)Ljava/util/concurrent/Executor;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Loxs;-><init>(Ljava/util/concurrent/Executor;Lovx;)V
...
.method public static a(Ljava/lang/Iterable;)Loxn;
    .locals 2

    new-instance v0, Lowo;

    invoke-static {p0}, Lohb;->a(Ljava/lang/Iterable;)Lohb;

    move-result-object p0

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, Lowo;-><init>(Logs;Z)V

    return-object v0
.end method

.method public static a(Ljava/lang/Object;)Loxn;
    .locals 1
    ...
    invoke-direct {v0, p0}, Loxk;-><init>(Ljava/lang/Object;)V

    return-object v0

    :cond_0
    sget-object p0, Loxk;->a:Loxn;

    return-object p0
.end method

.method public static a(Ljava/lang/Throwable;)Loxn;
    .locals 1
    ...
    invoke-direct {v0, p0}, Loxj;-><init>(Ljava/lang/Throwable;)V

    return-object v0
.end method

.method public static a(Lowk;Ljava/util/concurrent/Executor;)Loxn;
    .locals 0

    invoke-static {p0}, Loyj;->a(Lowk;)Loyj;
...
.method public static a(Loxn;)Loxn;
    .locals 2

    invoke-interface {p0}, Loxn;->isDone()Z
    ...
    invoke-direct {v0, p0}, Loxh;-><init>(Loxn;)V

    sget-object v1, Lowt;->a:Lowt;

    invoke-interface {p0, v0, v1}, Loxn;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public static a(Loxn;JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/ScheduledExecutorService;)Loxn;
    .locals 2
    ...
    invoke-direct {v0, p0}, Loyg;-><init>(Loxn;)V

    new-instance v1, Loye;

    invoke-direct {v1, v0}, Loye;-><init>(Loyg;)V

    invoke-interface {p4, v1, p1, p2, p3}, Ljava/util/concurrent/ScheduledExecutorService;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p1

    iput-object p1, v0, Loyg;->b:Ljava/util/concurrent/ScheduledFuture;

    sget-object p1, Lowt;->a:Lowt;

    invoke-interface {p0, v1, p1}, Loxn;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public static varargs a([Loxn;)Loxn;
    .locals 2
    ...
    invoke-static {p0}, Lohb;->a([Ljava/lang/Object;)Lohb;
...
.method public static a(Ljava/util/concurrent/ExecutorService;)Loxp;
    .locals 1

    instance-of v0, p0, Loxp;
    ...
    invoke-direct {v0, p0}, Loxx;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    invoke-direct {v0, p0}, Loxu;-><init>(Ljava/util/concurrent/ExecutorService;)V
...
.method public static a(Lchl;Lchh;)V
    ...
    invoke-interface {p1, v4}, Lchh;->a(Lchk;)Loab;
...
.method public static a(Lchl;Lchh;Lcie;)V
    ...
    sget-object p1, Lklf;->b:Landroid/hardware/camera2/CaptureRequest$Key;
...
.method public static a(Loxn;Loxc;Ljava/util/concurrent/Executor;)V
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Loxe;-><init>(Ljava/util/concurrent/Future;Loxc;)V

    invoke-interface {p0, v0, p2}, Loxn;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public static b(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Loyz;->a(Ljava/util/concurrent/Future;)Ljava/lang/Object;
...
.method public static varargs b([Loxn;)Loxg;
    .locals 2
    .annotation runtime Ljava/lang/SafeVarargs;
    .end annotation
    ...
    invoke-direct {v0, v1, p0}, Loxg;-><init>(ZLohb;)V
...
.method public static c(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0}, Lowu;-><init>(Ljava/lang/Error;)V
...
.method public static c()Loxp;
    ...
    invoke-direct {v0, v1}, Loxt;-><init>([B)V
