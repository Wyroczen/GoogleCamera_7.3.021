...
# instance fields
.field private final c:Lmjy;

.field private final d:Lmkj;

.field private final e:Lmom;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpaj;->a:Ljava/lang/String;

    invoke-static {}, Lmon;->a()Lmon;

    move-result-object v0

    sput-object v0, Lpaj;->b:Lmon;

    return-void
.end method

.method public constructor <init>(Lmjy;Lmkj;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lpaj;->c:Lmjy;

    iput-object p2, p0, Lpaj;->d:Lmkj;

    invoke-static {}, Lmom;->a()Lmom;

    move-result-object p2

    iput-object p2, p0, Lpaj;->e:Lmom;

    sget-object p2, Lpaj;->b:Lmon;

    invoke-virtual {p2}, Lmon;->c()Z
    ...
    invoke-virtual {p2}, Lmon;->d()Z

    move-result p2

    if-nez p2, :cond_0

    invoke-interface {p1}, Lmjy;->g()Lmko;
...
.method public static a(Lmjy;Lmpa;)I
    .locals 6

    invoke-interface {p0}, Lmjy;->N()Lmkp;

    move-result-object v0

    invoke-interface {p0}, Lmjy;->C()Z

    move-result v1

    invoke-interface {p0}, Lmjy;->J()Ljava/util/List;
    ...
    invoke-interface {p1, p0}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    sget-object p0, Lpaj;->b:Lmon;

    invoke-virtual {p0}, Lmon;->e()Z
    ...
    :cond_b
    invoke-static {p1}, Lpaj;->g(Lmpa;)Ljava/lang/Integer;
...
.method public static a(Landroid/graphics/Rect;Lmpa;)Lcom/google/googlex/gcam/MeshWarp;
    .locals 12
    ...
    sget-object v0, Lklh;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-interface {p1, v1}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    :cond_3
    sget-object p0, Lpaj;->a:Ljava/lang/String;
...
.method public static a(Lmjy;)Lmlc;
    .locals 6

    const/16 v0, 0x25

    invoke-interface {p0, v0}, Lmjy;->a(I)Ljava/util/List;

    move-result-object v1

    const/16 v2, 0x26

    invoke-interface {p0, v2}, Lmjy;->a(I)Ljava/util/List;

    move-result-object v3

    const/16 v4, 0x20

    invoke-interface {p0, v4}, Lmjy;->a(I)Ljava/util/List;
    ...
    invoke-static {v1}, Lhlt;->a(Ljava/util/List;)Llun;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Lmlc;-><init>(ILlun;)V
    ...
    invoke-direct {p0, v2, v0}, Lmlc;-><init>(ILlun;)V
    ...
    invoke-direct {v0, v4, p0}, Lmlc;-><init>(ILlun;)V
...
.method private static a(Lmpe;Ljava/lang/String;)Lmpe;
    .locals 3
    ...
    sget-object v0, Lpaj;->a:Ljava/lang/String;
...
.method public static b(Lmjy;)J
    .locals 2

    invoke-static {p0}, Lpaj;->a(Lmjy;)Lmlc;
    ...
    invoke-interface {p0, v1, v0}, Lmjy;->a(ILlun;)J
...
.method public static c(Lmjy;)I
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lpaj;->a(Lmjy;Lmpa;)I
...
.method public static d(Lmjy;)Lcom/google/googlex/gcam/StaticMetadata;
    .locals 18
    ...
    sget-object v0, Lmoo;->a:Lmop;

    const-string v2, "ro.revision"

    invoke-virtual {v0, v2}, Lmop;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lpaj;->c(Lmjy;)I

    move-result v0

    invoke-virtual {v8, v0}, Lcom/google/googlex/gcam/StaticMetadata;->a(I)V

    invoke-interface/range {p0 .. p0}, Lmjy;->I()Z
    ...
    invoke-interface/range {p0 .. p0}, Lmjy;->N()Lmkp;

    move-result-object v0

    sget-object v2, Lmkp;->a:Lmkp;

    invoke-virtual {v0}, Lmkp;->ordinal()I
    ...
    invoke-interface/range {p0 .. p0}, Lmjy;->h()Ljava/util/List;
    ...
    invoke-interface {v1, v0}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v0}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    sget-object v3, Lpaj;->a:Ljava/lang/String;
    ...
    invoke-interface {v1, v3}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {v4, v5}, Lpaj;->a(J)F
    ...
    sget-object v0, Lpaj;->b:Lmon;

    invoke-virtual {v0}, Lmon;->e()Z
    ...
    invoke-static {v2}, Lpaj;->a(Landroid/hardware/camera2/params/ColorSpaceTransform;)[F
    ...
    invoke-static {v3}, Lpaj;->a(Landroid/hardware/camera2/params/ColorSpaceTransform;)[F
    ...
    :try_start_0
    sget-object v2, Lklf;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    invoke-interface {v1, v2}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    sget-object v3, Lklf;->m:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v4, Lklf;->n:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {v1, v4}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    sget-object v2, Lklf;->o:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-nez v2, :cond_19

    sget-object v2, Lpaj;->a:Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lpaj;->a(Lmjy;)Lmlc;

    move-result-object v0

    iget-object v2, v0, Lmlc;->b:Llun;
    ...
    invoke-static/range {p0 .. p0}, Lpaj;->b(Lmjy;)J

    move-result-wide v2

    iget-wide v4, v8, Lcom/google/googlex/gcam/StaticMetadata;->a:J

    invoke-static {v2, v3}, Lpaj;->a(J)F
...
.method private static f(Lmpa;)F
    .locals 2

    sget-object v0, Landroid/hardware/camera2/CaptureResult;->SENSOR_EXPOSURE_TIME:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p0, v0}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Lpaj;->a(J)F
...
.method private static g(Lmpa;)Ljava/lang/Integer;
    .locals 1
...
.method public final a(I)F
    ...
    iget-object v0, p0, Lpaj;->c:Lmjy;

    sget-object v1, Landroid/hardware/camera2/CameraCharacteristics;->CONTROL_AE_COMPENSATION_STEP:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {v0, v1}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final a(Lmpa;)J
    .locals 2

    invoke-virtual {p0, p1}, Lpaj;->b(Lmpa;)Lmjy;

    move-result-object p1

    invoke-static {p1}, Lpaj;->b(Lmjy;)J
...
.method public final a(Lmpe;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
    ...
    invoke-virtual/range {p0 .. p1}, Lpaj;->b(Lmpa;)Lmjy;
    ...
    invoke-interface {v8}, Lmjy;->M()Lmkm;

    move-result-object v2

    iget-object v2, v2, Lmkm;->a:Ljava/lang/String;

    invoke-static {v0, v2}, Lpaj;->a(Lmpe;Ljava/lang/String;)Lmpe;

    move-result-object v2

    new-instance v3, Lpah;

    invoke-direct {v3, v2}, Lpah;-><init>(Lmpa;)V
    ...
    invoke-interface {v8, v4}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    iget-object v10, v3, Lpah;->a:[Landroid/hardware/camera2/params/Face;
    ...
    iget-object v1, v3, Lpah;->a:[Landroid/hardware/camera2/params/Face;
    ...
    iget-object v1, v3, Lpah;->d:[F

    iget-object v5, v3, Lpah;->c:[B
    ...
    invoke-interface {v2, v3}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v6}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v3, v9, v13}, Lpaj;->a([Landroid/hardware/camera2/params/MeteringRectangle;ZLcom/google/googlex/gcam/WeightedPixelRectVector;)V
    ...
    invoke-static {v5, v13, v3}, Lpaj;->a([Landroid/hardware/camera2/params/MeteringRectangle;ZLcom/google/googlex/gcam/WeightedPixelRectVector;)V
    ...
    invoke-static {v6, v5, v3}, Lpaj;->a([Landroid/hardware/camera2/params/MeteringRectangle;ZLcom/google/googlex/gcam/WeightedPixelRectVector;)V
    ...
    invoke-static {v2, v0}, Lpaj;->a(Landroid/graphics/Rect;Lmpa;)Lcom/google/googlex/gcam/MeshWarp;
    ...
    invoke-interface {v0, v2}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v3}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v4}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-direct {v3, v15}, Lpag;-><init>(Lcom/google/googlex/gcam/FrameMetadata;)V
    ...
    :goto_15
    invoke-interface/range {v28 .. v28}, Lmjy;->C()Z
    ...
    invoke-interface {v0, v5}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v2}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v3}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v4}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v5}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    :cond_25
    sget-object v2, Lklg;->b:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :cond_26
    sget-object v2, Lklg;->c:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v2, :cond_28

    sget-object v2, Lklg;->d:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v2, :cond_28

    sget-object v2, Lklg;->e:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v2, :cond_28

    sget-object v2, Lklg;->f:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v3, Lklg;->c:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v4, Lklg;->d:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v6, Lklg;->e:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {v11, v6}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, [I

    sget-object v12, Lklg;->f:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {v11, v12}, Lmjy;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {v11, v0}, Lpaj;->a(Lmjy;Lmpa;)I
    ...
    invoke-static/range {p1 .. p1}, Lpaj;->f(Lmpa;)F
    ...
    invoke-interface {v11, v3}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v4}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    :goto_1e
    invoke-virtual/range {p0 .. p1}, Lpaj;->d(Lmpa;)Lcom/google/googlex/gcam/AwbInfo;
    ...
    iget-object v2, v14, Lpaj;->e:Lmom;

    iget-boolean v2, v2, Lmom;->f:Z

    if-nez v2, :cond_31

    sget-object v2, Lpaj;->b:Lmon;

    invoke-virtual {v2}, Lmon;->c()Z
    ...
    invoke-static {v2, v3}, Lpaj;->a(FF)Z
    ...
    invoke-virtual {v12, v2}, Lcom/google/googlex/gcam/FrameMetadata;->a([F)V
    ...
    sget-object v2, Lklh;->d:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :cond_40
    sget-object v2, Lklh;->b:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-interface {v0, v1}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v2}, Lpaj;->a(I)F
    ...
    :cond_44
    sget-object v1, Lklf;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :cond_45
    sget-object v1, Lklg;->s:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-direct {v0, v2, v3}, Loyx;-><init>(J)V
    ...
    invoke-static {v0}, Loyx;->a(Loyx;)J
    ...
    sget-object v1, Lpaj;->a:Ljava/lang/String;
...
.method public final a(Lcom/google/googlex/gcam/AeShotParams;Lmpe;FLlun;)V
    .locals 17
    ...
    invoke-virtual {v2, v1}, Lpaj;->b(Lmpa;)Lmjy;

    move-result-object v3

    invoke-interface {v3}, Lmjy;->M()Lmkm;

    move-result-object v4

    iget-object v4, v4, Lmkm;->a:Ljava/lang/String;

    invoke-static {v1, v4}, Lpaj;->a(Lmpe;Ljava/lang/String;)Lmpe;

    move-result-object v4

    sget-object v5, Landroid/hardware/camera2/CaptureResult;->SCALER_CROP_REGION:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v4, v5}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v5, v1}, Lpaj;->a(Landroid/graphics/Rect;Lmpa;)Lcom/google/googlex/gcam/MeshWarp;
    ...
    invoke-interface {v4, v6}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v6}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/graphics/Rect;

    invoke-static/range {p4 .. p4}, Lltw;->a(Llun;)Lltw;

    move-result-object v6

    invoke-virtual {v6, v4}, Lltw;->a(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v6, v7, v8}, Lovg;->a(III)I
    ...
    invoke-static {v7, v8, v9}, Lovg;->a(III)I
...
.method public final a(Lcom/google/googlex/gcam/FrameRequest;Lmpe;Lpai;)V
    .locals 11

    invoke-virtual {p0, p2}, Lpaj;->b(Lmpa;)Lmjy;
    ...
    invoke-interface {p3, v4, v6}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, v4, v8}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, v4, v1}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, v1, v4}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, v2, v1}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V

    sget-object v1, Lpaj;->b:Lmon;

    invoke-virtual {v1}, Lmon;->e()Z
    ...
    iget-boolean v1, v1, Lmon;->h:Z

    if-nez v1, :cond_1

    sget-object v1, Lpaj;->b:Lmon;

    invoke-virtual {v1}, Lmon;->f()Z
    ...
    :cond_1
    :goto_0
    invoke-static {p2}, Lpaj;->g(Lmpa;)Ljava/lang/Integer;
    ...
    invoke-interface {p3, p2, v8}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    sget-object p1, Lpaj;->a:Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lmjy;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p3, p1, v0}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, p2, p1}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, p1, v6}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, p1, p2}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V

    sget-object p1, Landroid/hardware/camera2/CaptureRequest;->EDGE_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-interface {p3, p1, v8}, Lpai;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
...
.method public final b(Lmpa;)Lmjy;
    .locals 6

    iget-object v0, p0, Lpaj;->c:Lmjy;

    invoke-interface {v0}, Lmjy;->C()Z
    ...
    invoke-interface {v0}, Lmjy;->H()Ljava/util/Set;
    ...
    iget-object v3, p0, Lpaj;->d:Lmkj;

    invoke-interface {v3, v2}, Lmkj;->b(Lmkm;)Lmjy;

    move-result-object v2

    invoke-interface {v2}, Lmjy;->h()Ljava/util/List;
...
.method public final c(Lmpa;)Lcom/google/googlex/gcam/FrameMetadataKey;
    .locals 4
    ...
    invoke-static {v1, p1}, Lpaj;->a(Lmjy;Lmpa;)I
...
.method public final d(Lmpa;)Lcom/google/googlex/gcam/AwbInfo;
    .locals 7
    ...
    invoke-interface {p1, v4}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    :cond_2
    invoke-static {p1}, Lpaj;->a(Landroid/hardware/camera2/params/ColorSpaceTransform;)[F
...
.method public final e(Lmpa;)Lcom/google/googlex/gcam/SpatialGainMap;
    .locals 18
    ...
    invoke-interface {v1, v0}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface/range {p1 .. p1}, Lmpa;->c()Lmoz;
    ...
    invoke-interface {v0, v1}, Lmoz;->a(Landroid/hardware/camera2/CaptureRequest$Key;)Ljava/lang/Object;
