...
# direct methods
.method public constructor <init>(Lhkr;Lhkh;Lcox;Llva;)V
    .locals 1
    ...
    iput-object v0, p0, Lfsq;->e:Ljava/util/Map;

    iput-object p1, p0, Lfsq;->b:Lhkr;

    iput-object p2, p0, Lfsq;->a:Lhkh;

    iput-object p3, p0, Lfsq;->c:Lcox;
...
.method private final declared-synchronized a()V
    ...
    iget-object v2, v1, Lfsq;->e:Ljava/util/Map;
    ...
    iget-boolean v10, v9, Lfsp;->b:Z

    if-eqz v10, :cond_1d

    iget-object v10, v9, Lfsp;->e:Ljava/util/List;
    ...
    :try_start_2
    iget-object v10, v9, Lfsp;->a:Loyd;

    invoke-virtual {v10}, Loyd;->isDone()Z

    move-result v10

    if-nez v10, :cond_1

    iget-object v7, v9, Lfsp;->a:Loyd;

    sget-object v8, Lnzk;->a:Lnzk;

    invoke-virtual {v7, v8}, Loyd;->b(Ljava/lang/Object;)Z
    :try_end_2
    ...
    iget-object v11, v9, Lfsp;->e:Ljava/util/List;
    ...
    invoke-interface {v8, v7}, Llva;->b(Ljava/lang/String;)V
    ...
    :cond_3
    :try_start_5
    iget-object v12, v1, Lfsq;->d:Llva;
    ...
    invoke-interface {v12, v7}, Llva;->b(Ljava/lang/String;)V

    sget-object v7, Lpgm;->g:Lpgm;

    invoke-virtual {v7}, Lpct;->f()Lpco;

    move-result-object v7

    iget-boolean v12, v7, Lpco;->c:Z
    ...
    iput-boolean v8, v7, Lpco;->c:Z

    :goto_3
    iget-object v12, v7, Lpco;->b:Lpct;

    check-cast v12, Lpgm;

    iget v13, v12, Lpgm;->a:I

    const/4 v14, 0x2

    or-int/2addr v13, v14

    iput v13, v12, Lpgm;->a:I

    iput v14, v12, Lpgm;->d:I
    ...
    iget-wide v3, v13, Lfuq;->a:J

    iget v13, v13, Lfuq;->b:F

    iget-boolean v14, v9, Lfsp;->c:Z

    if-eqz v14, :cond_5

    iget-object v14, v1, Lfsq;->d:Llva;
    ...
    invoke-interface {v14, v15}, Llva;->b(Ljava/lang/String;)V
    ...
    invoke-interface {v14, v8}, Llva;->b(Ljava/lang/String;)V
    ...
    invoke-interface {v8, v2}, Llva;->b(Ljava/lang/String;)V

    mul-float v13, v13, v16

    :goto_5
    invoke-static {v13}, Lfsq;->a(F)V

    sget-object v2, Lpgl;->e:Lpgl;
    ...
    :goto_6
    iget-object v8, v2, Lpco;->b:Lpct;

    check-cast v8, Lpgl;

    iget v14, v8, Lpgl;->a:I

    or-int/lit8 v14, v14, 0x1

    iput v14, v8, Lpgl;->a:I

    iput-wide v3, v8, Lpgl;->b:J

    or-int/lit8 v3, v14, 0x2

    iput v3, v8, Lpgl;->a:I

    iput v13, v8, Lpgl;->c:F
    ...
    iget-object v3, v1, Lfsq;->d:Llva;

    iget-wide v13, v2, Lpgl;->b:J
    ...
    iput-boolean v3, v7, Lpco;->c:Z

    :goto_7
    iget-object v3, v7, Lpco;->b:Lpct;

    check-cast v3, Lpgm;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v4, v3, Lpgm;->b:Lpdb;
    ...
    iput-object v4, v3, Lpgm;->b:Lpdb;

    :cond_9
    iget-object v3, v3, Lpgm;->b:Lpdb;

    invoke-interface {v3, v2}, Lpdb;->add(Ljava/lang/Object;)Z
    :try_end_6
    ...
    iget-object v4, v1, Lfsq;->b:Lhkr;

    invoke-interface {v4, v2, v3}, Lhkr;->b(J)Lhkq;

    move-result-object v4

    if-nez v4, :cond_c

    iget-object v4, v1, Lfsq;->d:Llva;
    ...
    invoke-interface {v4, v2}, Llva;->f(Ljava/lang/String;)V
    ...
    iput-boolean v4, v7, Lpco;->c:Z

    :goto_b
    iget-object v4, v7, Lpco;->b:Lpct;

    check-cast v4, Lpgm;

    invoke-static {}, Lpgm;->j()Lpdb;

    move-result-object v8

    iput-object v8, v4, Lpgm;->e:Lpdb;

    iget-object v4, v1, Lfsq;->b:Lhkr;

    invoke-interface {v4}, Lhkr;->a()Ljava/util/List;
    ...
    iget v2, v15, Lpgl;->a:I

    or-int/lit8 v2, v2, 0x1

    iput v2, v15, Lpgl;->a:I

    iput-wide v12, v15, Lpgl;->b:J
    ...
    iput v3, v15, Lpgl;->c:F

    iget-object v2, v1, Lfsq;->a:Lhkh;

    iget-wide v12, v8, Lhkq;->a:J

    invoke-virtual {v2, v12, v13}, Lhkh;->a(J)Lpgi;
    ...
    iput-boolean v12, v14, Lpco;->c:Z

    :goto_e
    iget-object v12, v14, Lpco;->b:Lpct;

    check-cast v12, Lpgl;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v2, v12, Lpgl;->d:Lpgi;

    iget v2, v12, Lpgl;->a:I

    or-int/2addr v2, v3

    iput v2, v12, Lpgl;->a:I

    :goto_f
    iget-boolean v2, v7, Lpco;->c:Z
    ...
    :goto_10
    iget-object v2, v7, Lpco;->b:Lpct;

    check-cast v2, Lpgm;

    invoke-virtual {v14}, Lpco;->f()Lpct;
    ...
    iget-object v13, v2, Lpgm;->e:Lpdb;

    invoke-interface {v13}, Lpdb;->a()Z
    ...
    invoke-static {v13}, Lpct;->a(Lpdb;)Lpdb;

    move-result-object v13

    iput-object v13, v2, Lpgm;->e:Lpdb;
    :try_end_a
    .catchall {:try_start_a .. :try_end_a} :catchall_2

    :cond_14
    :try_start_b
    iget-object v2, v2, Lpgm;->e:Lpdb;

    invoke-interface {v2, v12}, Lpdb;->add(Ljava/lang/Object;)Z

    iget-wide v12, v8, Lhkq;->a:J

    iget-wide v14, v9, Lfsp;->d:J
    :try_end_b
    ...
    iget-object v13, v1, Lfsq;->d:Llva;
    ...
    invoke-interface {v13, v3}, Llva;->e(Ljava/lang/String;)V
    ...
    :goto_13
    invoke-virtual {v10, v7}, Loyd;->b(Ljava/lang/Object;)Z

    iget-wide v0, v9, Lfsp;->d:J
    ...
    :try_start_11
    iget-object v0, v2, Lfsq;->e:Ljava/util/Map;
    ...
    iget-object v3, v2, Lfsq;->e:Ljava/util/Map;
...
.method private final declared-synchronized e(Landroid/net/Uri;)Lfsp;
    .locals 3

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lfsq;->e:Ljava/util/Map;
    ...
    invoke-direct {v1, v2}, Lfsp;-><init>([B)V
...
.method public final declared-synchronized a(Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1}, Lfsq;->e(Landroid/net/Uri;)Lfsp;

    move-result-object p1

    invoke-static {p1}, Lfsp;->a(Lfsp;)V

    const/4 v0, 0x0

    iput-boolean v0, p1, Lfsp;->c:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Landroid/net/Uri;J)V
    ...
    iput-wide p2, p1, Lfsp;->d:J

    :cond_0
    invoke-direct {p0}, Lfsq;->a()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Landroid/net/Uri;Ljava/util/List;)V
    ...
    invoke-interface {v1, p1}, Llva;->b(Ljava/lang/String;)V

    iput-object p2, v0, Lfsp;->e:Ljava/util/List;
...
.method public final declared-synchronized c(Landroid/net/Uri;)Loxn;
    .locals 4
...
.method public final declared-synchronized d(Landroid/net/Uri;)V
    ...
    iget-boolean v0, p1, Lfsp;->b:Z

    if-nez v0, :cond_0

    iget-object p1, p1, Lfsp;->a:Loyd;
