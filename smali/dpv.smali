...
# direct methods
.method public constructor <init>(Ldpw;Lmpp;)V
    .locals 0
...
.method public final run()V
    ...
    iget-object v2, v1, Ldpv;->a:Ldpw;

    iget-object v0, v1, Ldpv;->b:Lmpp;

    :try_start_0
    iget-object v4, v2, Ldpw;->b:Ldpu;
    ...
    iget-object v5, v4, Ldpu;->c:Llvi;

    const-string v6, "Downsample YUV"

    invoke-interface {v5, v6}, Llvi;->b(Ljava/lang/String;)V

    iget-object v5, v4, Ldpu;->a:Lpaf;

    invoke-virtual {v5, v0}, Lpaf;->b(Lmpp;)Lcom/google/googlex/gcam/YuvWriteView;
    ...
    invoke-interface {v3, v7}, Llvi;->c(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Loyv;->a(Landroid/graphics/Bitmap;)Loyv;

    move-result-object v5

    iget-object v6, v5, Loyv;->a:Lcom/google/googlex/gcam/InterleavedWriteViewU8;
    ...
    invoke-virtual {v5}, Loyv;->close()V

    if-eqz v4, :cond_8

    iget-object v0, v0, Ldpu;->c:Llvi;
    ...
    sget-object v3, Ldpw;->a:Ljava/lang/String;

    const-string v4, "Could not map YUV to Bitmap"

    invoke-static {v3, v4, v0}, Lijc;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    sget-object v0, Ldpw;->a:Ljava/lang/String;
    ...
    :cond_9
    iget-object v0, v2, Ldpw;->c:Lhtj;

    invoke-virtual {v0, v3}, Lhtj;->a(Landroid/graphics/Bitmap;)V
