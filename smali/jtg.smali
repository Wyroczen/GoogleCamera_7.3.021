...
.method public constructor <init>(Ldve;Lchh;)V
    .locals 2
    ...
    iget-object p1, p1, Ldve;->a:Landroid/content/Context;

    const-string v1, "window"

    invoke-static {p1, v1}, Ldve;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v1, v0}, Llun;-><init>(II)V

    iput-object p1, p0, Ljtg;->b:Llun;

    iput-object p2, p0, Ljtg;->c:Lchh;
...
# virtual methods
.method final a(Ljava/util/List;D)Llun;
    .locals 16
    ...
    iget v13, v12, Llun;->a:I

    int-to-double v13, v13

    iget v15, v12, Llun;->b:I
...
.method public a(Ljava/util/List;DLmkp;Ljyr;Lmkm;)Llun;
    .locals 2
    ...
    :cond_0
    sget-object p6, Ljyr;->i:Ljyr;

    if-eq p5, p6, :cond_2

    sget-object p5, Lmkp;->a:Lmkp;

    if-eq p4, p5, :cond_1

    iget-object p4, p0, Ljtg;->c:Lchh;
    ...
    invoke-static {p1, p4}, Lhuj;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {v1, p5, v0}, Llun;-><init>(II)V
    ...
    :cond_6
    invoke-virtual {p0, p4, p2, p3}, Ljtg;->a(Ljava/util/List;D)Llun;

    move-result-object p1

    sget-object p2, Ljtg;->a:Ljava/lang/String;
