...
.method public constructor <init>(Landroid/os/Handler;Lbjp;Llvn;Lmkj;Llvk;Landroid/app/admin/DevicePolicyManager;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Semaphore;)V
    .locals 1
    ...
    iput-object p5, p0, Lbjv;->d:Llvk;

    iput-object p3, p0, Lbjv;->k:Llvn;

    iput-object p4, p0, Lbjv;->l:Lmkj;
...
.method public final a(Laiq;)V
    ...
    iget-object v0, p0, Lbjv;->h:Lmkm;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lmkm;->a()Z
...
.method public final a(Lbjp;Lmkm;Landroid/os/Handler;Lahy;)V
    .locals 2
    ...
    invoke-direct {p1, p0, p4, p2}, Lbju;-><init>(Lbjv;Lahy;Lmkm;)V
...
.method public final c()V
    ...
    iget-object v1, p0, Lbjv;->l:Lmkj;

    invoke-interface {v1, v0}, Lmkj;->a(I)Lmkm;
    ...
    iget-object v2, p0, Lbjv;->h:Lmkm;

    const/4 v3, 0x0

    if-eqz v2, :cond_1

    invoke-virtual {v2, v1}, Lmkm;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lbjv;->k:Llvn;

    invoke-interface {v2}, Llvn;->a()V

    iget-object v2, p0, Lbjv;->n:Ljava/util/concurrent/Executor;

    new-instance v3, Lbjr;

    invoke-direct {v3, p0, v1, v0}, Lbjr;-><init>(Lbjv;Lmkm;I)V
...
.method public final d()V
    ...
    :cond_0
    iget-object v3, p0, Lbjv;->h:Lmkm;

    const-string v4, ":"

    if-eqz v3, :cond_1

    invoke-virtual {v3}, Lmkm;->a()Z
    ...
    :goto_0
    iget-object v1, p0, Lbjv;->d:Llvk;

    iget-object v3, p0, Lbjv;->l:Lmkj;

    invoke-interface {v3, v0}, Lmkj;->a(I)Lmkm;

    move-result-object v0

    invoke-interface {v1, v0}, Llvk;->b(Lmkm;)V

    iput-object v2, p0, Lbjv;->h:Lmkm;
