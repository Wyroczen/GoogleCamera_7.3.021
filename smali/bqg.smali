...
# direct methods
.method public constructor <init>(Lbqj;Llyh;)V
    .locals 0
...
.method public final run()V
    ...
    iget-object v4, v2, Lbqj;->m:Llzr;

    invoke-interface {v3, v4}, Llyh;->a(Llzr;)Lmpp;
    ...
    invoke-interface {v3}, Llyh;->b()Llyl;
    ...
    iget-object v8, v2, Lbqj;->m:Llzr;

    invoke-interface {v8}, Llzr;->b()Llun;
    ...
    iget-object v10, v2, Lbqj;->l:Lpmi;

    invoke-interface {v10}, Lpmi;->get()Ljava/lang/Object;
    ...
    invoke-interface {v5, v10}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    iget-object v10, v2, Lbqj;->j:Lpaj;

    invoke-virtual {v10, v5}, Lpaj;->a(Lmpa;)J
    ...
    invoke-interface/range {v11 .. v16}, Lmlr;->a(JJLmlq;)Ljava/lang/Object;
    ...
    :goto_0
    invoke-virtual {v7, v6, v8, v5, v9}, Lbrz;->a(Llyl;Llun;Lmpe;Ljava/util/List;)Lphg;
    ...
    :try_start_1
    invoke-interface {v0, v4, v1}, Lcom/google/android/apps/camera/autotimer/analysis/jni/BaseCurator;->a(Lmpp;Lphg;)Lpid;
    ...
    :cond_6
    sget-object v6, Lpgx;->b:Lpgx;

    :goto_3
    iget-object v6, v6, Lpgx;->a:Lpda;
    ...
    iget-object v14, v2, Lbrw;->c:Loas;

    new-instance v15, Loal;

    invoke-direct {v15, v14}, Loal;-><init>(Loas;)V

    invoke-virtual {v15}, Loal;->c()V

    iput-object v15, v13, Lbrv;->a:Loal;
    ...
    :cond_8
    sget-object v5, Lpgw;->b:Lpgw;

    :goto_6
    iget-wide v5, v5, Lpgw;->a:J
    ...
    iget-object v10, v9, Lbrv;->a:Loal;

    invoke-virtual {v10}, Loal;->d()V

    iget-object v10, v9, Lbrv;->a:Loal;

    sget-object v11, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v10, v11}, Loal;->a(Ljava/util/concurrent/TimeUnit;)J
    ...
    :goto_a
    iget-object v9, v2, Lbrw;->b:Loal;

    iget-boolean v10, v9, Loal;->a:Z
    ...
    invoke-virtual {v9, v10}, Loal;->a(Ljava/util/concurrent/TimeUnit;)J
    ...
    iget-object v8, v2, Lbrw;->b:Loal;

    invoke-virtual {v8}, Loal;->b()V

    iget-object v8, v2, Lbrw;->b:Loal;

    invoke-virtual {v8}, Loal;->c()V
    ...
    invoke-direct/range {v12 .. v21}, Lbrt;-><init>(JJIIIFLphg;)V
    ...
    invoke-interface {v2, v6}, Llom;->a(Ljava/lang/Object;)V

    iget-boolean v0, v0, Lpie;->c:Z
    ...
    invoke-static {v0, v5, v2}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
