...
# direct methods
.method public synthetic constructor <init>(Lmxn;Lmxn;Lmxn;Lmxn;Lmxn;IIJ)V
    .locals 0
    ...
    iput-object p2, p0, Lmxm;->b:Lmxn;

    iput-object p3, p0, Lmxm;->c:Lmxn;

    iput-object p4, p0, Lmxm;->d:Lmxn;

    iput-object p5, p0, Lmxm;->e:Lmxn;

    iput p6, p0, Lmxm;->f:I

    iput p7, p0, Lmxm;->g:I

    iput-wide p8, p0, Lmxm;->h:J
    ...
    iput-object p1, p0, Lmxm;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final bridge synthetic call()Ljava/lang/Object;
    ...
    iget-object v0, v1, Lmxm;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, v1, Lmxm;->d:Lmxn;

    invoke-virtual {v0}, Lmxn;->a()Ljava/lang/Object;
    ...
    iget-object v4, v1, Lmxm;->c:Lmxn;

    invoke-virtual {v4}, Lmxn;->a()Ljava/lang/Object;
    ...
    iget-object v12, v1, Lmxm;->a:Lmxn;

    :try_start_0
    iget-object v13, v1, Lmxm;->b:Lmxn;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_b

    :try_start_1
    iget-object v14, v1, Lmxm;->e:Lmxn;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_9

    :try_start_2
    iget-object v15, v1, Lmxm;->d:Lmxn;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_7

    :try_start_3
    iget-object v9, v1, Lmxm;->c:Lmxn;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_5

    :try_start_4
    invoke-static {}, Lmyk;->e()Lmyj;

    move-result-object v4

    const-string v6, "Primary"

    iput-object v6, v4, Lmyj;->b:Ljava/lang/String;

    const/4 v6, 0x0

    invoke-virtual {v4, v6}, Lmyj;->b(I)V

    invoke-virtual {v4, v6}, Lmyj;->a(I)V

    const-string v7, "image/jpeg"

    iput-object v7, v4, Lmyj;->a:Ljava/lang/String;

    invoke-virtual {v4}, Lmyj;->a()Lmyk;
    ...
    iput-object v8, v7, Lmyj;->b:Ljava/lang/String;

    const-string v8, "video/mp4"

    iput-object v8, v7, Lmyj;->a:Ljava/lang/String;

    invoke-virtual {v7, v6}, Lmyj;->b(I)V

    iget-object v8, v1, Lmxm;->c:Lmxn;

    invoke-virtual {v8}, Lmxn;->a()Ljava/lang/Object;
    ...
    invoke-virtual {v7, v8}, Lmyj;->a(I)V

    invoke-virtual {v7}, Lmyj;->a()Lmyk;
    ...
    iget-wide v10, v1, Lmxm;->h:J

    new-array v2, v5, [Lmyk;
    ...
    new-instance v7, Lmyi;

    invoke-direct {v7}, Lmyi;-><init>()V
    ...
    :try_start_5
    iget-object v3, v7, Lmyi;->a:Ljava/util/List;
    ...
    invoke-static {v2, v10}, Lovg;->a(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v0, v11, v4}, Lmyk;->a(Lael;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v11, v5}, Lovg;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v11, v8}, Lmyk;->a(Lael;Ljava/lang/String;Ljava/lang/String;)V

    const-string v18, "http://ns.google.com/photos/1.0/container/item/"

    const-string v19, "Mime"

    invoke-virtual/range {v17 .. v17}, Lmyk;->a()Ljava/lang/String;
    ...
    :try_start_6
    invoke-static/range {v4 .. v9}, Lmyk;->a(Lael;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v7, "http://ns.google.com/photos/1.0/container/item/"

    const-string v8, "Semantic"

    invoke-virtual/range {v17 .. v17}, Lmyk;->b()Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v17}, Lmyk;->c()I
    ...
    invoke-virtual/range {v17 .. v17}, Lmyk;->d()I
    ...
    :try_start_7
    iget-object v2, v1, Lmxm;->b:Lmxn;

    invoke-virtual {v2}, Lmxn;->a()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Ljava/io/InputStream;

    iget-object v3, v1, Lmxm;->a:Lmxn;

    invoke-virtual {v3}, Lmxn;->a()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Ljava/io/InputStream;

    iget-object v4, v1, Lmxm;->e:Lmxn;
    ...
    invoke-static {v3, v4, v0}, Lnrt;->a(Ljava/io/InputStream;Ljava/io/OutputStream;Lael;)Z
    ...
    invoke-virtual {v3, v4}, Lmyi;->a(Lmyk;)V
    ...
    invoke-static/range {v16 .. v16}, Lmxu;->b(Lmyk;)Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v16}, Lmxu;->a(Lmyk;)Ljava/lang/String;
    ...
    :try_start_18
    iget-object v4, v1, Lmxm;->b:Lmxn;
    :try_end_18
    .catchall {:try_start_18 .. :try_end_18} :catchall_15

    :try_start_19
    iget-object v5, v1, Lmxm;->e:Lmxn;
    :try_end_19
    .catchall {:try_start_19 .. :try_end_19} :catchall_13

    :try_start_1a
    iget-object v6, v1, Lmxm;->d:Lmxn;
    :try_end_1a
    .catchall {:try_start_1a .. :try_end_1a} :catchall_11

    :try_start_1b
    iget-object v7, v1, Lmxm;->c:Lmxn;
    :try_end_1b
    ...
    iget-object v9, v1, Lmxm;->a:Lmxn;

    invoke-virtual {v9}, Lmxn;->a()Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Ljava/io/InputStream;

    iget-object v10, v1, Lmxm;->e:Lmxn;

    invoke-virtual {v10}, Lmxn;->a()Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Ljava/io/OutputStream;

    invoke-static {v9, v10, v0}, Lnrt;->a(Ljava/io/InputStream;Ljava/io/OutputStream;Lael;)Z
    ...
    :try_start_23
    invoke-static {v2, v7}, Loys;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    :try_start_25
    invoke-static {v2, v6}, Loys;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    :try_start_27
    invoke-static {v2, v5}, Loys;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
