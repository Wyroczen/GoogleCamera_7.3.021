...
.method public constructor <init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;Z)V
    ...
    iput-object p1, p0, Lgqh;->d:Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;
    ...
    iput-object v0, p0, Lgqh;->e:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lgqh;->a:Landroid/widget/RelativeLayout;
    ...
    invoke-static {v0, v1, v2}, Lohr;->a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lohr;

    move-result-object v0

    iput-object v0, p0, Lgqh;->f:Lohr;

    iget-object p1, p1, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzi;

    iput-object p1, p0, Lgqh;->g:Ljzi;

    iput-boolean p2, p0, Lgqh;->b:Z
...
.method public final a()Landroid/animation/Animator;
    ...
    :goto_0
    iget-object v3, p0, Lgqh;->e:Landroid/widget/FrameLayout;
    ...
    iget-object v4, p0, Lgqh;->e:Landroid/widget/FrameLayout;

    iget v6, p0, Lgqh;->h:I

    invoke-direct {v3, v4, v6}, Ljzk;-><init>(Landroid/view/View;I)V

    invoke-virtual {v0, v3}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object v3, p0, Lgqh;->g:Ljzi;
    ...
    invoke-static {v3}, Ljzj;->a(Landroid/view/View;)[I

    move-result-object v3

    aget v3, v3, v8

    iget-object v4, p0, Lgqh;->a:Landroid/widget/RelativeLayout;

    invoke-static {v4}, Ljzj;->a(Landroid/view/View;)[I
    ...
    iget-object v6, p0, Lgqh;->a:Landroid/widget/RelativeLayout;
    ...
    iget-object v3, p0, Lgqh;->a:Landroid/widget/RelativeLayout;

    iget v4, p0, Lgqh;->c:I

    invoke-direct {v2, v3, v4}, Ljzk;-><init>(Landroid/view/View;I)V

    invoke-virtual {v1, v2}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    new-instance v2, Ljzb;

    iget-object v3, p0, Lgqh;->d:Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;

    invoke-direct {v2, v3}, Ljzb;-><init>(Landroid/view/View;)V

    invoke-virtual {v1, v2}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    new-instance v2, Lgqf;

    invoke-direct {v2, p0}, Lgqf;-><init>(Lgqh;)V

    invoke-static {v2}, Lmjn;->a(Lj$/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-direct {v4, p0}, Lgqg;-><init>(Lgqh;)V
    ...
    invoke-direct {v0, p0}, Lgqe;-><init>(Lgqh;)V

    invoke-static {v0}, Lmjn;->b(Lj$/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
