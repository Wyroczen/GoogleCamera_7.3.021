...
.method public constructor <init>(Lhva;Llpq;Lchh;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcco;->a:Lhva;

    iput-object p2, p0, Lcco;->c:Llpq;
...
# virtual methods
.method public final a(Lmkp;Lbxs;Llpl;Z)Llpo;
    .locals 5

    invoke-virtual {p3}, Llpl;->b()Z
    ...
    invoke-virtual {p2, p3}, Lbxs;->a(Llpl;)Ljava/util/List;
    ...
    invoke-interface {p4, p3}, Lchh;->a(Lchk;)Loab;
    ...
    :cond_5
    sget-object p1, Llpo;->g:Llpo;

    return-object p1

    :cond_6
    sget-object p1, Llpo;->f:Llpo;

    return-object p1

    :cond_7
    sget-object p1, Llpo;->e:Llpo;

    return-object p1

    :cond_8
    sget-object p1, Llpo;->d:Llpo;

    return-object p1

    :cond_9
    sget-object p1, Llpo;->c:Llpo;

    return-object p1

    :cond_a
    sget-object p1, Llpo;->b:Llpo;

    return-object p1

    :cond_b
    :goto_1
    iget-object p3, p0, Lcco;->a:Lhva;

    sget-object p4, Lhup;->h:Lhvg;

    invoke-interface {p3, p4}, Lhva;->a(Lhun;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, v3}, Lbxs;->a(Llpl;)Ljava/util/List;

    move-result-object p2

    invoke-direct {p4, p2}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    new-instance p2, Lhyq;

    invoke-direct {p2}, Lhyq;-><init>()V
    ...
    iget-object p4, p4, Lhvg;->a:Ljava/lang/String;
    ...
    iget-object p1, p2, Lhyq;->b:Llpo;

    goto :goto_5

    :cond_13
    iget-object p1, p2, Lhyq;->c:Llpo;
