...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lkpp;->d:Z

    sput-boolean v0, Lkpp;->b:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lkpp;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lkpp;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)I
    ...
    sget-object v0, Lkpp;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v0, Lkvi;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, Lkvi;->b:Z

    if-nez v2, :cond_1

    sput-boolean v1, Lkvi;->b:Z

    invoke-virtual {p0}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lkwp;->b(Landroid/content/Context;)Lkwo;
    ...
    :try_start_2
    invoke-virtual {v3, v2, v4}, Lkwo;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_4
    :goto_3
    invoke-static {p0}, Lkwg;->b(Landroid/content/Context;)V

    sget-object v0, Lkwg;->a:Ljava/lang/Boolean;
    ...
    sput-object v0, Lkwg;->a:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lkpq;->a(Landroid/content/Context;)Lkpq;

    invoke-static {v6, v1}, Lkpq;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v5, v1}, Lkpq;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lkwg;->a(I)I

    move-result p0

    invoke-static {p1}, Lkwg;->a(I)I
...
.method public static a(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lkow;->a(I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lkwo;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v0, v1}, Lkpq;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lkpq;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lkpp;->d:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lkpp;->d:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v2, Lkpp;->b:Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lkpp;->a(Landroid/content/Context;Ljava/lang/String;)Z
