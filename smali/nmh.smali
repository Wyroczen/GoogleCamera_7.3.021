...
# direct methods
.method public constructor <init>(Loxq;Lnmg;)V
    .locals 0
...
.method private final a(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lnmh;->b(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
...
.method private final b(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    invoke-direct {v0, p0, p1}, Lnme;-><init>(Lnmh;Ljava/lang/Runnable;)V
...
.method private final b(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
    ...
    invoke-direct {v0, p0, p1}, Lnmf;-><init>(Lnmh;Ljava/util/concurrent/Callable;)V
...
.method public final a(Ljava/lang/Runnable;)Loxn;
    ...
    iget-object v0, p0, Lnmh;->b:Loxq;

    invoke-direct {p0, p1}, Lnmh;->b(Ljava/lang/Runnable;)Ljava/lang/Runnable;
...
.method public final a(Ljava/util/concurrent/Callable;)Loxn;
    ...
    invoke-direct {p0, p1}, Lnmh;->b(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;
...
.method public final execute(Ljava/lang/Runnable;)V
    ...
    invoke-interface {v0, p1}, Loxq;->execute(Ljava/lang/Runnable;)V
...
.method public final invokeAll(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lnmh;->a(Ljava/util/Collection;)Ljava/util/List;

    move-result-object p1

    invoke-interface {v0, p1}, Loxq;->invokeAll(Ljava/util/Collection;)Ljava/util/List;
...
.method public final invokeAll(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/util/List;
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Loxq;->invokeAll(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/util/List;
...
.method public final invokeAny(Ljava/util/Collection;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Loxq;->invokeAny(Ljava/util/Collection;)Ljava/lang/Object;
...
.method public final invokeAny(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Loxq;->invokeAny(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method public final bridge synthetic schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lnmh;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Loxo;
...
.method public final bridge synthetic schedule(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lnmh;->a(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Loxo;
...
.method public final bridge synthetic scheduleAtFixedRate(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-virtual/range {p0 .. p6}, Lnmh;->a(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Loxo;
...
.method public final bridge synthetic scheduleWithFixedDelay(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-virtual/range {p0 .. p6}, Lnmh;->b(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Loxo;
...
.method public final bridge synthetic submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, p1}, Lnmh;->a(Ljava/lang/Runnable;)Loxn;
...
.method public final bridge synthetic submit(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, p1, p2}, Lnmh;->a(Ljava/lang/Runnable;Ljava/lang/Object;)Loxn;
...
.method public final bridge synthetic submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, p1}, Lnmh;->a(Ljava/util/concurrent/Callable;)Loxn;
