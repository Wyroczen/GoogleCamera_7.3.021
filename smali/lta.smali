...
.field private final z:Llre;


# direct methods
.method public constructor <init>(Llqd;Llrb;Llre;Loab;Loab;ZLlsj;Llvi;Llom;Z)V
    .locals 14
    ...
    iput-object v3, v0, Llta;->a:Ljava/lang/Object;

    new-instance v3, Ljava/lang/Object;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v3, v0, Llta;->b:Ljava/lang/Object;

    invoke-static {}, Loyd;->f()Loyd;

    move-result-object v3

    iput-object v3, v0, Llta;->h:Loyd;

    new-instance v3, Llsy;

    invoke-direct {v3, p0}, Llsy;-><init>(Llta;)V

    iput-object v3, v0, Llta;->E:Landroid/media/MediaCodec$Callback;

    const-wide v3, 0x7fffffffffffffffL

    iput-wide v3, v0, Llta;->o:J
    ...
    iput-object v3, v0, Llta;->p:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v3, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v3, v4, v5}, Ljava/util/concurrent/atomic/AtomicLong;-><init>(J)V

    iput-object v3, v0, Llta;->G:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v3, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v3, v4, v5}, Ljava/util/concurrent/atomic/AtomicLong;-><init>(J)V

    iput-object v3, v0, Llta;->H:Ljava/util/concurrent/atomic/AtomicLong;

    iput-wide v4, v0, Llta;->q:J

    const/4 v3, 0x0

    iput-boolean v3, v0, Llta;->r:Z

    iput-boolean v3, v0, Llta;->s:Z

    iput-boolean v3, v0, Llta;->I:Z

    iput-boolean v3, v0, Llta;->t:Z

    new-instance v6, Ljava/util/ArrayList;

    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    iput-object v6, v0, Llta;->u:Ljava/util/List;

    iput-boolean v3, v0, Llta;->v:Z

    move-object v6, p1

    iput-object v6, v0, Llta;->D:Llqd;

    move-object/from16 v7, p7

    iput-object v7, v0, Llta;->e:Llsj;

    move-object/from16 v7, p9

    iput-object v7, v0, Llta;->C:Llom;

    iput-boolean v2, v0, Llta;->l:Z

    invoke-virtual {p1}, Llqd;->i()I

    move-result v7

    int-to-double v7, v7

    invoke-virtual {p1}, Llqd;->k()I
    ...
    iput-wide v7, v0, Llta;->B:D

    invoke-virtual {p1}, Llqd;->e()I

    move-result v7

    invoke-static {v7}, Llqh;->a(I)Llqh;

    move-result-object v7

    iget-object v8, v7, Llqh;->e:Ljava/lang/String;
    ...
    invoke-virtual {v10}, Llpo;->b()Llun;
    ...
    invoke-static {v7}, Llqj;->a(Llqg;)Landroid/media/MediaCodec;

    move-result-object v7

    iput-object v7, v0, Llta;->c:Landroid/media/MediaCodec;
    ...
    iput-object v7, v0, Llta;->i:Landroid/os/HandlerThread;

    invoke-virtual {v7}, Landroid/os/HandlerThread;->start()V

    new-instance v7, Landroid/os/Handler;

    iget-object v10, v0, Llta;->i:Landroid/os/HandlerThread;
    ...
    iput-object v7, v0, Llta;->j:Landroid/os/Handler;
    ...
    iput-object v7, v0, Llta;->E:Landroid/media/MediaCodec$Callback;

    iput-boolean v11, v0, Llta;->k:Z

    goto :goto_0

    :cond_3
    iput-boolean v3, v0, Llta;->k:Z

    :goto_0
    iget-object v7, v0, Llta;->c:Landroid/media/MediaCodec;

    iget-object v10, v0, Llta;->E:Landroid/media/MediaCodec$Callback;

    iget-object v12, v0, Llta;->j:Landroid/os/Handler;
    ...
    iput-object v1, v0, Llta;->d:Landroid/view/Surface;
    ...
    :cond_5
    sget-object v7, Llrb;->a:Llrb;

    if-ne v1, v7, :cond_6

    iget-object v1, v0, Llta;->c:Landroid/media/MediaCodec;
    ...
    :cond_6
    iput-object v10, v0, Llta;->d:Landroid/view/Surface;

    :goto_2
    move-object/from16 v1, p3

    iput-object v1, v0, Llta;->z:Llre;

    move-object/from16 v1, p8

    iput-object v1, v0, Llta;->A:Llvi;
    ...
    iput-object v1, v0, Llta;->g:Landroid/util/Range;

    iput v11, v0, Llta;->x:I

    const/4 v1, 0x0

    iput v1, v0, Llta;->m:F

    iput-wide v4, v0, Llta;->n:J

    iput-wide v4, v0, Llta;->F:J
    ...
    invoke-virtual {p0, v3}, Llta;->a(Z)V
...
.method private final a()V
    ...
    iget-object v0, p0, Llta;->j:Landroid/os/Handler;

    new-instance v1, Llsx;

    invoke-direct {v1, p0}, Llsx;-><init>(Llta;)V

    invoke-virtual {v0, v1}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :try_start_0
    iget-object v0, p0, Llta;->i:Landroid/os/HandlerThread;
...
.method public final a(ILandroid/media/MediaCodec$BufferInfo;)V
    ...
    :cond_0
    iget-object v1, p0, Llta;->c:Landroid/media/MediaCodec;
    ...
    invoke-interface {v4, v8}, Llom;->a(Ljava/lang/Object;)V
    ...
    :cond_2
    iget-object v4, p0, Llta;->G:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v4, v2, v3}, Ljava/util/concurrent/atomic/AtomicLong;->set(J)V

    iget-object v4, p0, Llta;->H:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {p0, v2, v3}, Llta;->d(J)J
    ...
    iget-object v4, p0, Llta;->z:Llre;

    invoke-interface {v4}, Llre;->c()Z
    ...
    invoke-interface {v4, v8, v9}, Llre;->a(J)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :goto_1
    iget-wide v11, p0, Llta;->q:J

    cmp-long v0, v11, v6

    if-nez v0, :cond_6

    iput-wide v2, p0, Llta;->q:J
    ...
    iget-object v0, p0, Llta;->z:Llre;

    invoke-interface {v0, v1, p2}, Llre;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    iput-boolean v10, p0, Llta;->s:Z

    iget-wide v0, p0, Llta;->F:J
    ...
    iget-object v4, v4, Llsu;->h:Llsk;

    iget-wide v6, v4, Llsk;->b:J

    add-long/2addr v6, v0

    iput-wide v6, v4, Llsk;->b:J
    ...
    :cond_9
    :goto_2
    iput-wide v2, p0, Llta;->F:J

    iget-object v0, p0, Llta;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-boolean v10, p0, Llta;->I:Z

    iget-object v0, p0, Llta;->e:Llsj;

    sget-object v1, Llsb;->j:Llsb;

    invoke-virtual {v0, v1}, Llsj;->a(Llsb;)V

    :goto_3
    iget-object v0, p0, Llta;->c:Landroid/media/MediaCodec;

    invoke-virtual {v0, p1, v5}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V

    iget-wide v0, p0, Llta;->o:J
    ...
    :cond_c
    iget-boolean p1, p0, Llta;->r:Z

    if-eqz p1, :cond_d

    iget-boolean p1, p0, Llta;->s:Z

    if-nez p1, :cond_e

    :cond_d
    iget-boolean p1, p0, Llta;->I:Z

    if-nez p1, :cond_e

    iget-boolean p1, p0, Llta;->t:Z

    if-eqz p1, :cond_f

    :cond_e
    :goto_5
    iget-object p1, p0, Llta;->h:Loyd;
...
.method public final a(J)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Llta;->c(J)J
    ...
    :cond_1
    invoke-virtual {p0, v8, v9}, Llta;->b(J)V
    ...
    iput-wide p1, p0, Llta;->o:J

    iget-wide p1, p0, Llta;->o:J
    ...
    iget-object p1, p0, Llta;->c:Landroid/media/MediaCodec;
    ...
    iget-object p1, p0, Llta;->a:Ljava/lang/Object;
    ...
    iget-object v4, p0, Llta;->c:Landroid/media/MediaCodec;
    ...
    :cond_7
    iget-boolean p1, p0, Llta;->k:Z

    if-nez p1, :cond_8

    iget-wide p1, p0, Llta;->o:J

    iget-object v1, p0, Llta;->G:Ljava/util/concurrent/atomic/AtomicLong;

    iget-object v3, p0, Llta;->h:Loyd;

    invoke-static {v2, p1, p2, v1, v3}, Llsd;->a(IJLjava/util/concurrent/atomic/AtomicLong;Loxn;)V

    :cond_8
    iget-object p1, p0, Llta;->j:Landroid/os/Handler;

    new-instance p2, Llsv;

    invoke-direct {p2, p0}, Llsv;-><init>(Llta;)V
    ...
    iget-object p1, p0, Llta;->i:Landroid/os/HandlerThread;
...
.method public final a(Landroid/media/MediaFormat;)V
    ...
    iget-object v0, p0, Llta;->D:Llqd;

    invoke-virtual {v0}, Llqd;->i()I
    ...
    iget-object v2, v2, Llsu;->c:Ljava/lang/Object;
    ...
    iget-object v1, v1, Llsu;->f:Llrg;

    invoke-virtual {v1}, Llrg;->a()Z
    ...
    iget-object v3, v3, Llsu;->a:Landroid/media/MediaMuxer;

    invoke-virtual {v3, p1}, Landroid/media/MediaMuxer;->addTrack(Landroid/media/MediaFormat;)I

    move-result v3

    invoke-virtual {v1, v3}, Llrg;->a(I)V

    check-cast v0, Llsu;

    iget-object v0, v0, Llsu;->f:Llrg;

    iput-object p1, v0, Llrg;->d:Landroid/media/MediaFormat;

    invoke-virtual {v0}, Llrg;->b()I
    ...
    :goto_0
    iget-object p1, p0, Llta;->z:Llre;

    invoke-interface {p1}, Llre;->a()V

    iget-boolean p1, p0, Llta;->k:Z

    if-nez p1, :cond_2

    iget-object p1, p0, Llta;->e:Llsj;

    sget-object v0, Llrh;->b:Llrh;

    iget-object v1, p0, Llta;->H:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {p1, v0, v1}, Llsj;->a(Llrh;Ljava/util/concurrent/atomic/AtomicLong;)V
...
.method public final close()V
    ...
    invoke-virtual {p0, v0, v1}, Llta;->a(J)V
