...
.method public final a(JLjava/util/Map;)V
    ...
    :cond_1
    iget-object p2, p0, Lcgy;->f:Lidv;

    invoke-interface {p1, p2}, Lidw;->a(Lidv;)V
...
.method public final a(Lidw;)V
    ...
    iput-object p1, p0, Lcgy;->j:Lidw;

    invoke-virtual {p0}, Lcgy;->d()Lcgx;

    move-result-object v0

    invoke-virtual {v0}, Lcgx;->b()Lidv;
    ...
    invoke-direct {v3, p1, v2}, Lcgu;-><init>(Lidw;Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, Lcgy;->f:Lidv;

    goto :goto_0

    :cond_0
    iput-object v1, p0, Lcgy;->f:Lidv;

    :goto_0
    iget-object p1, p0, Lcgy;->f:Lidv;
