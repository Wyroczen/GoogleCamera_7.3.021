...
.method public constructor <init>(Lchh;Lllp;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lewe;->c:Lllp;
...
.method public final a(Lewb;Ljava/lang/String;)Z
    ...
    :goto_1
    invoke-static {v6, v8}, Lijc;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_4
    iput-object v2, p1, Lewb;->a:Ljava/lang/String;

    :goto_4
    if-nez v5, :cond_6

    sget-object p1, Lewe;->a:Ljava/lang/String;
    ...
    :try_start_2
    iget-boolean p2, p0, Lewe;->b:Z

    if-nez p2, :cond_8

    sget-object p2, Lewe;->a:Ljava/lang/String;
    ...
    :cond_8
    iget-object p2, p0, Lewe;->c:Lllp;

    new-instance v2, Lewd;

    invoke-direct {v2, p1}, Lewd;-><init>(Ljava/lang/RuntimeException;)V

    invoke-virtual {p2, v2}, Lllp;->execute(Ljava/lang/Runnable;)V
    :try_end_2
