...
# direct methods
.method public constructor <init>(Llrw;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 0
    ...
    iput-object p3, p0, Llru;->c:Landroid/media/MediaCodec$BufferInfo;
...
.method public final run()V
    ...
    iget-object v2, p0, Llru;->c:Landroid/media/MediaCodec$BufferInfo;
    ...
    :cond_1
    iget-object v4, v0, Llrz;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v4, v0, Llrz;->q:Ljava/util/concurrent/atomic/AtomicLong;

    iget-wide v7, v2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    long-to-double v7, v7

    iget-wide v9, v0, Llrz;->j:D
    ...
    iget-object v4, v0, Llrz;->n:Ljava/util/Deque;
    ...
    invoke-virtual {v9, v10}, Lojk;->c(Ljava/lang/Comparable;)Z

    move-result v10

    if-nez v10, :cond_6

    invoke-virtual {v9}, Lojk;->a()Z
    ...
    :cond_4
    iget-object v4, v0, Llrz;->g:Landroid/media/MediaCodec;
    ...
    iget-object v4, v0, Llrz;->m:Ljava/util/List;

    new-instance v8, Llsa;

    invoke-direct {v8, v2, v7}, Llsa;-><init>(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V

    invoke-interface {v4, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-wide v7, v0, Llrz;->w:J
    ...
    iput-boolean v7, v0, Llrz;->r:Z

    iget-object v3, v0, Llrz;->k:Llsj;

    sget-object v4, Llsb;->c:Llsb;
    ...
    :cond_5
    invoke-virtual {v0, v2, v4}, Llrz;->a(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V

    :cond_6
    :goto_2
    iget-object v3, v0, Llrz;->g:Landroid/media/MediaCodec;

    invoke-virtual {v3, v1, v6}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V

    invoke-virtual {v0, v2}, Llrz;->a(Landroid/media/MediaCodec$BufferInfo;)V
