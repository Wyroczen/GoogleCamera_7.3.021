...
.method public constructor <init>(Landroid/content/Context;Lckj;Landroid/content/ContentResolver;Lckn;Lilu;)V
    .locals 0
...
.method public final a(Landroid/net/Uri;)Lckp;
    ...
    invoke-static {v2, p1, v1}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v0
.end method

.method public final a(Landroid/net/Uri;ZLoab;)Lckp;
    .locals 11

    iget-object v0, p0, Lckq;->e:Lilu;

    invoke-interface {v0, p1}, Lilu;->c(Landroid/net/Uri;)Z
    ...
    invoke-interface {v0, p1}, Lilu;->d(Landroid/net/Uri;)Landroid/graphics/Point;
    ...
    invoke-interface {v0, p1}, Lilu;->e(Landroid/net/Uri;)J
    ...
    invoke-static/range {v5 .. v10}, Lckp;->a(Landroid/net/Uri;Llun;JZLoab;)Lewq;

    move-result-object v5

    iget-object v7, p0, Lckq;->e:Lilu;

    move-object v2, v1

    move-object v6, p0

    invoke-direct/range {v2 .. v7}, Lckp;-><init>(Landroid/content/Context;Lckj;Lewq;Lckq;Lilu;)V
...
.method public final b(Landroid/database/Cursor;)Lckp;
    ...
    invoke-static {v3, v4}, Lkbf;->e(J)J
    ...
    invoke-direct {v3, v1, v2}, Llun;-><init>(II)V
    ...
    invoke-static {v1, v2, v3, v4}, Lews;->a(DD)Lews;
    ...
    invoke-direct/range {v7 .. v22}, Lewq;-><init>(JLjava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;Ljava/lang/String;Landroid/net/Uri;ZLoab;JILews;Z)V
    ...
    iget-object v5, v6, Lckq;->e:Lilu;

    move-object v0, v7

    move-object/from16 v4, p0

    invoke-direct/range {v0 .. v5}, Lckp;-><init>(Landroid/content/Context;Lckj;Lewq;Lckq;Lilu;)V
