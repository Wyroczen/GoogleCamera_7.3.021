...
.method public constructor <init>(Leul;Limw;)V
    ...
    iput-object v0, p0, Linh;->d:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Linh;->e:Ljava/util/HashMap;

    new-instance v0, Lind;

    invoke-direct {v0}, Lind;-><init>()V

    iput-object v0, p0, Linh;->f:Landroid/util/LruCache;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Linh;->g:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Linh;->h:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Linh;->i:Ljava/util/HashMap;

    new-instance v0, Lj$/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Lj$/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Linh;->j:Lj$/util/concurrent/ConcurrentHashMap;

    iput-object p1, p0, Linh;->b:Leul;

    iput-object p2, p0, Linh;->c:Limw;
...
# virtual methods
.method public final a()Lils;
    .locals 1

    new-instance v0, Line;

    invoke-direct {v0, p0}, Line;-><init>(Linh;)V

    return-object v0
.end method

.method public final a(Landroid/content/ContentResolver;Ljava/lang/String;JLoab;ILjava/lang/String;IILmpt;)V
    .locals 3
    ...
    iget-object v1, p0, Linh;->b:Leul;

    iget-object v2, p0, Linh;->c:Limw;

    invoke-direct {p7, v1, v2}, Leur;-><init>(Leul;Limw;)V
    ...
    sget-object p2, Linh;->a:Ljava/lang/String;
...
.method public final a(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Linh;->g:Ljava/util/HashMap;

    invoke-virtual {v0, p1}, Ljava/util/HashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Linh;->f:Landroid/util/LruCache;

    invoke-virtual {v0, p1}, Landroid/util/LruCache;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Linh;->h:Ljava/util/HashMap;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Linh;->d:Ljava/util/HashMap;

    invoke-virtual {v0, p2, p1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Linh;->e:Ljava/util/HashMap;
...
.method public final a(Landroid/net/Uri;Lawg;)V
    ...
    iget-object v1, p0, Linh;->f:Landroid/util/LruCache;
    ...
    iget-object p2, p0, Linh;->h:Ljava/util/HashMap;
...
.method public final a(Lawg;JLandroid/net/Uri;)V
    ...
    iget-object v0, p0, Linh;->i:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, p4, p1}, Linh;->a(Landroid/net/Uri;Lawg;)V

    return-void
.end method

.method public final a(Llun;JLandroid/net/Uri;)V
    .locals 3
    ...
    iget-object p1, p0, Linh;->f:Landroid/util/LruCache;

    invoke-virtual {p1, p4}, Landroid/util/LruCache;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p1, p0, Linh;->h:Ljava/util/HashMap;
    ...
    iget-object p1, p0, Linh;->i:Ljava/util/HashMap;
...
.method public final b()Lilt;
    ...
    invoke-direct {v0, p0}, Linf;-><init>(Linh;)V

    return-object v0
.end method

.method public final b(Landroid/net/Uri;)Loab;
    .locals 1
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Linh;->j:Lj$/util/concurrent/ConcurrentHashMap;
