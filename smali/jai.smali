...
.method public constructor <init>(Landroid/view/WindowManager;Lj$/util/function/Consumer;Lbks;Z)V
    ...
    iput-object p1, p0, Ljai;->a:Landroid/view/WindowManager;

    iput-object p2, p0, Ljai;->b:Lj$/util/function/Consumer;

    iput-object p3, p0, Ljai;->c:Lbks;

    iput-boolean p4, p0, Ljai;->d:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Ljai;->b:Lj$/util/function/Consumer;

    new-instance v1, Ljae;

    invoke-direct {v1, p0}, Ljae;-><init>(Ljai;)V
...
.method public final a(ILbkk;)V
    ...
    iget-object p1, p0, Ljai;->b:Lj$/util/function/Consumer;

    new-instance p2, Ljag;

    invoke-direct {p2, p0}, Ljag;-><init>(Ljai;)V
...
.method public final a(Lbkf;)V
    ...
    invoke-direct {v0, p0}, Ljaf;-><init>(Ljai;)V
...
.method public final b()Lizx;
    .locals 6

    const-string v0, "FilmstripDCIU"

    :try_start_0
    iget-object v1, p0, Ljai;->c:Lbks;

    invoke-interface {v1}, Lbks;->e()I

    move-result v1

    iget-object v2, p0, Ljai;->c:Lbks;
    ...
    iget-object v5, p0, Ljai;->a:Landroid/view/WindowManager;
    ...
    invoke-interface {v2, v3, v3}, Lbki;->b(II)Ljzg;
    ...
    invoke-direct {v2, v1}, Lizx;-><init>(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v1, v4}, Lizx;-><init>(Landroid/graphics/Bitmap;)V

    return-object v1

    :cond_6
    :goto_4
    invoke-static {}, Lizx;->c()Lizx;
    ...
    invoke-static {v0, v2, v1}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b(ILbkk;)V
    ...
    invoke-direct {p2, p0}, Ljah;-><init>(Ljai;)V
