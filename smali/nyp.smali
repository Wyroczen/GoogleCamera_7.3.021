...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lnyp;->b:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput-object p1, p0, Lnyp;->a:Lty;

    invoke-virtual {p1}, Lty;->k()V

    iget-object p1, p0, Lnyp;->a:Lty;
    ...
    invoke-virtual {p0}, Lnyp;->getAdapter()Landroid/widget/ListAdapter;
    ...
    invoke-direct {p2, p0}, Lnyo;-><init>(Lnyp;)V
...
.method public final a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lnyp;->convertSelectionToString(Ljava/lang/Object;)Ljava/lang/CharSequence;

    move-result-object p1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lnyp;->setText(Ljava/lang/CharSequence;Z)V
...
.method public final getHint()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lnyp;->getParent()Landroid/view/ViewParent;
...
.method public final showDropDown()V
    ...
    invoke-virtual {p0}, Lnyp;->getInputType()I

    move-result v0

    if-nez v0, :cond_0

    iget-object v0, p0, Lnyp;->b:Landroid/view/accessibility/AccessibilityManager;
