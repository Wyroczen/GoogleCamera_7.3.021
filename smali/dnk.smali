...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Ldnk;->d:Ljava/util/Deque;
...
.method public final a(Lmpe;)V
    ...
    iget-object v0, p0, Ldnk;->c:Ldno;

    invoke-interface {v0}, Ldno;->c()V

    iget-object v0, p0, Ldnk;->c:Ldno;

    invoke-interface {v0}, Ldno;->a()Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p1}, Ldnr;->a(Lmpa;)Ldnr;
    ...
    iget-wide v0, v0, Ldnw;->a:J

    const-wide/16 v2, -0xe10

    add-long/2addr v0, v2

    iget-object v2, p0, Ldnk;->d:Ljava/util/Deque;
    ...
    :goto_0
    :try_start_0
    iget-object v4, p0, Ldnk;->d:Ljava/util/Deque;
    ...
    sget-object v2, Ldnk;->a:Ljava/lang/String;
    ...
    :cond_2
    iget-object v0, p0, Ldnk;->d:Ljava/util/Deque;

    monitor-enter v0

    :try_start_1
    iget-object v1, p0, Ldnk;->d:Ljava/util/Deque;
    ...
    :goto_1
    iget-object p1, p0, Ldnk;->d:Ljava/util/Deque;
    ...
    :cond_5
    :goto_2
    iget-object p1, p0, Ldnk;->c:Ldno;

    invoke-interface {p1}, Ldno;->d()Loab;
