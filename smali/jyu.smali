...
.method private constructor <init>(ILandroid/view/animation/Interpolator;)V
    ...
    iput-object p2, p0, Ljyu;->b:Landroid/view/animation/Interpolator;

    new-instance p1, Landroid/animation/AnimatorSet;

    invoke-direct {p1}, Landroid/animation/AnimatorSet;-><init>()V

    iput-object p1, p0, Ljyu;->c:Landroid/animation/AnimatorSet;

    return-void
.end method

.method public static a(ILandroid/view/animation/Interpolator;)Ljyu;
    .locals 1

    new-instance v0, Ljyu;

    invoke-direct {v0, p0, p1}, Ljyu;-><init>(ILandroid/view/animation/Interpolator;)V
...
.method public final a()Landroid/animation/AnimatorSet;
    ...
    iget-object v0, p0, Ljyu;->c:Landroid/animation/AnimatorSet;
...
.method public final a(Ljava/lang/Object;Ljava/lang/String;FF)V
    ...
    iget-object p2, p0, Ljyu;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {p1, p2}, Landroid/animation/ObjectAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object p2, p0, Ljyu;->d:Landroid/animation/AnimatorSet$Builder;

    if-nez p2, :cond_0

    iget-object p2, p0, Ljyu;->c:Landroid/animation/AnimatorSet;

    invoke-virtual {p2, p1}, Landroid/animation/AnimatorSet;->play(Landroid/animation/Animator;)Landroid/animation/AnimatorSet$Builder;

    move-result-object p1

    iput-object p1, p0, Ljyu;->d:Landroid/animation/AnimatorSet$Builder;
