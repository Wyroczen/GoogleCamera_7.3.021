...
.method public constructor <init>(Lllp;Ljava/util/concurrent/ScheduledExecutorService;Lj$/time/Clock;Llva;Lpng;)V
    .locals 1
    ...
    invoke-interface {p4, v0}, Llva;->a(Ljava/lang/String;)Llva;

    move-result-object v0

    iput-object v0, p0, Lcoa;->c:Llva;

    invoke-static {p2}, Loyz;->a(Ljava/util/concurrent/ScheduledExecutorService;)Loxq;

    move-result-object v0

    iput-object v0, p0, Lcoa;->h:Loxq;

    new-instance v0, Lllw;

    invoke-direct {v0, p1, p2}, Lllw;-><init>(Lllp;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {p1, p0, p4, p5}, Lcnp;-><init>(Lcoa;Llva;Lpng;)V
...
.method public final a()Loxn;
    ...
    iget-object v0, p0, Lcoa;->h:Loxq;

    new-instance v1, Lcnq;

    invoke-direct {v1, p0}, Lcnq;-><init>(Lcoa;)V

    invoke-interface {v0, v1}, Loxq;->a(Ljava/util/concurrent/Callable;)Loxn;
...
.method public final a(JLjava/lang/String;Lj$/time/Instant;Lhqs;)V
    .locals 9
    ...
    invoke-direct/range {v1 .. v7}, Lcns;-><init>(Lcoa;JLjava/lang/String;Lj$/time/Instant;Lhqs;)V
...
.method public final b()V
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Loxq;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Loxo;
