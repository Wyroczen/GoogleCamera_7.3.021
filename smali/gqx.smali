...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lgpw;Lgpz;Lgqd;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/constraint/ConstraintLayout;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lgqx;->i:Lgpw;

    iput-object p3, p0, Lgqx;->j:Lgpz;

    iput-object p1, p0, Lgqx;->k:Landroid/content/Context;

    iput-object p4, p0, Lgqx;->l:Lgqd;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, Lgqx;->d:Ljava/util/ArrayList;

    new-instance p2, Ljava/util/HashMap;

    invoke-direct {p2}, Ljava/util/HashMap;-><init>()V

    iput-object p2, p0, Lgqx;->e:Ljava/util/Map;

    new-instance p2, Ljava/util/HashMap;

    invoke-direct {p2}, Ljava/util/HashMap;-><init>()V

    iput-object p2, p0, Lgqx;->f:Ljava/util/Map;

    new-instance p2, Landroid/widget/TextView;

    invoke-direct {p2, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lgqx;->g:Landroid/widget/TextView;
    ...
    iput-object p2, p0, Lgqx;->h:Landroid/widget/TextView;
...
.method public final a(Lgpz;)V
    ...
    iput-object p1, p0, Lgqx;->j:Lgpz;

    iget-object v0, p0, Lgqx;->d:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lgqx;->e:Ljava/util/Map;
    ...
    :cond_1
    iget-object v0, p0, Lgqx;->i:Lgpw;

    invoke-virtual {v0}, Lgpw;->e()Lohb;
    ...
    iget-object v2, v1, Lgpx;->a:Lgpz;

    if-ne v2, p1, :cond_2

    iget-object p1, p0, Lgqx;->h:Landroid/widget/TextView;
