...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lmtm;Lmsr;Lmtr;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmua;->b:Landroid/content/Context;

    iput-object p2, p0, Lmua;->c:Lmtm;

    iput-object p3, p0, Lmua;->a:Lmsr;

    iput-object p4, p0, Lmua;->d:Lmtr;
...
.method public final a(Ljava/lang/String;)Lcom/google/android/libraries/lens/lenslite/dynamicloading/DLEngineApi;
    ...
    iget-object v2, v1, Lmua;->c:Lmtm;

    new-instance v3, Lmtl;

    iget-object v4, v2, Lmtm;->a:Lpng;
    ...
    invoke-static {v4, v5}, Lmtm;->a(Ljava/lang/Object;I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/content/Context;

    iget-object v2, v2, Lmtm;->b:Lpng;
    ...
    invoke-static {v2, v6}, Lmtm;->a(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    invoke-static {v0, v7}, Lmtm;->a(Ljava/lang/Object;I)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Ljava/lang/String;

    invoke-direct {v3, v4, v2, v8}, Lmtl;-><init>(Landroid/content/Context;Ljava/util/Set;Ljava/lang/String;)V

    iget-object v2, v3, Lmtl;->d:Landroid/content/Context;

    iget-object v4, v3, Lmtl;->f:Ljava/lang/String;
    ...
    invoke-static {v2, v4}, Lmtl;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    sget-object v9, Lmtl;->b:Ljava/lang/Object;

    monitor-enter v9

    :try_start_1
    sget-object v10, Lmtl;->c:Ljava/util/Map;
    ...
    iget-object v11, v3, Lmtl;->d:Landroid/content/Context;
    ...
    iget-object v12, v3, Lmtl;->d:Landroid/content/Context;
    ...
    iget-object v15, v3, Lmtl;->d:Landroid/content/Context;

    invoke-virtual {v15}, Landroid/content/Context;->getClassLoader()Ljava/lang/ClassLoader;

    move-result-object v15

    sget-object v8, Lmtl;->a:Ljava/util/Set;

    invoke-direct {v14, v15, v8}, Lmtk;-><init>(Ljava/lang/ClassLoader;Ljava/util/Set;)V
    ...
    :cond_0
    iget-object v8, v3, Lmtl;->d:Landroid/content/Context;
    ...
    :goto_0
    sget-object v8, Lmtl;->c:Ljava/util/Map;
    ...
    invoke-direct {v4, v2, v8}, Lmtj;-><init>(Landroid/content/Context;Landroid/content/Context;)V

    iput-object v4, v3, Lmtl;->g:Landroid/content/Context;

    iget-object v2, v3, Lmtl;->f:Ljava/lang/String;

    iget-object v4, v3, Lmtl;->e:Ljava/util/Set;
    ...
    invoke-interface {v8, v3}, Lmtg;->a(Lmtl;)Lmue;
    ...
    iget-object v2, v8, Lmue;->b:Ljava/lang/String;
    ...
    invoke-direct {v0, v2}, Lmtn;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v2}, Lmtl;->a(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-virtual {v3}, Lmtl;->a()Landroid/content/Context;

    move-result-object v4

    iget-object v8, v1, Lmua;->d:Lmtr;

    invoke-interface {v8, v3}, Lmtr;->a(Lmtl;)I
    ...
    iget-object v9, v1, Lmua;->b:Landroid/content/Context;
    ...
    new-instance v8, Lmty;

    invoke-direct {v8, v1}, Lmty;-><init>(Lmua;)V
    ...
    invoke-direct {v3, v1}, Lmtz;-><init>(Lmua;)V
    ...
    :goto_3
    iget-object v3, v1, Lmua;->b:Landroid/content/Context;
    ...
    invoke-direct {v3, v2, v0}, Lmtn;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v2, v3, v0}, Lmtn;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v3, v2}, Lmto;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
