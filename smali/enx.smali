...
.field public final j:Lhnm;

.field public final k:Lert;
...
.field public final w:Ljhi;

.field public final x:Lpng;

.field public final y:Lllp;
...
.method public constructor <init>(Landroid/content/Context;Llom;Lchh;Landroid/content/Context;ZLcgm;Ljhi;Leob;Lhnm;Lert;Lfig;Ljava/util/concurrent/Executor;Lpng;Lllp;Leod;Lemv;)V
    .locals 3
    ...
    iput-object v1, v0, Lenx;->b:Landroid/content/Context;

    move-object v1, p2

    iput-object v1, v0, Lenx;->c:Llom;

    move-object v2, p3

    iput-object v2, v0, Lenx;->d:Lchh;

    invoke-static {p12}, Loyz;->a(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;

    move-result-object v2

    iput-object v2, v0, Lenx;->e:Ljava/util/concurrent/Executor;

    const/4 v2, 0x1

    iput-boolean v2, v0, Lenx;->o:Z
    ...
    iput-object v1, v0, Lenx;->f:Llln;

    move-object v1, p4

    check-cast v1, Landroid/app/Activity;

    iput-object v1, v0, Lenx;->g:Landroid/app/Activity;

    move v1, p5

    iput-boolean v1, v0, Lenx;->h:Z

    move-object v1, p6

    iput-object v1, v0, Lenx;->i:Lcgm;

    move-object v1, p7

    iput-object v1, v0, Lenx;->w:Ljhi;

    move-object v1, p11

    iput-object v1, v0, Lenx;->l:Lfig;

    move-object v1, p8

    iput-object v1, v0, Lenx;->B:Leob;

    move-object v1, p9

    iput-object v1, v0, Lenx;->j:Lhnm;

    move-object v1, p10

    iput-object v1, v0, Lenx;->k:Lert;

    move-object/from16 v1, p13

    iput-object v1, v0, Lenx;->x:Lpng;

    move-object/from16 v1, p14

    iput-object v1, v0, Lenx;->y:Lllp;

    move-object/from16 v1, p15

    iput-object v1, v0, Lenx;->z:Leod;

    move-object/from16 v1, p16

    iput-object v1, v0, Lenx;->A:Lemv;
...
# virtual methods
.method public final a(Lcom/google/android/libraries/lens/lenslite/api/LinkChipResult;Lmtd;Loab;)Lidv;
    .locals 9
    ...
    invoke-direct/range {v3 .. v8}, Lenf;-><init>(Lenx;Lcom/google/android/libraries/lens/lenslite/api/LinkChipResult;Loab;Lmtd;Lcom/google/android/libraries/lens/lenslite/api/LinkChipResult$BitmapProvider;)V
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Lenb;-><init>(Lenx;Ljava/lang/Runnable;Lcom/google/android/libraries/lens/lenslite/api/LinkChipResult;Lmtd;)V
    ...
    iput-object p3, v0, Lidu;->e:Ljava/lang/String;
    ...
    invoke-direct {p3, p0, p1, p2}, Lenc;-><init>(Lenx;Lcom/google/android/libraries/lens/lenslite/api/LinkChipResult;Lmtd;)V

    iput-object p3, v0, Lidu;->f:Ljava/lang/Runnable;
    ...
    invoke-direct {p3, p0, p1, p2}, Lend;-><init>(Lenx;Lcom/google/android/libraries/lens/lenslite/api/LinkChipResult;Lmtd;)V

    iput-object p3, v0, Lidu;->g:Ljava/lang/Runnable;

    new-instance p2, Lene;

    invoke-direct {p2, p0, p1}, Lene;-><init>(Lenx;Lcom/google/android/libraries/lens/lenslite/api/LinkChipResult;)V

    iput-object p2, v0, Lidu;->h:Ljava/lang/Runnable;
...
.method public final a()V
    ...
    iget-object v0, p0, Lenx;->e:Ljava/util/concurrent/Executor;
...
.method public final a(Landroid/graphics/Point;)V
    ...
    iget-object p1, p0, Lenx;->e:Ljava/util/concurrent/Executor;

    new-instance v1, Lent;

    invoke-direct {v1, p0, v0}, Lent;-><init>(Lenx;Landroid/graphics/Point;)V
...
.method public final a(Lidw;)V
    ...
    iget-object v0, p0, Lenx;->B:Leob;

    new-instance v1, Lemz;

    invoke-direct {v1, p0, p1}, Lemz;-><init>(Lenx;Lidw;)V

    iput-object v1, v0, Leob;->d:Leoa;

    iget-object p1, p0, Lenx;->f:Llln;
    ...
    invoke-direct {v1, v0}, Lenk;-><init>(Leob;)V

    invoke-virtual {p1, v1}, Llln;->a(Llul;)Llul;

    iget-object p1, p0, Lenx;->B:Leob;

    iget-object v0, p1, Leob;->b:Lchh;
    ...
    iget-object v0, p1, Leob;->c:Ljhi;

    invoke-static {}, Loyd;->f()Loyd;

    move-result-object v1

    iget-object v2, v0, Ljhi;->c:Lllp;

    new-instance v3, Ljhb;

    invoke-direct {v3, v0, v1}, Ljhb;-><init>(Ljhi;Loyd;)V

    invoke-virtual {v2, v3}, Lllp;->a(Ljava/lang/Runnable;)V

    new-instance v0, Lenz;

    invoke-direct {v0, p1}, Lenz;-><init>(Leob;)V

    sget-object p1, Lowt;->a:Lowt;

    invoke-static {v1, v0, p1}, Loyz;->a(Loxn;Loxc;Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method public final a(Lmpp;I)V
    .locals 2
    ...
    invoke-direct {v1, p0, p1, p2}, Lens;-><init>(Lenx;Lmpp;I)V
...
.method public final b()V
    ...
    invoke-direct {v1, p0}, Lenp;-><init>(Lenx;)V
...
.method public final c()V
    ...
    invoke-direct {v1, p0}, Lenq;-><init>(Lenx;)V
...
.method public final d()V
    ...
    iget-boolean v0, p0, Lenx;->n:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lenx;->p:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lenx;->o:Z
