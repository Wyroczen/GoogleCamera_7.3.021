...
# direct methods
.method public constructor <init>(Lfxi;Lfyi;Lbex;Z)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, v0}, Lmyz;-><init>([B)V

    iput-object p1, p0, Lbdl;->a:Lfxi;

    iput-object p2, p0, Lbdl;->b:Lfyi;
...
.method private final c(Lmpe;)Loab;
    .locals 13
...
.method public final a(Lmpe;)V
    ...
    invoke-virtual {p0, p1}, Lbdl;->b(Lmpe;)Z

    move-result v5

    invoke-direct {p0, p1}, Lbdl;->c(Lmpe;)Loab;
    ...
    iget-object v4, v7, Lfyi;->a:Lfyk;

    invoke-virtual {v4, v8}, Lfyk;->b(Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-direct {v7, v8}, Lfxf;-><init>([B)V

    invoke-virtual {v7, v6}, Lfxf;->a(Z)V
    ...
    iput-object v8, v7, Lfxf;->b:Ljava/lang/Integer;

    if-eqz v4, :cond_7

    iput-object v4, v7, Lfxf;->a:Landroid/graphics/PointF;
    ...
    invoke-virtual {v7, v1}, Lfxf;->a(Z)V

    iget-object v1, v7, Lfxf;->a:Landroid/graphics/PointF;
    ...
    :goto_0
    iget-object v4, v7, Lfxf;->b:Ljava/lang/Integer;
    ...
    :cond_3
    iget-object v4, v7, Lfxf;->c:Ljava/lang/Boolean;
    ...
    iget-object v4, v7, Lfxf;->a:Landroid/graphics/PointF;

    iget-object v8, v7, Lfxf;->b:Ljava/lang/Integer;

    invoke-virtual {v8}, Ljava/lang/Integer;->intValue()I

    move-result v8

    iget-object v7, v7, Lfxf;->c:Ljava/lang/Boolean;

    invoke-virtual {v7}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v7

    invoke-direct {v1, v4, v8, v7}, Lfxy;-><init>(Landroid/graphics/PointF;IZ)V
    ...
    invoke-direct/range {v1 .. v7}, Lfxh;-><init>(Lhjz;Lhka;FZLoab;I)V

    iget-object p1, p0, Lbdl;->a:Lfxi;

    invoke-interface {p1, v8}, Lfxi;->a(Ljava/lang/Object;)V
