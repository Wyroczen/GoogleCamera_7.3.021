...
.method public constructor <init>(Landroid/media/AudioRecord;I)V
    ...
    iput-object p1, p0, Lnfg;->a:Landroid/media/AudioRecord;
    ...
    iput-object p1, p0, Lnfg;->b:Landroid/media/AudioFormat;

    new-instance p1, Lnfi;

    iget-object p2, p0, Lnfg;->b:Landroid/media/AudioFormat;

    invoke-direct {p1, p2}, Lnfi;-><init>(Landroid/media/AudioFormat;)V

    iput-object p1, p0, Lnfg;->c:Lnfi;

    new-instance p1, Landroid/media/AudioTimestamp;

    invoke-direct {p1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object p1, p0, Lnfg;->e:Landroid/media/AudioTimestamp;
...
.method public final a()I
    ...
    iget-object v0, p0, Lnfg;->a:Landroid/media/AudioRecord;
...
.method public final declared-synchronized a(Ljava/nio/ByteBuffer;I)Lnfe;
    .locals 10
    ...
    iget-object v1, p0, Lnfg;->e:Landroid/media/AudioTimestamp;
    ...
    iget-object v2, v0, Lnfi;->a:Ljava/lang/Object;
    ...
    :try_start_1
    iget-wide v6, v0, Lnfi;->e:J

    iget-wide v8, v1, Landroid/media/AudioTimestamp;->framePosition:J

    sub-long/2addr v6, v8

    iget-wide v8, v0, Lnfi;->b:J

    mul-long v6, v6, v8

    iget-wide v8, v0, Lnfi;->e:J

    add-long/2addr v8, v4

    iput-wide v8, v0, Lnfi;->e:J
    ...
    iget-object v1, p0, Lnfg;->c:Lnfi;

    iget-object v4, v1, Lnfi;->a:Ljava/lang/Object;
    ...
    iget-wide v6, p0, Lnfg;->f:J

    add-long/2addr v2, v6

    iput-wide v2, p0, Lnfg;->f:J
    :try_end_4
    ...
    invoke-direct {v0, p1, p2, v6, v7}, Lnfh;-><init>(Ljava/nio/ByteBuffer;IJ)V
    :try_end_6
...
.method public final declared-synchronized b()V
    ...
    :try_start_0
    iput-wide v0, p0, Lnfg;->f:J

    iget-object v2, p0, Lnfg;->c:Lnfi;

    iget-object v3, v2, Lnfi;->a:Ljava/lang/Object;
