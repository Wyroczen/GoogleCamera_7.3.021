...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lihc;->a:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Llnt;)V
    .locals 1
    ...
    iput-object v0, p0, Lihc;->f:Ljava/util/Collection;

    new-instance v0, Ligz;

    invoke-direct {v0, p0}, Ligz;-><init>(Lihc;)V

    iput-object v0, p0, Lihc;->i:Landroid/media/SoundPool$OnLoadCompleteListener;

    iput-object p1, p0, Lihc;->g:Landroid/content/Context;
    ...
    iput-object p1, p0, Lihc;->c:Landroid/util/SparseArray;

    iput-object p2, p0, Lihc;->e:Llnt;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lihc;->d:Z
...
.method public final a(I)Loxn;
    ...
    iget-object v1, p0, Lihc;->c:Landroid/util/SparseArray;
    ...
    sget-object v1, Lihc;->a:Ljava/lang/String;
    ...
    iget-object v2, p0, Lihc;->c:Landroid/util/SparseArray;

    invoke-virtual {v2, p1, v1}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-virtual {p0}, Lihc;->d()Landroid/media/SoundPool;

    move-result-object v2

    iget-object v3, p0, Lihc;->g:Landroid/content/Context;
    ...
    sget-object v2, Lihc;->a:Ljava/lang/String;
...
.method public final b(I)V
    ...
    invoke-virtual {p0, p1}, Lihc;->a(I)Loxn;

    move-result-object v0

    new-instance v1, Liha;

    invoke-direct {v1, p0, p1}, Liha;-><init>(Lihc;I)V
...
.method public final c()V
    ...
    iget-object v1, p0, Lihc;->f:Ljava/util/Collection;
...
.method public final close()V
    ...
    iget-object v1, p0, Lihc;->h:Landroid/media/SoundPool;
    ...
    iput-object v1, p0, Lihc;->h:Landroid/media/SoundPool;
...
.method public final d()Landroid/media/SoundPool;
    ...
    iget-object v0, p0, Lihc;->h:Landroid/media/SoundPool;
    ...
    sget-object v0, Lihc;->a:Ljava/lang/String;

    invoke-static {v0}, Lijc;->d(Ljava/lang/String;)V

    invoke-static {}, Lihg;->a()Landroid/media/SoundPool;

    move-result-object v0

    iput-object v0, p0, Lihc;->h:Landroid/media/SoundPool;
    ...
    iget-object v1, p0, Lihc;->i:Landroid/media/SoundPool$OnLoadCompleteListener;
