...
.method public constructor <init>(Lchh;Levz;Ldjf;Lpng;Lcie;)V
    .locals 9
    ...
    iput-object v0, p0, Ldls;->c:Ljava/util/concurrent/ConcurrentMap;
    ...
    iput-object v0, p0, Ldls;->d:Llni;

    new-instance v0, Llni;

    invoke-direct {v0, v1}, Llni;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Ldls;->e:Llni;

    new-instance v0, Ldlq;

    invoke-direct {v0, p0}, Ldlq;-><init>(Ldls;)V

    iput-object v0, p0, Ldls;->f:Lcom/google/googlex/gcam/hdrplus/MemoryStateCallback;

    new-instance v0, Ldlr;

    invoke-direct {v0, p0}, Ldlr;-><init>(Ldls;)V

    iput-object v0, p0, Ldls;->g:Ljava/lang/Runnable;

    check-cast p4, Link;

    invoke-virtual {p4}, Link;->a()Loab;
    ...
    :goto_0
    iget-object v0, p0, Ldls;->f:Lcom/google/googlex/gcam/hdrplus/MemoryStateCallback;

    iget-object v1, p0, Ldls;->g:Ljava/lang/Runnable;
    ...
    invoke-static {p1, v2, v3}, Ldls;->a(Lchh;Lchk;Ljava/lang/Integer;)Lcom/google/googlex/gcam/ThreadPoolConfig;
    ...
    sget-object p1, Ldls;->a:Ljava/lang/String;
    ...
    iput-object v8, p0, Ldls;->b:Lcom/google/googlex/gcam/InitParams;

    new-instance p1, Levt;

    sget-object p3, Levr;->a:Levr;

    iget-object p4, p0, Ldls;->d:Llni;

    iget-object p5, p0, Ldls;->e:Llni;

    invoke-direct {p1, p3, p4, p5}, Levt;-><init>(Levr;Llnt;Llnt;)V

    invoke-virtual {p2, p1}, Levz;->a(Levs;)V
...
.method private static a(Lchh;Lchk;Ljava/lang/Integer;)Lcom/google/googlex/gcam/ThreadPoolConfig;
    ...
    invoke-interface {p0, p1}, Lchh;->a(Lchk;)Loab;
