...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lpiq;->b:Landroid/content/ContentProviderClient;

    const-string p1, "device_params"

    invoke-static {p2, p1}, Lpme;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lpiq;->c:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpiq;->d:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpiq;->e:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpiq;->f:Landroid/net/Uri;
...
.method private final a(Lpeb;Landroid/net/Uri;Ljava/lang/String;)Lpec;
    .locals 1

    invoke-direct {p0, p2, p3}, Lpiq;->a(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :try_start_0
    invoke-interface {p1, p2}, Lpeb;->a([B)Lpeb;
...
.method private final a(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :try_start_0
    iget-object v1, p0, Lpiq;->b:Landroid/content/ContentProviderClient;
...
.method public final a(Lpkb;)Lopd;
    ...
    invoke-virtual {v1, v0}, Lpco;->a(Lpct;)Lpco;

    iget-object v0, p0, Lpiq;->f:Landroid/net/Uri;

    invoke-direct {p0, v1, v0, p1}, Lpiq;->a(Lpeb;Landroid/net/Uri;Ljava/lang/String;)Lpec;
...
.method public final a()Lpjy;
    ...
    iget-object v1, p0, Lpiq;->c:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Lpiq;->a(Lpeb;Landroid/net/Uri;Ljava/lang/String;)Lpec;
...
.method public final a(Lpjy;)Z
    ...
    iget-object v0, p0, Lpiq;->c:Landroid/net/Uri;
    ...
    invoke-interface {p1}, Lpec;->b()[B

    move-result-object p1

    invoke-virtual {v2, v3, p1}, Landroid/content/ContentValues;->put(Ljava/lang/String;[B)V

    iget-object p1, p0, Lpiq;->b:Landroid/content/ContentProviderClient;
...
.method public final b()Lpjz;
    ...
    iget-object v1, p0, Lpiq;->e:Landroid/net/Uri;
...
.method public final c()Lpka;
    ...
    iget-object v1, p0, Lpiq;->d:Landroid/net/Uri;
...
.method public final d()V
    ...
    iget-object v0, p0, Lpiq;->b:Landroid/content/ContentProviderClient;
