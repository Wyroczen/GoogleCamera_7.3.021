...
.method static constructor <clinit>()V
    ...
    sput-object v0, Leqv;->i:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V
    ...
    iput-boolean v0, p0, Leqv;->b:Z

    invoke-static {p1}, Llam;->a(Landroid/content/Context;)Lkqc;

    move-result-object p1

    iput-object p1, p0, Leqv;->h:Lkqc;

    iput-object p2, p0, Leqv;->j:Ljava/util/concurrent/Executor;
...
.method public static a(Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-object v3, Leqv;->i:Landroid/net/Uri;
    ...
    :goto_1
    :try_start_2
    sget-object v4, Leqv;->a:Ljava/lang/String;

    const-string v5, "Failed to get \'Use My Location\' setting"

    invoke-static {v4, v5, v3}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
...
.method private final b()V
    ...
    invoke-static {p0, v2}, Lkvw;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v2}, Lkvw;->a(Ljava/lang/String;Ljava/lang/Object;)V

    new-instance v2, Lksi;

    invoke-direct {v2, p0, v1}, Lksi;-><init>(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Lkqc;->a(Lksi;)Lldz;

    move-result-object v0

    sget-object v1, Llef;->a:Ljava/util/concurrent/Executor;

    new-instance v2, Lleg;

    invoke-direct {v2}, Lleg;-><init>()V

    move-object v3, v0

    check-cast v3, Lleg;

    iget-object v3, v3, Lleg;->b:Lleb;

    new-instance v4, Lldl;

    invoke-direct {v4, v1, v2}, Lldl;-><init>(Ljava/util/concurrent/Executor;Lleg;)V

    invoke-virtual {v3, v4}, Lleb;->a(Llea;)V

    check-cast v0, Lleg;

    invoke-virtual {v0}, Lleg;->f()V
    :try_end_1
...
.method public static final b(Landroid/location/Location;)Z
    ...
    sget-object p0, Leqv;->a:Ljava/lang/String;

    const-string v1, "Fused location API did not provide a location."

    invoke-static {p0, v1}, Lijc;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2}, Lkbf;->c(J)F
    ...
    invoke-static {v1, p0}, Lijc;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a()Loxn;
    ...
    iget-object v1, p0, Leqv;->d:Landroid/location/Location;
    ...
    iget-object v2, p0, Leqv;->d:Landroid/location/Location;
    ...
    iput-object v2, p0, Leqv;->d:Landroid/location/Location;
    ...
    iget-object v1, p0, Leqv;->h:Lkqc;

    invoke-virtual {v1}, Lkqc;->b()Lldz;

    move-result-object v1

    iget-object v2, p0, Leqv;->j:Ljava/util/concurrent/Executor;

    new-instance v3, Leqt;

    invoke-direct {v3, p0, v0}, Leqt;-><init>(Leqv;Loyd;)V
...
.method public final a(Z)V
    ...
    :try_start_0
    iget-boolean p1, p0, Leqv;->b:Z

    if-nez p1, :cond_0

    const/4 p1, 0x0

    iput-boolean p1, p0, Leqv;->g:Z

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Leqv;->h:Lkqc;

    invoke-virtual {p1}, Lkqc;->b()Lldz;

    move-result-object p1

    iget-object v0, p0, Leqv;->j:Ljava/util/concurrent/Executor;

    new-instance v1, Lequ;

    invoke-direct {v1, p0}, Lequ;-><init>(Leqv;)V

    invoke-virtual {p1, v0, v1}, Lldz;->a(Ljava/util/concurrent/Executor;Lldr;)V
