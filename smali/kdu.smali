...
.field volatile b:Lohb;

.field public c:Z

.field public final d:Ljava/util/concurrent/atomic/AtomicReference;

.field private final e:Lncv;
...
# direct methods
.method public constructor <init>(Landroid/media/ImageReader;Lncv;)V
    .locals 2
    ...
    iput-object v0, p0, Lkdu;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-static {}, Lohb;->c()Lohb;

    move-result-object v0

    iput-object v0, p0, Lkdu;->b:Lohb;

    iput-boolean v1, p0, Lkdu;->c:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object v0, p0, Lkdu;->d:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p1, p0, Lkdu;->f:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lkdu;->g:Loxn;

    iput-object p2, p0, Lkdu;->e:Lncv;
...
.method public final declared-synchronized a()Loxn;
    .locals 2
...
.method final declared-synchronized a(Landroid/media/ImageReader;Lmkp;)V
    .locals 24
    ...
    :try_start_0
    iget-object v3, v1, Lkdu;->a:Lcom/google/android/libraries/oliveoil/bufferflinger/BufferFlinger;

    iget-object v2, v1, Lkdu;->i:Landroid/util/Size;

    iget-boolean v4, v1, Lkdu;->c:Z
    ...
    iget-object v4, v1, Lkdu;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v7, v1, Lkdu;->b:Lohb;

    invoke-virtual {v7}, Lohb;->isEmpty()Z

    move-result v8

    if-nez v8, :cond_1

    invoke-virtual {v7}, Lohb;->d()Lold;
    ...
    invoke-interface {v8, v4, v4}, Lmqg;->a(Landroid/media/Image;Landroid/media/Image;)V
    ...
    :goto_1
    iget-object v10, v1, Lkdu;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v10}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object v10, v1, Lkdu;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_3
    iget v12, v10, Lkdt;->b:I

    iget v13, v10, Lkdt;->c:I

    sget-object v14, Lmkp;->a:Lmkp;
    ...
    :try_start_2
    iget-object v15, v1, Lkdu;->e:Lncv;

    invoke-static {v15, v13}, Lndv;->a(Lncv;Lcom/google/android/libraries/oliveoil/gl/EGLImage;)Lndv;
    ...
    :try_start_4
    invoke-virtual/range {p0 .. p0}, Lkdu;->b()Lncv;

    move-result-object v9

    iget-object v5, v8, Lnhp;->a:Lnbi;

    check-cast v5, Lnce;

    invoke-static {v9, v5}, Lneu;->a(Lncv;Lnce;)Lneu;

    move-result-object v5

    invoke-static {v5}, Lnhv;->a(Lmyl;)Lnhs;

    move-result-object v5

    invoke-static {v5}, Lncu;->a(Lnhs;)Lncu;
    ...
    invoke-static {v9}, Lnev;->a(Lncv;)Lnev;
    ...
    :goto_2
    invoke-virtual {v9, v15, v5, v11}, Lnev;->a(Lndv;Lncu;[F)V

    new-instance v0, Lnct;

    invoke-direct {v0, v5, v8}, Lnct;-><init>(Lncu;Lnho;)V

    invoke-virtual {v5, v0}, Lndd;->a(Lmyo;)Lnab;
    ...
    :try_start_7
    invoke-virtual {v9}, Lnev;->close()V
    :try_end_7
    ...
    :cond_5
    :try_start_9
    invoke-virtual {v15}, Lndd;->close()V
    :try_end_9
    ...
    iget-object v0, v10, Lkdt;->a:Loyd;

    invoke-virtual {v0, v12}, Loyd;->b(Ljava/lang/Object;)Z
    ...
    invoke-direct {v8, v6}, Lkdr;-><init>(Landroid/hardware/HardwareBuffer;)V
    ...
    invoke-direct/range {v2 .. v8}, Lnbf;-><init>(Lcom/google/android/libraries/oliveoil/bufferflinger/BufferFlinger;Landroid/hardware/HardwareBuffer;Landroid/graphics/Rect;Landroid/graphics/Rect;ILcom/google/android/libraries/oliveoil/bufferflinger/BufferFlinger$OnBufferReleasedListener;)V
...
.method public final declared-synchronized a(Landroid/view/Surface;Landroid/util/Size;)V
    ...
    iget-object v0, p0, Lkdu;->a:Lcom/google/android/libraries/oliveoil/bufferflinger/BufferFlinger;
    ...
    :goto_0
    iput-object p2, p0, Lkdu;->i:Landroid/util/Size;
    ...
    iput-object p2, p0, Lkdu;->a:Lcom/google/android/libraries/oliveoil/bufferflinger/BufferFlinger;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized b()Lncv;
    .locals 2
...
.method public final declared-synchronized close()V
    ...
    iget-object v0, p0, Lkdu;->f:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, Lkdu;->a:Lcom/google/android/libraries/oliveoil/bufferflinger/BufferFlinger;
    ...
    iget-object v0, p0, Lkdu;->d:Ljava/util/concurrent/atomic/AtomicReference;
