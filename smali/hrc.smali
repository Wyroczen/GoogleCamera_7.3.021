...
# direct methods
.method public constructor <init>(Lhrf;Landroid/graphics/Bitmap;Ljava/io/File;Lhpp;)V
    .locals 0
    ...
    iput-object p2, p0, Lhrc;->b:Landroid/graphics/Bitmap;

    iput-object p3, p0, Lhrc;->c:Ljava/io/File;

    iput-object p4, p0, Lhrc;->d:Lhpp;
...
.method public final run()V
    ...
    iget-object v1, p0, Lhrc;->b:Landroid/graphics/Bitmap;

    iget-object v2, p0, Lhrc;->c:Ljava/io/File;

    iget-object v3, p0, Lhrc;->d:Lhpp;

    :try_start_0
    iget-object v4, v0, Lhrf;->c:Lhrg;
    ...
    invoke-static {v6}, Losc;->b(Ljava/io/File;)V
    ...
    invoke-virtual {v5, v6, v7}, Llxy;->a(J)V
    ...
    :try_start_1
    iget-object v5, v5, Llxy;->a:Lcom/google/android/libraries/camera/exif/ExifInterface;

    if-eqz v1, :cond_0

    new-instance v7, Loow;

    invoke-direct {v7, v6}, Loow;-><init>(Ljava/io/OutputStream;)V
    :try_end_1
    ...
    invoke-virtual {v7}, Loow;->flush()V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    :try_start_5
    invoke-virtual {v7}, Loow;->close()V
    :try_end_5
