...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnrt;->a:Ljava/util/logging/Logger;
...
.method public static a(Ljava/io/InputStream;)Lael;
    ...
    invoke-static {p0, v0}, Lnrt;->a(Ljava/io/InputStream;Z)Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lnrt;->a(Ljava/util/List;)Lael;
    ...
    iget-object v8, v7, Lnrs;->c:[B

    invoke-static {v8, v1}, Lnrt;->a([BLjava/lang/String;)Z
    ...
    :try_start_2
    sget-object v1, Lnrt;->a:Ljava/util/logging/Logger;
    ...
    invoke-static {p0}, Loys;->a(Ljava/lang/Throwable;)V
...
.method public static a(Ljava/lang/String;)Lael;
    ...
    invoke-static {v0}, Lnrt;->a(Ljava/io/InputStream;)Lael;
...
.method private static a(Ljava/util/List;)Lael;
    ...
    iget-object v5, v4, Lnrs;->c:[B

    const-string v6, "http://ns.adobe.com/xap/1.0/\u0000"

    invoke-static {v5, v6}, Lnrt;->a([BLjava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_0

    iget-object p0, v4, Lnrs;->c:[B
    ...
    sget-object v4, Lnrt;->a:Ljava/util/logging/Logger;
...
.method private static a(Ljava/io/InputStream;Z)Ljava/util/List;
    ...
    :cond_6
    :goto_2
    new-instance v5, Lnrs;

    invoke-direct {v5, v4}, Lnrs;-><init>([B)V
    ...
    iput-object v1, v5, Lnrs;->c:[B

    iget-object v1, v5, Lnrs;->c:[B
    ...
    invoke-direct {p1, v4}, Lnrs;-><init>([B)V
    ...
    :goto_8
    :try_start_8
    sget-object p1, Lnrt;->a:Ljava/util/logging/Logger;
...
.method public static a(Ljava/io/InputStream;Ljava/io/OutputStream;Lael;)Z
    ...
    sget-object v2, Lnrt;->a:Ljava/util/logging/Logger;
    ...
    iget-object v5, v6, Lnrs;->c:[B

    const-string v7, "http://ns.adobe.com/xmp/extension/\u0000"

    invoke-static {v5, v7}, Lnrt;->a([BLjava/lang/String;)Z
    ...
    sget-object p0, Lnrt;->a:Ljava/util/logging/Logger;
    ...
    invoke-static {v6, v3, v0}, Lnrt;->a([B[BI)I

    move-result v6

    invoke-static {p2, v3, v6}, Lnrt;->a([B[BI)I

    new-instance p2, Lnrs;

    invoke-direct {p2, v1}, Lnrs;-><init>([B)V
    ...
    iget-object v2, v2, Lnrs;->c:[B

    invoke-static {v2, v4}, Lnrt;->a([BLjava/lang/String;)Z
