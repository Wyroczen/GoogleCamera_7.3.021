...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llxy;->c:Ljava/lang/Long;
...
.method public constructor <init>(Lcom/google/android/libraries/camera/exif/ExifInterface;)V
    ...
    iput-object p1, p0, Llxy;->a:Lcom/google/android/libraries/camera/exif/ExifInterface;
...
.method public static a(Lcom/google/android/libraries/camera/exif/ExifInterface;)Ljava/lang/Long;
    ...
    sget-object v2, Llxv;->a:Lnzv;

    invoke-virtual {v1, v2}, Loab;->a(Lnzv;)Loab;

    move-result-object v1

    sget-object v2, Llxw;->a:Lnzv;
    ...
    invoke-virtual {v1, v2}, Loab;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v2, Llxx;->a:Lnzv;

    invoke-virtual {p0, v2}, Loab;->a(Lnzv;)Loab;
    ...
    invoke-virtual {p0, v2}, Loab;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final a(Ljava/lang/Double;Ljava/lang/Long;)Lluk;
    .locals 5
    ...
    invoke-direct {v0, v1, v2, p0, p1}, Lluk;-><init>(JJ)V

    return-object v0
.end method

.method private static final a(Ljava/lang/Float;Ljava/lang/Long;)Lluk;
    .locals 3
...
.method public static a()Llxy;
    ...
    invoke-direct {v0, v1}, Llxy;-><init>(Lcom/google/android/libraries/camera/exif/ExifInterface;)V
...
.method private final a(ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Llxy;->a:Lcom/google/android/libraries/camera/exif/ExifInterface;

    invoke-virtual {v0, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V
...
# virtual methods
.method public final a(IILluj;Loab;)V
    .locals 7

    invoke-virtual {p0}, Llxy;->b()V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V
    ...
    invoke-virtual {v0, v1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
    ...
    iget-object p1, p0, Llxy;->a:Lcom/google/android/libraries/camera/exif/ExifInterface;

    sget v0, Lcom/google/android/libraries/camera/exif/ExifInterface;->b:I

    invoke-virtual {p1, v0, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V

    iget-object p1, p0, Llxy;->a:Lcom/google/android/libraries/camera/exif/ExifInterface;

    sget p2, Lcom/google/android/libraries/camera/exif/ExifInterface;->j:I

    invoke-static {p3}, Llxn;->a(Lluj;)Llxn;

    move-result-object p3

    iget-short p3, p3, Llxn;->i:S

    invoke-static {p3}, Ljava/lang/Short;->valueOf(S)Ljava/lang/Short;

    move-result-object p3

    invoke-virtual {p1, p2, p3}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Lluk;-><init>(JJ)V
    ...
    :goto_0
    invoke-direct {p0, v1, v2}, Llxy;->a(ILjava/lang/Object;)V
    ...
    invoke-static {p2, p3}, Llxy;->a(Ljava/lang/Double;Ljava/lang/Long;)Lluk;

    move-result-object p2

    invoke-direct {p0, v0, p2}, Llxy;->a(ILjava/lang/Object;)V

    :cond_1
    sget-object p2, Landroid/hardware/camera2/CaptureResult;->SENSOR_SENSITIVITY:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p1, p2}, Lmpa;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {p2, p3}, Llxy;->a(Ljava/lang/Float;Ljava/lang/Long;)Lluk;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Llxy;->a(ILjava/lang/Object;)V
    ...
    invoke-static {p2, p4}, Llxy;->a(Ljava/lang/Float;Ljava/lang/Long;)Lluk;

    move-result-object p2

    invoke-direct {p0, p3, p2}, Llxy;->a(ILjava/lang/Object;)V
    ...
    invoke-direct {p0, p2, v1}, Llxy;->a(ILjava/lang/Object;)V
    ...
    sget-object v1, Llxy;->c:Ljava/lang/Long;

    invoke-static {p4, v1}, Llxy;->a(Ljava/lang/Float;Ljava/lang/Long;)Lluk;
    ...
    new-instance p4, Lluk;

    const-wide/16 p1, -0x1

    invoke-direct {p4, p1, p2, v1, v2}, Lluk;-><init>(JJ)V
    ...
    invoke-direct {p1, p2, p3, v1, v2}, Lluk;-><init>(JJ)V
    ...
    invoke-direct {p0, p1, p4}, Llxy;->a(ILjava/lang/Object;)V
    ...
    invoke-direct {p0, p1, p2}, Llxy;->a(ILjava/lang/Object;)V
...
.method public final a(Landroid/location/Location;)V
    ...
    invoke-static {v1, v2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(D)[Lluk;

    move-result-object v6

    invoke-virtual {v0, v5, v6}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;

    move-result-object v5

    sget v6, Lcom/google/android/libraries/camera/exif/ExifInterface;->aR:I

    invoke-static {v3, v4}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(D)[Lluk;

    move-result-object v7

    invoke-virtual {v0, v6, v7}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
    ...
    :goto_0
    invoke-virtual {v0, v7, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
    ...
    :goto_1
    invoke-virtual {v0, v2, v3}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
    ...
    invoke-virtual {v0, v5}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V

    invoke-virtual {v0, v6}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V

    invoke-virtual {v0, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V

    invoke-virtual {v0, v2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
    ...
    invoke-virtual {v0, v3}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llxt;)V
    ...
    invoke-direct {v3, v6, v7, v10, v11}, Lluk;-><init>(JJ)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
    ...
    invoke-virtual {v0, p1, v3}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llxt;
