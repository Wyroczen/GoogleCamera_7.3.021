...
.method public constructor <init>(Lllp;Lcew;Lbxg;Lbvq;Lcat;Lbyj;Lceo;Lccj;Lccv;Lcaq;Lcfc;Lbvw;Lbnh;Ljava/util/concurrent/ScheduledExecutorService;Lbpu;Lbyt;Lbxf;Lbym;)V
    .locals 8
    ...
    iput-object v4, v0, Lbvh;->B:Lluf;

    const-string v4, "MediaRecorderExecutor"

    invoke-static {v4}, Llmh;->b(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual/range {p18 .. p18}, Lbym;->c()Llpl;
    ...
    invoke-virtual {p5, v6}, Lcat;->a(Lcas;)Llln;

    move-result-object v6

    invoke-virtual {v6, p0}, Llln;->a(Llul;)Llul;
    ...
    :cond_1
    invoke-virtual/range {p18 .. p18}, Lbym;->v()Lmkp;
...
.method public final a(Z)Loxn;
    ...
    invoke-static {v1}, Lonp;->a(I)Ljava/lang/String;
    ...
    iget-object v3, v1, Lcaq;->e:Loal;

    iget-boolean v5, v3, Loal;->a:Z
    ...
    iget-object v3, v1, Lcaq;->c:Lkfc;

    const-string v5, "/video_state_stopped"

    const-wide/16 v6, -0x1

    invoke-interface {v3, v5, v6, v7}, Lkfc;->a(Ljava/lang/String;J)V

    iget-object v1, v1, Lcaq;->f:Ljava/util/Timer;

    invoke-virtual {v1}, Ljava/util/Timer;->cancel()V

    iget-object v1, p0, Lbvh;->u:Loab;
    ...
    invoke-virtual {v4, v6}, Lcat;->a(Lcas;)Llln;

    move-result-object v4

    invoke-virtual {v4, p1}, Llln;->a(Llul;)Llul;

    new-instance v4, Lbuz;

    invoke-direct {v4, v3, v1}, Lbuz;-><init>(Loyd;Llrj;)V
    ...
    :cond_6
    invoke-interface {v1}, Llrj;->b()Loxn;

    move-result-object p1

    :goto_3
    invoke-virtual {v3, p1}, Loyd;->a(Loxn;)Z
    ...
    invoke-static {v3, p1, v1}, Lowb;->a(Loxn;Lowl;Ljava/util/concurrent/Executor;)Loxn;
    ...
    invoke-static {p1, v1, v2}, Lowb;->a(Loxn;Lnzv;Ljava/util/concurrent/Executor;)Loxn;
...
.method public final a(I)V
    ...
    invoke-static {v2}, Lonp;->a(I)Ljava/lang/String;

    move-result-object v2

    invoke-static {p1}, Lonp;->a(I)Ljava/lang/String;
...
.method public final a(JJ)V
    ...
    iget-object v0, p0, Lbvh;->B:Lluf;

    new-instance v1, Llue;

    long-to-float p3, p3

    invoke-direct {v1, p1, p2, p3}, Llue;-><init>(JF)V

    invoke-virtual {v0, v1}, Lluf;->a(Llue;)F
    ...
    invoke-static {p4}, Lijc;->f(Ljava/lang/String;)V
...
.method public final a(Lbzo;)V
    ...
    invoke-interface {v0}, Llrj;->l()Loab;
    ...
    invoke-virtual {v5, v3}, Loab;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5}, Lbym;->g()Llqd;

    move-result-object v7

    iget-object v8, v1, Lbvh;->v:Lbyt;

    invoke-interface {v0}, Llrj;->i()Loab;

    move-result-object v9

    iget-object v5, v1, Lbvh;->n:Lbxy;

    invoke-virtual {v5}, Lbxy;->i()Llom;
    ...
    :cond_1
    invoke-interface {v0}, Llrj;->k()Loab;
    ...
    invoke-static {v6}, Lzy;->a(Ljava/util/Map;)Lohg;
    ...
    :try_start_2
    invoke-direct/range {v5 .. v21}, Lbzr;-><init>(Ljava/io/File;Llqd;Lbyt;Loab;ZJJIIIIILoab;Ljava/util/Map;)V
    ...
    :goto_1
    invoke-virtual/range {p1 .. p1}, Lbzo;->a()Loab;
    ...
    invoke-static {v5, v0}, Lijc;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v3, Llsb;->i:Llsb;

    invoke-virtual {v0, v3}, Lbue;->a(Llsb;)V
...
.method public final a(Llsb;)V
    ...
    invoke-virtual {v0, p1}, Lbue;->a(Llsb;)V

    iget-object v0, p0, Lbvh;->b:Lbxf;

    invoke-interface {v0, p1}, Lbxf;->a(Llsb;)V
...
.method public final c()V
    ...
    invoke-interface {v1, v2}, Llrj;->a(Ljava/io/File;)V
...
.method public final close()V
    ...
    invoke-virtual {p0, v0}, Lbvh;->a(Z)Loxn;
...
.method public final d()V
    ...
    invoke-interface {v2}, Llrj;->h()Loab;

    move-result-object v2

    invoke-virtual {v1, v2}, Lbzn;->a(Loab;)V
