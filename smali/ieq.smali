...
.field private static final c:Lohb;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Ligi;->b:Landroid/content/ComponentName;

    invoke-virtual {v0}, Landroid/content/ComponentName;->getPackageName()Ljava/lang/String;

    move-result-object v0

    sget-object v1, Ligi;->c:Landroid/content/ComponentName;
    ...
    sput-object v0, Lieq;->c:Lohb;

    return-void
.end method

.method public constructor <init>(Lign;Landroid/content/Context;Lhqf;Llom;Lhnm;Lchh;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lieq;->d:Lign;

    iput-object p2, p0, Lieq;->a:Landroid/content/Context;

    iput-object p3, p0, Lieq;->e:Lhqf;

    iput-object p4, p0, Lieq;->f:Llom;

    iput-object p5, p0, Lieq;->g:Lhnm;

    iput-object p6, p0, Lieq;->h:Lchh;
...
.method private static a(Lbkk;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lewq;->d:Ljava/lang/String;
    ...
    :goto_0
    invoke-static {v1}, Lkvo;->a(I)Ljava/lang/String;

    move-result-object v1

    sget-object v2, Lifq;->h:Ljava/lang/String;

    invoke-interface {p0}, Lbki;->f()Lewo;

    move-result-object v3

    invoke-virtual {v3}, Lewo;->b()Z
...
.method final a(Landroid/content/pm/ResolveInfo;Lbkk;)I
    ...
    invoke-static {p2}, Lieq;->a(Lbkk;)Ljava/lang/String;
    ...
    sget-object v2, Lieq;->c:Lohb;

    iget-object v3, p1, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;

    iget-object v3, v3, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lohb;->contains(Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_3

    iget-object v2, p0, Lieq;->a:Landroid/content/Context;
    ...
    :goto_2
    invoke-virtual {p0, p1}, Lieq;->a(Landroid/content/pm/ResolveInfo;)Z
    ...
    :goto_3
    :try_start_0
    iget-object p2, p0, Lieq;->g:Lhnm;

    invoke-interface {p2, v1}, Lhnm;->a(Landroid/content/Intent;)V
    :try_end_0
...
.method final a(Lbkk;Ljava/util/List;)I
    ...
    iget-object v5, p0, Lieq;->e:Lhqf;

    invoke-interface {v5, v2}, Lhqf;->a(Landroid/net/Uri;)Lhpp;
    ...
    :cond_2
    invoke-interface {v0}, Lbki;->g()Lewc;

    move-result-object v2

    iget-object v5, v2, Lewc;->b:Lewb;

    iget-boolean v5, v5, Lewb;->j:Z

    if-nez v5, :cond_4

    invoke-virtual {v2}, Lewc;->e()Z

    move-result v5

    if-nez v5, :cond_4

    invoke-virtual {v2}, Lewc;->d()Z
    ...
    invoke-static {v2}, Lkvo;->a(I)Ljava/lang/String;

    move-result-object p1

    sget-object p2, Lifq;->h:Ljava/lang/String;
    ...
    :cond_6
    invoke-static {p1}, Lieq;->a(Lbkk;)Ljava/lang/String;

    move-result-object p1

    iget-object v2, p0, Lieq;->d:Lign;

    invoke-interface {v2, p1}, Lign;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v4, p0, Lieq;->d:Lign;

    invoke-interface {v4, p1}, Lign;->b(Ljava/lang/String;)Ljava/util/Map;
    ...
    iget-object v5, p0, Lieq;->a:Landroid/content/Context;
    ...
    invoke-virtual {v4, p1}, Logw;->c(Ljava/lang/Object;)V

    invoke-virtual {v4, v2}, Logw;->b(Ljava/lang/Iterable;)V

    invoke-virtual {v4}, Logw;->a()Lohb;
