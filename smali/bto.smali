...
.method public constructor <init>(Lbyr;Lbtf;Lcat;Lbyj;Ljava/util/concurrent/Executor;Lbfc;Lpng;Lcfj;Lkhb;Ldwy;Lllp;Llvi;Ljqm;Lizc;)V
    .locals 1
    ...
    iput-object v0, p0, Lbto;->h:Ljqt;

    new-instance v0, Lbtl;

    invoke-direct {v0, p0}, Lbtl;-><init>(Lbto;)V

    iput-object v0, p0, Lbto;->j:Ldwv;
    ...
    iput-object p7, p0, Lbto;->t:Lpng;

    iput-object p8, p0, Lbto;->u:Lcfj;

    iput-object p9, p0, Lbto;->f:Lkhb;

    iput-object p10, p0, Lbto;->i:Ldwy;

    iput-object p11, p0, Lbto;->b:Lllp;

    iput-object p12, p0, Lbto;->d:Llvi;

    iput-object p13, p0, Lbto;->v:Ljqm;

    iput-object p14, p0, Lbto;->g:Lizc;
...
.method private final i()V
    ...
    iget-object v4, v2, Lbvw;->g:Lkhb;

    invoke-interface {v4}, Lkhb;->l()V

    iget-object v4, v2, Lbvw;->n:Lmon;

    invoke-virtual {v4}, Lmon;->c()Z
    ...
    invoke-interface {v4, v5}, Lkhb;->a(Z)V
    ...
    iget-object v6, v6, Lbxs;->a:Lfyr;

    invoke-virtual {v4, v6}, Lcdw;->a(Lfyr;)V

    iget-object v2, v2, Lbvw;->h:Lgpp;

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {v3}, Lbym;->u()Lohb;
    ...
    sget-object v9, Llpl;->a:Llpl;

    invoke-virtual {v6}, Llpl;->ordinal()I
    ...
    iget-object v3, v2, Lgpp;->am:Loeo;

    check-cast v3, Lojq;

    iget-object v3, v3, Lojq;->e:Lojq;
    ...
    invoke-interface {v3, v11}, Loeo;->containsKey(Ljava/lang/Object;)Z

    move-result v12

    if-eqz v12, :cond_8

    invoke-interface {v3, v11}, Loeo;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_4
    iput-boolean v3, v2, Lgpp;->ag:Z

    iget-object v3, v2, Lgpp;->aG:Lgon;

    invoke-virtual {v3, v6}, Lgon;->a(Ljava/util/List;)Lgpw;

    move-result-object v3

    iput-object v3, v2, Lgpp;->Q:Lgpw;

    invoke-virtual {v2}, Lgpp;->f()V
    ...
    :goto_5
    invoke-virtual {v2}, Lbym;->v()Lmkp;

    move-result-object v9

    invoke-static {v4}, Lltw;->a(Llun;)Lltw;
    ...
    :goto_6
    invoke-static {v9, v4, v10, v6}, Ljuj;->a(Lmkp;Llun;Lltw;Loab;)Ljuj;

    move-result-object v4

    iget-object v6, v3, Lcfe;->b:Lbxg;

    invoke-interface {v6}, Lbxg;->g()Ljyr;
    ...
    iget-object v6, v3, Lcfe;->e:Ljud;

    iget-object v3, v3, Lcfe;->a:Ljub;

    invoke-virtual {v6, v3, v4}, Ljud;->a(Ljub;Ljuj;)Loxn;
    ...
    :goto_7
    new-array v4, v8, [Loxn;

    aput-object v3, v4, v5

    invoke-static {v4}, Loyz;->b([Loxn;)Loxg;

    move-result-object v4

    new-instance v6, Lbtb;

    invoke-direct {v6, v1, v2, v3}, Lbtb;-><init>(Lbtf;Lbym;Loxn;)V

    iget-object v2, v1, Lbtf;->b:Ljava/util/concurrent/Executor;

    invoke-virtual {v4, v6, v2}, Loxg;->a(Lowk;Ljava/util/concurrent/Executor;)Loxn;

    move-result-object v2

    new-array v3, v7, [Loxn;

    iget-object v4, v1, Lbtf;->p:Loyd;

    aput-object v4, v3, v5

    aput-object v2, v3, v8

    invoke-static {v3}, Loyz;->b([Loxn;)Loxg;

    move-result-object v3

    new-instance v4, Lbtc;

    invoke-direct {v4, v2}, Lbtc;-><init>(Loxn;)V

    iget-object v1, v1, Lbtf;->c:Lllp;

    invoke-virtual {v3, v4, v1}, Loxg;->a(Lowk;Ljava/util/concurrent/Executor;)Loxn;

    move-result-object v1

    iput-object v1, p0, Lbto;->x:Loxn;

    new-instance v2, Lbtn;

    invoke-direct {v2, p0, v1}, Lbtn;-><init>(Lbto;Loxn;)V
...
.method private final j()V
    ...
    invoke-interface {v1, v3}, Loxn;->cancel(Z)Z

    iput-object v2, p0, Lbto;->x:Loxn;
...
.method public final a(Z)V
    ...
    invoke-virtual {v1, v2}, Lcat;->a(Lcas;)Llln;
    ...
    iget-object v2, p0, Lbto;->i:Ldwy;

    iget-object v3, p0, Lbto;->j:Ldwv;
    ...
    iget-object v2, p0, Lbto;->v:Ljqm;

    iget-object v3, p0, Lbto;->h:Ljqt;
