...
# direct methods
.method public constructor <init>(Leut;Likz;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lezn;->a:Leut;

    iput-object p2, p0, Lezn;->b:Likz;
...
.method public final a(Ljava/io/File;Ljava/io/File;)V
    ...
    :try_start_2
    invoke-static {v0}, Llxy;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)Ljava/lang/Long;
    ...
    sget-object v3, Lezp;->a:Ljava/lang/String;
    ...
    iget-object v2, p0, Lezn;->a:Leut;

    invoke-interface {v2, v0}, Leut;->a(Landroid/net/Uri;)Ljava/io/OutputStream;
    ...
    :try_start_5
    iget-object v0, p0, Lezn;->b:Likz;

    invoke-interface {v0, v8, v1}, Likz;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_5
    ...
    invoke-direct {v1, v0, v2}, Lilj;-><init>(Llun;Lmpt;)V

    invoke-virtual {v1, p2}, Lilj;->a(Ljava/io/File;)V

    invoke-virtual {v1, p1}, Lilj;->a(Lluj;)V

    invoke-virtual {v7, v1}, Loyd;->b(Ljava/lang/Object;)Z
    :try_end_6
    ...
    invoke-virtual {v7, p1}, Loyd;->a(Ljava/lang/Throwable;)Z
