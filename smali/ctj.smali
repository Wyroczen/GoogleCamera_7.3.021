...
.method public final onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {p2, v0}, Llom;->a(Ljava/lang/Object;)V
    ...
    invoke-interface {p2, v1}, Llom;->a(Ljava/lang/Object;)V
    ...
    sget-object v6, Lnrc;->m:Lnrc;

    invoke-static {v6, v0, v5}, Lpct;->a(Lpct;[BLpcg;)Lpct;

    move-result-object v0

    check-cast v0, Lnrc;

    invoke-static {p2, v0}, Lnrb;->a(Landroid/content/Context;Lnrc;)Lnrb;
    ...
    :try_end_2
    .catch Lpde; {:try_start_2 .. :try_end_2} :catch_2
    ...
    invoke-interface {v1}, Landroid/database/Cursor;->close()V
    :try_end_4
    .catch Lpde; {:try_start_4 .. :try_end_4} :catch_2
    ...
    throw p2
    :try_end_6
    .catch Lpde; {:try_start_6 .. :try_end_6} :catch_2
    ...
    iget-object v5, v5, Lctk;->h:Ljrx;

    invoke-interface {v5, p2}, Ljrx;->a(Ljava/lang/String;)Ljsl;

    move-result-object p2

    sget-object v5, Ljzi;->a:Ljzi;

    iget-object v5, p0, Lctj;->b:Lctk;

    iget-object v5, v5, Lctk;->d:Lcom/google/android/apps/camera/evcomp/EvCompView;

    invoke-virtual {v5}, Lcom/google/android/apps/camera/evcomp/EvCompView;->d()Ljzi;

    move-result-object v5

    invoke-virtual {v5}, Ljzi;->ordinal()I
    ...
    invoke-interface {p2, p1}, Ljsl;->b(Landroid/view/View;)Ljsi;
    ...
    invoke-interface {p2, p1, v0}, Ljsl;->a(Landroid/view/View;I)Ljsi;
    ...
    invoke-interface {p2, p1, v0}, Ljsl;->b(Landroid/view/View;I)Ljsi;

    move-result-object p1

    :goto_5
    invoke-interface {p1}, Ljsi;->a()Ljsj;

    move-result-object p1

    invoke-interface {p1}, Ljsj;->d()Ljsk;

    move-result-object p1

    invoke-interface {p1}, Ljsk;->e()Ljsk;

    move-result-object p1

    const/16 p2, 0x12c

    invoke-interface {p1, p2}, Ljsk;->c(I)Ljsk;

    move-result-object p1

    const/16 p2, 0xce4

    invoke-interface {p1, p2}, Ljsk;->b(I)Ljsk;

    move-result-object p1

    invoke-interface {p1}, Ljsk;->g()Ljsk;

    move-result-object p1

    invoke-interface {p1, v2}, Ljsk;->a(Z)Ljsk;

    move-result-object p1

    new-instance p2, Lcti;

    invoke-direct {p2, p0, v1}, Lcti;-><init>(Lctj;Loab;)V

    sget-object v0, Lllp;->b:Lllp;

    invoke-interface {p1, p2, v0}, Ljsk;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)Ljsk;

    move-result-object p1

    invoke-interface {p1}, Ljsk;->f()Llul;

    move-result-object p1

    iget-object p2, p0, Lctj;->b:Lctk;

    iget-object p2, p2, Lctk;->b:Llln;
