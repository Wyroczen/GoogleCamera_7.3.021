...
.method public final a(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    iget-object v0, p0, Lnxn;->a:Lnxu;

    iget-object v1, p1, Lcom/google/android/material/textfield/TextInputLayout;->a:Landroid/widget/EditText;

    invoke-virtual {v0, v1}, Lnxu;->a(Landroid/widget/EditText;)Landroid/widget/AutoCompleteTextView;

    move-result-object v0

    iget-object v1, p0, Lnxn;->a:Lnxu;

    iget-object v2, v1, Lnxu;->k:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iget-object v1, v1, Lnxu;->f:Landroid/graphics/drawable/StateListDrawable;
    ...
    :goto_1
    iget-object v2, v2, Lcom/google/android/material/textfield/TextInputLayout;->j:Lnwd;

    const v7, 0x7f0400bd

    invoke-static {v0, v7}, Lnvx;->a(Landroid/view/View;I)I
    ...
    iget-object v1, v1, Lnxu;->k:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    invoke-static {v0, v1}, Lnvx;->a(Landroid/view/View;I)I

    move-result v1

    new-instance v6, Lnwd;

    invoke-virtual {v2}, Lnwd;->a()Lnwj;

    move-result-object v10

    invoke-direct {v6, v10}, Lnwd;-><init>(Lnwj;)V
    ...
    invoke-virtual {v6, v10}, Lnwd;->a(Landroid/content/res/ColorStateList;)V

    invoke-virtual {v6, v1}, Lnwd;->setTint(I)V
    ...
    invoke-direct {v7, v8}, Lnwd;-><init>(Lnwj;)V

    const/4 v8, -0x1

    invoke-virtual {v7, v8}, Lnwd;->setTint(I)V
    ...
    invoke-direct {v2, v1, v0}, Lnxp;-><init>(Lnxu;Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-direct {v2, v1}, Lnxq;-><init>(Lnxu;)V
    ...
    invoke-direct {v2, v1}, Lnxr;-><init>(Lnxu;)V
    ...
    iget-object v1, v1, Lnxu;->a:Landroid/text/TextWatcher;
    ...
    iget-object v0, v0, Lnxu;->b:Lnyj;

    invoke-virtual {p1, v0}, Lcom/google/android/material/textfield/TextInputLayout;->a(Lnyj;)V
