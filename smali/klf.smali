...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lklf;->u:Z

    sget-boolean v0, Lklf;->s:Z
    ...
    :goto_0
    sput-object v0, Lklf;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-boolean v0, Lklf;->s:Z

    if-eqz v0, :cond_5

    invoke-static {}, Lklf;->e()Z
    ...
    :goto_1
    sput-object v0, Lklf;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_2
    sput-object v0, Lklf;->c:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_3
    sput-object v0, Lklf;->d:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_4
    sput-object v0, Lklf;->e:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_5
    sput-object v0, Lklf;->f:Landroid/hardware/camera2/CaptureResult$Key;

    sget-boolean v0, Lklf;->s:Z

    if-eqz v0, :cond_10

    invoke-static {}, Lklf;->c()Z
    ...
    :goto_6
    sput-object v0, Lklf;->g:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_7
    sput-object v0, Lklf;->h:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_8
    sput-object v0, Lklf;->i:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-static {}, Lklf;->f()Z
    ...
    :goto_9
    sput-object v2, Lklf;->j:Landroid/hardware/camera2/CaptureRequest$Key;

    sget-boolean v2, Lklf;->s:Z

    if-eqz v2, :cond_1b

    invoke-static {}, Lklf;->g()Z
    ...
    :goto_b
    sput-object v2, Lklf;->k:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-static {}, Lklf;->h()Z
    ...
    :goto_d
    sput-object v2, Lklf;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_f
    sput-object v2, Lklf;->m:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_11
    sput-object v2, Lklf;->n:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_13
    sput-object v2, Lklf;->o:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-boolean v2, Lklf;->s:Z

    if-eqz v2, :cond_33

    invoke-static {}, Lklf;->i()Z
    ...
    :goto_15
    sput-object v2, Lklf;->p:Landroid/hardware/camera2/CaptureRequest$Key;

    sput-object v0, Lklf;->q:Ljava/lang/Integer;
    ...
    :goto_1a
    sput-object v1, Lklf;->r:Landroid/hardware/camera2/CaptureResult$Key;
