...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkib;->h:Ljava/lang/String;
...
.method public constructor <init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;Ljava/util/Set;Llom;Lert;Lcfo;Llnt;Lchh;)V
    ...
    invoke-direct {v0, p0}, Lkhs;-><init>(Lkib;)V

    iput-object v0, p0, Lkib;->a:Landroid/animation/AnimatorListenerAdapter;

    new-instance v0, Lkht;

    invoke-direct {v0, p0}, Lkht;-><init>(Lkib;)V

    iput-object v0, p0, Lkib;->b:Landroid/animation/AnimatorListenerAdapter;

    new-instance v0, Lkhp;

    invoke-direct {v0, p0}, Lkhp;-><init>(Lkib;)V

    iput-object v0, p0, Lkib;->c:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v0, Lkhq;

    invoke-direct {v0, p0}, Lkhq;-><init>(Lkib;)V

    iput-object v0, p0, Lkib;->i:Ljava/lang/Runnable;
    ...
    iput-object p2, p0, Lkib;->e:Ljava/util/Set;

    iput-object p3, p0, Lkib;->j:Llom;

    iput-object p5, p0, Lkib;->d:Lcfo;

    iput-object p4, p0, Lkib;->f:Lert;

    iput-object p6, p0, Lkib;->u:Llnt;

    iput-object p7, p0, Lkib;->v:Lchh;
    ...
    iput-object p2, p0, Lkib;->q:Landroid/view/ViewGroup;

    invoke-virtual {p1}, Lcom/google/android/apps/camera/zoomui/ZoomUi;->d()Lcom/google/android/apps/camera/zoomui/ZoomKnob;

    move-result-object p2

    iput-object p2, p0, Lkib;->k:Lcom/google/android/apps/camera/zoomui/ZoomKnob;

    invoke-virtual {p1}, Lcom/google/android/apps/camera/zoomui/ZoomUi;->c()Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;

    move-result-object p1

    iput-object p1, p0, Lkib;->l:Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;

    new-instance p1, Landroid/animation/ValueAnimator;

    invoke-direct {p1}, Landroid/animation/ValueAnimator;-><init>()V

    iput-object p1, p0, Lkib;->p:Landroid/animation/ValueAnimator;

    iget-object p2, p0, Lkib;->c:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object p1, p0, Lkib;->p:Landroid/animation/ValueAnimator;

    iget-object p2, p0, Lkib;->a:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object p1, p0, Lkib;->o:Landroid/animation/ValueAnimator;
    ...
    iput-object p1, p0, Lkib;->n:Landroid/animation/ValueAnimator;

    iget-object p2, p0, Lkib;->c:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object p1, p0, Lkib;->n:Landroid/animation/ValueAnimator;
    ...
    iget-object p2, p0, Lkib;->b:Landroid/animation/AnimatorListenerAdapter;

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object p1, p0, Lkib;->q:Landroid/view/ViewGroup;
    ...
    invoke-direct {p4, p1}, Lkhu;-><init>(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lkib;->m:Landroid/animation/AnimatorSet;
...
.method public final a(I)V
    ...
    iget-object v0, p0, Lkib;->e:Ljava/util/Set;
    ...
    invoke-interface {v1, p1}, Lkgz;->a(I)V
...
.method public final a(IFF)V
    ...
    iget-object v0, p0, Lkib;->f:Lert;

    iget-object v1, p0, Lkib;->d:Lcfo;

    invoke-interface {v1}, Lcfo;->d()Lmkp;

    move-result-object v1

    invoke-interface {v0, p1, p2, p3, v1}, Lert;->a(IFFLmkp;)V
...
.method public final b(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lkib;->m:Landroid/animation/AnimatorSet;
...
.method public final l()V
    ...
    iget-object v0, p0, Lkib;->k:Lcom/google/android/apps/camera/zoomui/ZoomKnob;
    ...
    iget-object v0, p0, Lkib;->q:Landroid/view/ViewGroup;

    invoke-virtual {v0}, Landroid/view/ViewGroup;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    iget-object v1, p0, Lkib;->k:Lcom/google/android/apps/camera/zoomui/ZoomKnob;

    new-instance v2, Lkhr;

    invoke-direct {v2, p0}, Lkhr;-><init>(Lkib;)V
