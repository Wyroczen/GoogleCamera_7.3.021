...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;)V
    ...
    invoke-direct {p1, p0}, Lnwz;-><init>(Lnxh;)V

    iput-object p1, p0, Lnxh;->a:Landroid/text/TextWatcher;

    new-instance p1, Lnxb;

    invoke-direct {p1, p0}, Lnxb;-><init>(Lnxh;)V

    iput-object p1, p0, Lnxh;->b:Lnyk;
...
.method private final varargs a([F)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v0, p0}, Lnxf;-><init>(Lnxh;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lnxh;->k:Lcom/google/android/material/textfield/TextInputLayout;

    iget-object v1, p0, Lnxh;->l:Landroid/content/Context;
    ...
    sget-object v2, Lnsf;->d:Landroid/animation/TimeInterpolator;
    ...
    invoke-direct {v2, p0}, Lnxg;-><init>(Lnxh;)V
    ...
    invoke-direct {p0, v2}, Lnxh;->a([F)Landroid/animation/ValueAnimator;
    ...
    iput-object v3, p0, Lnxh;->c:Landroid/animation/AnimatorSet;
    ...
    iget-object v1, p0, Lnxh;->c:Landroid/animation/AnimatorSet;

    new-instance v2, Lnxd;

    invoke-direct {v2, p0}, Lnxd;-><init>(Lnxh;)V
    ...
    invoke-direct {p0, v0}, Lnxh;->a([F)Landroid/animation/ValueAnimator;

    move-result-object v0

    iput-object v0, p0, Lnxh;->d:Landroid/animation/ValueAnimator;

    new-instance v1, Lnxe;

    invoke-direct {v1, p0}, Lnxe;-><init>(Lnxh;)V
...
.method public final a(Z)V
    ...
    invoke-virtual {p0, p1}, Lnxh;->b(Z)V
...
.method public final b(Z)V
    ...
    iget-object p1, p0, Lnxh;->d:Landroid/animation/ValueAnimator;

    invoke-virtual {p1}, Landroid/animation/ValueAnimator;->cancel()V

    iget-object p1, p0, Lnxh;->c:Landroid/animation/AnimatorSet;
