...
.method public constructor <init>(Landroid/hardware/SensorManager;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p2, p0, Lhpi;->c:Ljava/util/concurrent/Executor;
    ...
    :goto_0
    iput-object p2, p0, Lhpi;->b:Landroid/hardware/Sensor;
...
.method public final a(Landroid/hardware/SensorEventListener;)V
    ...
    iget-object v0, p0, Lhpi;->b:Landroid/hardware/Sensor;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lhpi;->c:Ljava/util/concurrent/Executor;

    new-instance v1, Lhph;

    invoke-direct {v1, p0, p1}, Lhph;-><init>(Lhpi;Landroid/hardware/SensorEventListener;)V
...
.method public final b(Landroid/hardware/SensorEventListener;)V
    ...
    invoke-direct {v1, p0, p1}, Lhpg;-><init>(Lhpi;Landroid/hardware/SensorEventListener;)V
