...
# direct methods
.method public constructor <init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lerq;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhfy;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iput-object p2, p0, Lhfy;->b:Lerq;
...
.method public final run()V
    ...
    iget-object v0, p0, Lhfy;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iget-object v1, p0, Lhfy;->b:Lerq;

    :goto_0
    :try_start_0
    iget-object v2, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->l:Lhgd;

    iget-object v3, v2, Lhgd;->b:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v4, v2, Lhgd;->c:Ljava/util/LinkedList;
    ...
    iget-object v6, v2, Lhgd;->a:Llva;

    iget-object v2, v2, Lhgd;->c:Ljava/util/LinkedList;
    ...
    invoke-interface {v6, v2}, Llva;->b(Ljava/lang/String;)V
    ...
    :cond_1
    :goto_1
    iget-object v4, v2, Lhgd;->a:Llva;

    iget-boolean v6, v2, Lhgd;->e:Z
    ...
    invoke-interface {v4, v6}, Llva;->b(Ljava/lang/String;)V
    ...
    :try_start_3
    iput-object v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Lhgf;
    ...
    :try_start_9
    iput-object v4, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Lhgf;

    iget-boolean v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->f:Z

    if-eqz v5, :cond_3

    iget-object v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Lhgf;

    invoke-interface {v5}, Lhgf;->a()V
    ...
    :try_start_a
    invoke-interface {v4}, Lhgf;->c()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v3}, Lerq;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v4}, Lhgf;->d()Lhge;
    ...
    :cond_4
    invoke-interface {v2, v0}, Lhge;->a(Lhgh;)V

    :goto_3
    invoke-static {}, Ljava/lang/System;->gc()V

    iget-object v2, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->d:Lhgi;

    invoke-interface {v4}, Lhgf;->c()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lhgi;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v0}, Lhgf;->a(Landroid/content/Context;)V
    ...
    :try_start_f
    iget-object v3, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->p:Lllp;

    new-instance v4, Lhfz;

    invoke-direct {v4, v2}, Lhfz;-><init>(Ljava/lang/Exception;)V

    invoke-virtual {v3, v4}, Lllp;->execute(Ljava/lang/Runnable;)V
    :try_end_f
    .catchall {:try_start_f .. :try_end_f} :catchall_4

    :goto_4
    invoke-virtual {v1}, Lerq;->b()V
