...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnrg;->b:[Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-direct {v2, v1}, Lnrh;-><init>(Ljava/io/FileDescriptor;)V

    invoke-static {v2}, Lnrj;->a(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-direct/range {v6 .. v11}, Lnrj;-><init>(JJZ)V

    sget v1, Landroid/os/Build$VERSION;->SDK_INT:I

    new-instance v1, Lnri;

    invoke-direct {v1, p1}, Lnri;-><init>(Ljava/lang/String;)V

    invoke-static {v1}, Lnrj;->a(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    :cond_2
    iget-wide v7, v2, Lnrj;->a:J

    iget-wide v9, v3, Lnrj;->a:J
    ...
    :cond_3
    iget-wide v1, v2, Lnrj;->b:J

    iget-wide v7, v3, Lnrj;->b:J
    ...
    invoke-direct {v1, p0}, Lnrd;-><init>(Landroid/content/Context;)V

    invoke-static {v1}, Lnrg;->a(Ljava/util/concurrent/Callable;)[Ljava/io/File;
    ...
    invoke-static {p2, p1}, Lnrg;->a(Landroid/os/ParcelFileDescriptor;Ljava/io/FileNotFoundException;)V
    ...
    invoke-static {p2, p0}, Lnrg;->a(Landroid/os/ParcelFileDescriptor;Ljava/io/FileNotFoundException;)V
    ...
    sget-object p0, Lnrg;->c:[Ljava/lang/String;
    ...
    sget-object p0, Lnrg;->b:[Ljava/lang/String;
