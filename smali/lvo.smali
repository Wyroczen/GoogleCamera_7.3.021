...
.method public final run()V
    ...
    iget-object v9, v1, Llvo;->a:Llvs;

    iget-object v0, v9, Llvs;->f:Llvi;

    iget-object v2, v9, Llvs;->a:Ljava/lang/String;
    ...
    :try_start_1
    new-instance v12, Llvp;

    invoke-direct {v12, v9}, Llvp;-><init>(Llvs;)V

    iget-object v3, v9, Llvs;->b:Landroid/hardware/camera2/CameraManager;

    iget-object v4, v9, Llvs;->e:Landroid/os/Handler;
    ...
    :try_start_2
    iget-object v3, v9, Llvs;->g:Ljava/lang/Object;
    ...
    :try_start_3
    iget-boolean v4, v9, Llvs;->l:Z

    if-eqz v4, :cond_1

    invoke-virtual {v2}, Llwi;->b()V
    ...
    :try_start_4
    iget-object v0, v9, Llvs;->b:Landroid/hardware/camera2/CameraManager;
    ...
    invoke-virtual/range {v2 .. v8}, Llvs;->a(Llwi;ZJJ)Llvq;
    ...
    iget-object v4, v9, Llvs;->g:Ljava/lang/Object;
    ...
    :try_start_b
    iget-object v3, v9, Llvs;->h:Ljava/lang/Object;
    ...
    iget-object v4, v9, Llvs;->a:Ljava/lang/String;
    ...
    iget-object v0, v9, Llvs;->h:Ljava/lang/Object;
    ...
    invoke-virtual {v14}, Llwi;->b()V

    new-instance v14, Llwi;

    invoke-direct {v14}, Llwi;-><init>()V
    :try_end_12
    ...
    :cond_6
    invoke-virtual {v9, v15}, Llvs;->a(Z)V

    new-instance v2, Llwi;

    invoke-direct {v2}, Llwi;-><init>()V

    invoke-virtual {v2, v3}, Llwi;->a(I)V
    :try_end_16
    ...
    invoke-virtual {v14, v3}, Llwi;->a(I)V
    :try_end_1b
    ...
    iget-object v0, v9, Llvs;->c:Llvv;

    invoke-interface {v0, v13}, Llvv;->c(I)V

    goto :goto_6

    :cond_a
    iget-object v0, v9, Llvs;->a:Ljava/lang/String;
    ...
    :goto_8
    iget-object v0, v9, Llvs;->i:Llwi;

    invoke-virtual {v2, v0}, Llwi;->a(Llvm;)V
    :try_end_1e
    .catchall {:try_start_1e .. :try_end_1e} :catchall_7

    iget-object v0, v9, Llvs;->j:Ljava/util/concurrent/CountDownLatch;
    ...
    :try_start_21
    iget-object v2, v9, Llvs;->b:Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v2, v9, Llvs;->j:Ljava/util/concurrent/CountDownLatch;
