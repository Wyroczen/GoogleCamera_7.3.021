...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkpc;->d:Ljava/lang/Object;
...
.method public static final a(Landroid/content/Context;ILkuk;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :goto_1
    invoke-static {p0, p1}, Lkue;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p0, p1}, Lkue;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lkue;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static final a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p0, p1, v0}, Lkpc;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    new-instance v1, Lkuh;

    invoke-direct {v1, v0, p0, p2}, Lkuh;-><init>(Landroid/content/Intent;Landroid/app/Activity;I)V

    invoke-static {p0, p1, v1, p3}, Lkpc;->a(Landroid/content/Context;ILkuk;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, p1, p2, p3}, Lkpc;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public static final a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    iput-object p1, v2, Lkpr;->ag:Landroid/app/Dialog;
    ...
    :cond_1
    iput-object p3, v2, Lkpr;->ah:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iput-object p1, v2, Lkoy;->a:Landroid/app/Dialog;

    if-eqz p3, :cond_2

    iput-object p3, v2, Lkoy;->b:Landroid/content/DialogInterface$OnCancelListener;

    :cond_2
    invoke-virtual {v2, p0, p2}, Lkoy;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public final a(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p2, p0, p1}, Lkpb;-><init>(Lkpc;Landroid/content/Context;)V
    ...
    invoke-static {p1, p2}, Lkue;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v1

    invoke-static {p1, p2}, Lkue;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lkwg;->a(Landroid/content/Context;)Z
    ...
    invoke-static {p1}, Lkwg;->b(Landroid/content/Context;)V
    ...
    sget-object p3, Lkpc;->d:Ljava/lang/Object;
    ...
    invoke-static {p1}, Lkue;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_6
    sget-object p2, Lkpp;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
