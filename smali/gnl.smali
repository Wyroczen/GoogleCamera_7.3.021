...
# direct methods
.method public constructor <init>(Lluz;Lcmf;)V
    .locals 2
    ...
    iput-object p1, p0, Lgnl;->a:Llva;

    iput-object p2, p0, Lgnl;->b:Lcmf;
...
# virtual methods
.method public final a(Lmpe;DD)V
    .locals 7

    sget-object p4, Landroid/hardware/camera2/CaptureResult;->SENSOR_TIMESTAMP:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p1, p4}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p5}, Lmpe;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p4}, Llva;->d(Ljava/lang/String;)V
