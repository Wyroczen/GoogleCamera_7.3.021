...
.method public constructor <init>(Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;ILandroid/app/Activity;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v0, p0}, Lmwc;-><init>(Lmwd;)V

    iput-object v0, p0, Lmwd;->j:Lx;

    iput-object p1, p0, Lmwd;->a:Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;

    iput p2, p0, Lmwd;->h:I

    iput-object p3, p0, Lmwd;->b:Landroid/app/Activity;

    iput-object p4, p0, Lmwd;->i:Ljava/util/concurrent/Executor;
...
.method public final a(IILandroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lmwd;->k()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmwd;->a:Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;
    ...
    iget-object p1, p0, Lmwd;->g:Lmwo;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lmwo;->b()V
...
.method public final a(Lmvh;)V
    ...
    invoke-direct {v1, p1}, Lmvt;-><init>(Lmvh;)V
...
.method public final a(Ly;Landroid/view/ViewGroup;Lmve;Lpax;)Z
    .locals 3
    ...
    invoke-static {p4}, Lmwg;->a(Lpax;)Lmxb;
    ...
    iget-object p4, p4, Lpax;->b:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, Lmwd;->c:Ly;

    iput-object p2, p0, Lmwd;->d:Landroid/view/ViewGroup;

    iput-object p3, p0, Lmwd;->e:Lmve;

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor()Ljava/util/concurrent/ExecutorService;

    move-result-object p4

    iput-object p4, p0, Lmwd;->f:Ljava/util/concurrent/ExecutorService;

    new-instance p4, Lmvr;

    invoke-direct {p4, v2}, Lmvr;-><init>([B)V

    iget-object v0, p0, Lmwd;->b:Landroid/app/Activity;
    ...
    iput-object v0, p4, Lmvr;->b:Landroid/app/Activity;

    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance p3, Lmwa;

    invoke-direct {p3}, Lmwa;-><init>()V
    ...
    iput-object p3, p4, Lmvr;->c:Loam;

    iget-object p3, p0, Lmwd;->f:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object p3, p4, Lmvr;->d:Ljava/util/concurrent/ExecutorService;

    iget-object p3, p0, Lmwd;->a:Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;
    ...
    iput-object p3, p4, Lmvr;->a:Lmwn;

    iget-object p3, p4, Lmvr;->a:Lmwn;

    const-class v0, Lmwn;

    invoke-static {p3, v0}, Lcqy;->a(Ljava/lang/Object;Ljava/lang/Class;)V

    iget-object p3, p4, Lmvr;->b:Landroid/app/Activity;

    const-class v0, Landroid/app/Activity;

    invoke-static {p3, v0}, Lcqy;->a(Ljava/lang/Object;Ljava/lang/Class;)V

    iget-object p3, p4, Lmvr;->c:Loam;

    const-class v0, Loam;

    invoke-static {p3, v0}, Lcqy;->a(Ljava/lang/Object;Ljava/lang/Class;)V

    iget-object p3, p4, Lmvr;->d:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object p1, p1, Lfkv;->f:Laa;

    iget-object p2, p0, Lmwd;->j:Lx;

    invoke-virtual {p1, p2}, Lv;->a(Lx;)V

    iget-object p1, p0, Lmwd;->i:Ljava/util/concurrent/Executor;

    new-instance p2, Lmvz;

    invoke-direct {p2, p0}, Lmvz;-><init>(Lmwd;)V
...
.method public final g()V
    ...
    invoke-interface {v0}, Lmve;->b()V

    iget-object v1, p0, Lmwd;->c:Ly;
    ...
    iget-object v2, p0, Lmwd;->j:Lx;

    invoke-virtual {v1, v2}, Lv;->b(Lx;)V

    iget-object v2, p0, Lmwd;->a:Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;
    ...
    iget-object v3, p0, Lmwd;->a:Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;
    ...
    iget-object v1, p0, Lmwd;->a:Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;

    invoke-interface {v1}, Lcom/google/android/libraries/lens/view/dynamic/shared/DynamicLensViewHost;->onDestroy()V

    :cond_2
    iget-object v1, p0, Lmwd;->d:Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Lmwd;->c:Ly;

    iput-object v1, p0, Lmwd;->d:Landroid/view/ViewGroup;

    iput-object v1, p0, Lmwd;->e:Lmve;

    iput-object v1, p0, Lmwd;->g:Lmwo;

    iget-object v2, p0, Lmwd;->f:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v1, p0, Lmwd;->f:Ljava/util/concurrent/ExecutorService;

    invoke-interface {v0}, Lmve;->c()V

    :cond_3
    return-void
.end method

.method public final h()Lmvd;
    .locals 3
    ...
    invoke-direct {v2, v0, v1}, Lmvb;-><init>(Landroid/graphics/Bitmap;Landroid/graphics/Rect;)V
